...
| Do I have to share my information? | **No!** You only need to share what is needed for the app to work |`);
  ...
  sections.push(
    `\n---\n\n*This child-friendly privacy notice was generated by [Codepliant](https://github.com/joechensmartz/codepliant) to help comply with the Children's Online Privacy Protection Act (COPPA). This notice should be reviewed by qualified legal counsel before publication.*`
  );
