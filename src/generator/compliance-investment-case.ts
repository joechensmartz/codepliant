...
| Startups losing deals due to missing compliance | Vanta 2024 Survey | 67% |`);
  ...
  sections.push(
    `\n---\n\n*This compliance investment case was generated by [Codepliant](https://github.com/joechensmartz/codepliant) based on automated code analysis of ${serviceCount} detected service(s). Figures are industry estimates and should be validated with qualified legal and financial counsel.*`
  );
