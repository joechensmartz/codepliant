...
For questions about this checklist, contact ${email}.`);
  ...
  sections.push(
    `\n---\n\n*This data minimization checklist was generated by [Codepliant](https://github.com/codepliant/codepliant) based on automated code analysis. It is for informational purposes only and does not constitute legal advice.*`
  );
