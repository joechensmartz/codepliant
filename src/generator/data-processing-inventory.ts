...
export function generateDataProcessingInventory(
  ...
  lines.push(`>`);
  lines.push(`> Generated on ${date} by [Codepliant](https://github.com/joechensmartz/codepliant)`);
  lines.push("");
  ...
  lines.push("");
  lines.push(
    "*This Data Processing Inventory was auto-generated by [Codepliant](https://github.com/joechensmartz/codepliant) based on automated code analysis. " +
