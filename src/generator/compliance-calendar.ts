...
- **Adjust cadence** — Some activities may need higher frequency depending on your risk profile`);
  ...
  sections.push(
    `\n---\n\n*This compliance calendar was generated by [Codepliant](https://github.com/codepliant/codepliant) based on automated code analysis. It is for informational purposes only and does not constitute legal advice.*`
  );
