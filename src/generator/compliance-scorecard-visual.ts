...
export function generateComplianceScorecardVisual(
  ...
  lines.push(``);
  lines.push(
    `*This Compliance Scorecard was generated by [Codepliant](https://github.com/codepliant/codepliant) based on automated code analysis and configuration review. Grades reflect configuration completeness and service profile, not full legal compliance. This document should be reviewed by qualified compliance professionals.*`,
  );
  lines.push(``);
