...
*This privacy metrics dashboard was generated by [Codepliant](https://github.com/codepliant/codepliant) based on automated code analysis. Vendor counts and categories are auto-populated from the codebase. Operational metrics (DSAR counts, consent rates, etc.) must be manually tracked. This document does not constitute legal advice.*`);
