...
**None of the 1 detected AI service(s) use your data for model training** when accessed via their commercial APIs. [Your Company Name] has verified the data handling policies of each provider.
...
*This AI training data notice was generated by [Codepliant](https://github.com/joechensmartz/codepliant) based on an automated scan of the **root** codebase. AI provider training policies are subject to change. This document should be reviewed regularly and verified against each provider's current terms of service and privacy policy.*