...
> This guide provides step-by-step procedures for handling Data Subject Access Requests (DSARs) under the General Data Protection Regulation (GDPR) and the California Consumer Privacy Act (CCPA). It is tailored to the **root** application based on automated code analysis.
...
The following map was auto-generated from code analysis of **root**. It shows where personal data is stored, how to export it, how to delete it, and which third parties must be notified.
...
- **Third-party notification required:** Yes — contact Segment to forward the DSAR or use their GDPR/privacy API
...
- **Third-party notification required:** Yes — contact Algolia to forward the DSAR or use their GDPR/privacy API
...
- **How to export:** Consult the service provider's documentation for data export procedures. Contact their DPO if no self-service export is available.
- **How to delete:** Contact the service provider to request deletion of all personal data. Document the request and any response received.
- **Third-party notification required:** Yes — contact cookie-parser to forward the DSAR or use their GDPR/privacy API
...
- **How to export:** Consult the service provider's documentation for data export procedures. Contact their DPO if no self-service export is available.
- **How to delete:** Contact the service provider to request deletion of all personal data. Document the request and any response received.
- **Third-party notification required:** Yes — contact express-session to forward the DSAR or use their GDPR/privacy API
...
- **How to export:** List and export all files associated with the user's account. Include file metadata (upload date, size, type).
- **How to delete:** Delete all user-uploaded files and associated metadata. Purge from CDN caches if applicable.
- **Third-party notification required:** Yes — contact Multer to forward the DSAR or use their GDPR/privacy API
...
| Segment | Analytics / Tracking | Forward DSAR; confirm deletion/export |
| SendGrid | Email / Communication | Forward DSAR; confirm deletion/export |
| Algolia | Third-Party Service | Forward DSAR; confirm deletion/export |
| cookie-parser | Third-Party Service | Forward DSAR; confirm deletion/export |
| express-session | Third-Party Service | Forward DSAR; confirm deletion/export |
| Multer | File Storage | Forward DSAR; confirm deletion/export |
...
*This DSAR Handling Guide was generated by [Codepliant](https://github.com/joechensmartz/codepliant) based on automated code analysis of the **root** project. The service-specific data location map is derived from detected dependencies and may not capture all data stores. This document is a template and must be reviewed by a legal professional and your Data Protection Officer. It does not constitute legal advice.*