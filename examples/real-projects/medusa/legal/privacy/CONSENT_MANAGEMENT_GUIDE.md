...
|---------|----------|----------------|-----------------|
| @segment/analytics-next | analytics | user identity, user behavior, page views | Must not load until user consents |
...
| Multer | storage | uploaded files, file metadata, potential PII in uploaded content | Essential for service delivery |
...
|----------|----------|---------------|
| Strictly Necessary | @aws-sdk/client-s3, ioredis, Multer, stripe | Always active (no toggle) |
| Analytics | @segment/analytics-next, posthog | Off until consented |
...
### Other Analytics Services (@segment/analytics-next)
...
*This guide was auto-generated by Codepliant based on code analysis of root. It provides implementation guidance only and does not constitute legal advice. Consult with a qualified privacy professional for your specific compliance requirements.*