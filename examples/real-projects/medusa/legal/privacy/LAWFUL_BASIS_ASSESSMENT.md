...
**Services:** @aws-sdk/client-s3, Multer
...
**Services:** @segment/analytics-next, posthog

**Data processed:** user identity, user behavior, page views, custom events, device information, IP address, session recordings, feature flag usage
...
**Services:** algoliasearch, cookie-parser, express-session

**Data processed:** search queries, search result clicks, user search behavior, cookies, cookie data, session cookies, session data
