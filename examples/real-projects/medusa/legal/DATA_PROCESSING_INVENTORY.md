...
### PA-001: Website & Product Analytics
...
| **Recipients / Processors** | @segment/analytics-next, posthog |
...
| **Recipients / Processors** | @sendgrid/mail |
...
### PA-005: File Storage & Media Management
...
| **Recipients / Processors** | @aws-sdk/client-s3, Multer |
...
| **Recipients / Processors** | ioredis (managed/self-hosted) |
...
|----|----------|-------------|------------|------|
| PA-001 | Website & Product Analytics | Consent | Page views, Click events, Session duration ... | Medium |
...
| PA-005 | File Storage & Media Management | Contract performance | Uploaded files, File metadata, EXIF data (images) ... | Medium |
...
|-------------|-------------------|
| Consent (Art. 6(1)(a)) or Legitimate interest (Art. 6(1)(f)) | PA-001 |
| Contract performance (Art. 6(1)(b)) | PA-002, PA-003, PA-005, PA-006 |
...
|----------|-----------|-----------|
| PA-001: Website & Product Analytics | @segment/analytics-next, posthog | Standard Contractual Clauses (SCCs) |
| PA-002: Payment Processing & Billing | stripe | PCI DSS compliance, Standard Contractual Clauses |
| PA-003: Email Communications | @sendgrid/mail | Standard Contractual Clauses (SCCs) |
| PA-004: AI-Powered Features & Processing | openai | Standard Contractual Clauses, Data Processing Addendum with AI provider |
| PA-005: File Storage & Media Management | @aws-sdk/client-s3, Multer | Encryption at rest, Standard Contractual Clauses |
