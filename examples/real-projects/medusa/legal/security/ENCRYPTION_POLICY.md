...
This Encryption Policy defines the encryption requirements for data at rest, data in transit, and key management procedures for **[Your Company Name]**'s **root** application. It supports compliance with GDPR Article 32, SOC 2 CC6.1, ISO 27001 Annex A.10, and PCI DSS Requirement 3 & 4.
...
| Multer (Storage) | AES-256 server-side encryption (SSE-S3, SSE-KMS, or SSE-C for AWS S3 | Cloud-managed keys | Cloud-managed or CMEK |
...
*This Encryption Policy was generated by [Codepliant](https://github.com/joechensmartz/codepliant) based on an automated scan of the **root** codebase. It should be reviewed by your security and engineering teams and customized to reflect your actual encryption implementation.*