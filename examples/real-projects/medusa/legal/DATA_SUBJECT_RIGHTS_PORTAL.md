...
*Generated on 2026-03-16 | 11 services detected | 28 data categories*
...
| user identity, user behavior, page views | @segment/analytics-next | Per retention policy | View, Export, Delete |
| email addresses, email content | @sendgrid/mail | Per retention policy | View, Export, Delete |
| search queries, search result clicks, user search behavior | algoliasearch | Per retention policy | View, Export, Delete |
| cookies, cookie data | cookie-parser | Per retention policy | View, Export, Delete |
| session cookies, session data | express-session | Per retention policy | View, Export, Delete |
| cached data, session data | ioredis | Per retention policy | View, Export, Delete |
| uploaded files, file metadata, potential PII in uploaded content | Multer | Per retention policy | View, Export, Delete |
...
```json
{
  ...
  "third_party_sharing": [
    ...
    { "processor": "@segment/analytics-next", "data_shared": ["user identity","user behavior"], "purpose": "service_operation" },
...
│  └─ Data points: 1,247                                  │
│                                                         │
│  Third-Party Services (11 connected)       │
│  ├─ @aws-sdk/client-s3: uploaded files, file metadata
│  ├─ @segment/analytics-next: user identity, user behavior
│  ├─ @sendgrid/mail: email addresses, email content
│  ├─ algoliasearch: search queries, search result clicks
...
- [ ] Add data aggregation from all 11 connected services
...
*This specification was auto-generated by Codepliant based on 11 detected services in your codebase. Implement this portal to give your users full control over their personal data.*
