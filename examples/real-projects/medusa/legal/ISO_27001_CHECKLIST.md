...
| @segment/analytics-next | Analytics | Organizational Controls (A.5), Technological Controls (A.8) |
...
| Multer | File Storage | Technological Controls (A.8), Organizational Controls (A.5) |
...
*Data-collecting services detected: @segment/analytics-next, posthog, openai*
...
*Data storage services detected: ioredis, @aws-sdk/client-s3, Multer*
