...
| @segment/analytics-next | analytics | user identity, user behavior, page views, custom events, device information, IP address | Export / Delete / Rectify |
| @sendgrid/mail | email | email addresses, email content | Export / Delete / Rectify |
| algoliasearch | other | search queries, search result clicks, user search behavior | Export / Delete / Rectify |
| cookie-parser | other | cookies, cookie data | Export / Delete / Rectify |
| express-session | other | session cookies, session data | Export / Delete / Rectify |
| ioredis | database | cached data, session data | Export / Delete / Rectify |
| Multer | storage | uploaded files, file metadata, potential PII in uploaded content | Export / Delete / Rectify |
