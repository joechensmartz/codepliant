...
| Where is data stored? | [AUTO] Database services detected: ioredis — [MANUAL] specify hosting region |
| Do you use cloud storage? | [AUTO] Yes — @aws-sdk/client-s3, Multer detected |
...
| Question | Answer |
|----------|--------|
| How many third-party sub-processors do you use? | [AUTO] 11 sub-processor(s) detected |
...
*This vendor security questionnaire was generated by [Codepliant](https://github.com/joechensmartz/codepliant) based on an automated scan of the **root** codebase. Answers marked [AUTO] are derived from code analysis and should be verified. Answers marked [MANUAL] require input from your security and compliance teams. This document is not a substitute for a formal security assessment.*
