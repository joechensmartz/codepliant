...
|---|--------|----------|-----------|-------------------|
| 1 | @aws-sdk/client-s3 | File Storage | High | Confidential — stores files that may contain any data category |
| 2 | @segment/analytics-next | Analytics | Medium | Internal — collects behavioral data, device info, IP addresses |
| 3 | @sendgrid/mail | Email Service | Medium | Confidential — processes email addresses, message content |
| 4 | algoliasearch | Other | Low | Internal — classification depends on specific use case |
| 5 | cookie-parser | Other | Low | Internal — classification depends on specific use case |
| 6 | express-session | Other | Low | Internal — classification depends on specific use case |
| 7 | ioredis | Database | High | Confidential — stores application data, potentially all data categories |
| 8 | Multer | File Storage | High | Confidential — stores files that may contain any data category |
| 9 | openai | AI Service | Critical | Confidential — may process user content, prompts, PII |
| 10 | posthog | Analytics | Medium | Internal — collects behavioral data, device info, IP addresses |
| 11 | stripe | Payment Processing | Critical | Restricted — processes payment card data, financial PII |

> **Total vendors:** 11 | **Critical/High risk:** 5
