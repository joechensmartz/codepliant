...
|----------|---------|----------|-------------------|
| Twilio Segment | 2 | Analytics | [Yes](https://segment.com/legal/privacy/#your-choices) |
| PostHog Inc | 2 | Analytics | [Yes](https://posthog.com/docs/libraries/js#opt-users-out) |

## Twilio Segment

**Service:** @segment/analytics-next
**Privacy Policy:** [https://segment.com/legal/privacy/](https://segment.com/legal/privacy/)
**Opt-Out URL:** [https://segment.com/legal/privacy/#your-choices](https://segment.com/legal/privacy/#your-choices)

### Cookies Set

| Cookie Name | Purpose | Duration |
|-------------|---------|----------|
| `ajs_anonymous_id` | Anonymous user identification for analytics routing | 1 year |
| `ajs_user_id` | Identified user tracking across Segment-connected services | 1 year |

### How to Opt Out

To opt out of Twilio Segment cookies:

1. Visit the opt-out page: [https://segment.com/legal/privacy/#your-choices](https://segment.com/legal/privacy/#your-choices)
2. Use your browser's cookie management settings to block cookies from Twilio Segment
