...
| Information Security | 1.8/5.0 [██░░░] | 4/9 | Developing (Level 2) |
...
**Overall Maturity Score:** 2.8/5.0 — **Defined (Level 3)**
...
| GOV-04 | Is the scope of compliance obligations clearly defined? | [AUTO] 3 | [AUTO] 11 services detected — compliance scope is well-defined |
...
| # | Question | Score (1-5) | Justification |
|---|----------|------------|---------------|
| SEC-01 | Is authentication required for all system access, with MFA for privileged accounts? | [AUTO] 1 | [AUTO] No authentication service detected |
...
| SEC-06 | Is data encrypted at rest and in transit? | [AUTO] 2 | [AUTO] Database service detected (ioredis) — encryption at rest needs manual verification |
...
| # | Question | Score (1-5) | Justification |
|---|----------|------------|---------------|
| VEN-01 | Is there a complete inventory of all third-party services and sub-processors? | [AUTO] 3 | [AUTO] 11 third-party services detected and inventoried |
...
|----------|--------|---------|--------|----------------|-------|----------|
| 1 | Information Security | 1.8 | 2.8 | [DESCRIBE ACTIONS] | [OWNER] | [DATE] |
...
*This compliance maturity assessment was generated by [Codepliant](https://github.com/joechensmartz/codepliant) based on an automated scan of the **root** codebase. Auto-scored questions should be verified by your compliance team. This assessment does not constitute legal advice or formal certification.*
