...
**Relevant SOC 2 sections:** Confidentiality (C1), Security (CC6), Processing Integrity (PI1), Privacy (P1-P8), Availability (A1)
...
| @segment/analytics-next | Analytics | Processing Integrity (PI1), Privacy (P1-P8) |
| @sendgrid/mail | Email Service | Confidentiality (C1), Privacy (P1-P8) |
| algoliasearch | Other | General |
| cookie-parser | Other | General |
| express-session | Other | General |
| ioredis | Database | Confidentiality (C1), Security (CC6) |
| Multer | File Storage | Confidentiality (C1), Security (CC6) |
...
- [ ] Enable encryption at rest for: ioredis
- [ ] Enable encryption at rest for file storage: @aws-sdk/client-s3, Multer
...
- [ ] Validate AI model inputs and outputs for: openai
...
- [ ] Enable transparent data encryption (TDE) or equivalent for: ioredis
- [ ] Enable server-side encryption for: @aws-sdk/client-s3, Multer
...
- [ ] Disclose third-party data sharing for: @segment/analytics-next, posthog, openai
