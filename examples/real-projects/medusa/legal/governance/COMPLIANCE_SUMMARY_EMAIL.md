...
[Your Company Name] currently operates **11 third-party service(s)** that process user data. A total of **81 compliance document(s)** have been generated covering all applicable regulatory requirements.
...
3. **High Service Count** (11 services): Large attack surface increases data breach risk. Sub-processor management is critical.
4. **Analytics/Monitoring** (@segment/analytics-next, posthog): Cookie consent and tracking disclosure required under GDPR/ePrivacy.
...
*Report generated from analysis of 11 service(s) across 7 categories.*