...
Based on the 11 service(s) detected in **root**, the following obligations apply:
...
### Analytics / Advertising Services (@segment/analytics-next, posthog)
...
### Storage / Database Services (@aws-sdk/client-s3, ioredis, Multer)
