...
This document provides a 12-month calendar view of all compliance activities for **root**, auto-populated based on 11 detected service(s) and applicable regulations.
...
| **Total** | **64 items** | **14 items** | **9 items** |
