...
[Your Company Name] currently operates **6 third-party service(s)** that process user data. A total of **73 compliance document(s)** have been generated covering all applicable regulatory requirements.
...
|----------|-------|----------|
| Auth | 2 | django-admin, django-sessions |
| Database | 1 | redis |
| Other | 1 | Django Channels |
| Payment | 1 | stripe |
| Storage | 1 | boto3 |
...
*Report generated from analysis of 6 service(s) across 5 categories.*