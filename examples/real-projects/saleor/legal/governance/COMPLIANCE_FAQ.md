...
*6 services detected across 5 categories.*
...
This data is collected through 6 integrated service(s): boto3, Django Channels, django-admin, django-sessions, redis, stripe.
...
| Django Channels | Other Services | real-time user data, connection metadata, channel group data |
| django-admin | Authentication | admin panel access, staff user accounts |
| django-sessions | Authentication | session cookies, CSRF tokens |
...
### Q15: Where is my data stored?

Data may be processed in the following regions based on our service providers:

- **boto3** — Processes data as described in their privacy policy
- **Django Channels** — Processes data as described in their privacy policy
- **django-admin** — Processes data as described in their privacy policy
- **django-sessions** — Processes data as described in their privacy policy
...
### Q16: How do you protect international data transfers?
...
### Q17: Do you store my credit card number?
...
### Q19: What happens to my payment data if I cancel?
...
### Q20: How will I know if this policy changes?
...
### Q23: Do you comply with GDPR/CCPA?
...
### Q24: Where can I find your full Privacy Policy?
...
### Q26: What happens to my data when I delete my account?
...
*This FAQ was generated by [Codepliant](https://github.com/joechensmartz/codepliant) based on automated code analysis of 6 detected services. It should be reviewed by a qualified legal professional before publication.*