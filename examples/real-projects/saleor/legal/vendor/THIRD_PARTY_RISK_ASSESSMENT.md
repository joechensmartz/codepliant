...
This document provides a risk assessment of all third-party services integrated into the **saleor** application. Each vendor has been evaluated for data sensitivity, geographic risk, compliance certifications, data processing scope, and risk mitigation measures.

Total third-party vendors assessed: **5**
...
|--------|----------|-----------------|----------------|---------------|-------------|
| boto3 | storage | medium | Other | None verified | Critical |
| Django Channels | other | low | Other | None verified | High |
| django-admin | auth | high | Other | None verified | Critical |
| django-sessions | auth | high | Other | None verified | Critical |
...
|-----------|--------|
| **Category** | auth |
| **Data Processed** | admin panel access, staff user accounts |
