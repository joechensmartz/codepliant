...
|---|--------|----------|-----------|-------------------|
| 1 | boto3 | File Storage | High | Confidential — stores files that may contain any data category |
| 2 | Django Channels | Other | Low | Internal — classification depends on specific use case |
| 3 | django-admin | Authentication | High | Confidential — processes authentication credentials, identity data |
| 4 | django-sessions | Authentication | High | Confidential — processes authentication credentials, identity data |
| 5 | redis | Database | High | Confidential — stores application data, potentially all data categories |
| 6 | stripe | Payment Processing | Critical | Restricted — processes payment card data, financial PII |

> **Total vendors:** 6 | **Critical/High risk:** 5
