...
> 6 services | Generated on 2026-03-16
...
|---------|----------|---------------|-----------|-------------|-------------------|
| boto3 | storage | **P1** | **P2** | uploaded files, file metadata | GDPR Art. 33/34 if PII stored |
| Django Channels | other | **P2** | **P3** | real-time user data, connection metadata, channel group data | Assess per data processed |
| django-admin | auth | **P0** | **P1** | admin panel access, staff user accounts | GDPR Art. 33/34, credential breach notification |
| django-sessions | auth | **P0** | **P1** | session cookies, CSRF tokens | GDPR Art. 33/34, credential breach notification |
...
*This incident severity matrix was generated by [Codepliant](https://github.com/joechensmartz/codepliant) based on an automated scan of the **saleor** codebase (6 services detected). Customize response times, escalation paths, and roles to match your organization's structure. This document should be reviewed by your security team and legal counsel before adoption.*
