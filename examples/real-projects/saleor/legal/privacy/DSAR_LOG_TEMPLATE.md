...
|---------|----------|----------------|-----------------|
| boto3 | storage | uploaded files, file metadata | Export / Delete / Rectify |
| Django Channels | other | real-time user data, connection metadata, channel group data, WebSocket messages | Export / Delete / Rectify |
| django-admin | auth | admin panel access, staff user accounts | Export / Delete / Rectify |
| django-sessions | auth | session cookies, CSRF tokens | Export / Delete / Rectify |
