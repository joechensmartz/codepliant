...
*Generated on 2026-03-16 | 6 services detected | 16 data categories*
...
|---------------|--------|-----------|---------|
| uploaded files, file metadata | boto3 | Per retention policy | View, Export, Delete |
| real-time user data, connection metadata, channel group data | Django Channels | Per retention policy | View, Export, Delete |
| admin panel access, staff user accounts | django-admin | Per retention policy | View, Export, Delete |
| session cookies, CSRF tokens | django-sessions | Per retention policy | View, Export, Delete |
...
```json
{
  ...
  "third_party_sharing": [
    { "processor": "boto3", "data_shared": ["uploaded files","file metadata"], "purpose": "service_operation" },
    { "processor": "Django Channels", "data_shared": ["real-time user data","connection metadata"], "purpose": "service_operation" },
    { "processor": "django-admin", "data_shared": ["admin panel access","staff user accounts"], "purpose": "service_operation" }
  ]
}
```
...
│  └─ Data points: 1,247                                  │
│                                                         │
│  Third-Party Services (6 connected)       │
│  ├─ boto3: uploaded files, file metadata
│  ├─ Django Channels: real-time user data, connection metadata
│  ├─ django-admin: admin panel access, staff user accounts
│  ├─ django-sessions: session cookies, CSRF tokens
│  ├─ redis: cached data, session data
│  └─ ... and 1 more
│                                                         │
└─────────────────────────────────────────────────────────┘
```
...
- [ ] Add data aggregation from all 6 connected services
...
*This specification was auto-generated by Codepliant based on 6 detected services in your codebase. Implement this portal to give your users full control over their personal data.*
