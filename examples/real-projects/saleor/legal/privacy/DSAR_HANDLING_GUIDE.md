...
> This guide provides step-by-step procedures for handling Data Subject Access Requests (DSARs) under the General Data Protection Regulation (GDPR) and the California Consumer Privacy Act (CCPA). It is tailored to the **saleor** application based on automated code analysis.
...
The following map was auto-generated from code analysis of **saleor**. It shows where personal data is stored, how to export it, how to delete it, and which third parties must be notified.
...
- **Third-party notification required:** Yes — contact boto3 to forward the DSAR or use their GDPR/privacy API
...
- **Third-party notification required:** Yes — contact django-admin to forward the DSAR or use their GDPR/privacy API
...
- **How to export:** Export user profile data from the authentication provider's admin panel or API. Include account metadata, login history, and linked social accounts.
- **How to delete:** Delete the user account and all associated sessions, tokens, and profile data through the auth provider's API or admin panel.
- **Third-party notification required:** Yes — contact django-sessions to forward the DSAR or use their GDPR/privacy API
...
|--------------|----------|----------------|
| boto3 | File Storage | Forward DSAR; confirm deletion/export |
| Django Channels | Third-Party Service | Forward DSAR; confirm deletion/export |
| django-admin | Authentication / Identity | Forward DSAR; confirm deletion/export |
| django-sessions | Authentication / Identity | Forward DSAR; confirm deletion/export |
...
*This DSAR Handling Guide was generated by [Codepliant](https://github.com/joechensmartz/codepliant) based on automated code analysis of the **saleor** project. The service-specific data location map is derived from detected dependencies and may not capture all data stores. This document is a template and must be reviewed by a legal professional and your Data Protection Officer. It does not constitute legal advice.*