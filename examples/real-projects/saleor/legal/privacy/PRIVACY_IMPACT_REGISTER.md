...
| 2 | User Authentication & Identity Assessment | PIA | 2026-03-16 | Pending Review | Medium | [Data Protection Officer Name] | 2027-03-16 |
| 3 | General Personal Data Processing Assessment | PIA | 2026-03-16 | Pending Review | Medium | [Data Protection Officer Name] | 2027-03-16 |
| 4 | Cross-Border Data Transfer Assessment | DPIA | 2026-03-16 | Pending Review | High | [Data Protection Officer Name] | 2027-03-16 |
...
#### Assessment 2: General Personal Data Processing
...
| **Scope** | All 6 detected services and general data processing |
...
| **Data Categories** | Personal Identity Data, Financial Data, Technical & Diagnostic Data, User-Uploaded Content, Stored User Data, Contact Information, Location Data, Authentication Data |
...
|---------|----------|---------------|---------------|-------------------|
| boto3 | storage | uploaded files, file metadata | Review needed | Pending |
| Django Channels | other | real-time user data, connection metadata, channel group data | Review needed | Pending |
| django-admin | auth | admin panel access, staff user accounts | Review needed | Pending |
| django-sessions | auth | session cookies, CSRF tokens | Review needed | Pending |
