...
|-----------------|----------|---------------------------|
| boto3 | File Storage | Technological Controls (A.8), Organizational Controls (A.5) |
| Django Channels | Other | General |
| django-admin | Authentication | Organizational Controls (A.5), Technological Controls (A.8) |
| django-sessions | Authentication | Organizational Controls (A.5), Technological Controls (A.8) |
...
*Authentication services detected: django-admin, django-sessions*
...
*Data storage services detected: redis, boto3*
