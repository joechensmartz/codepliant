...
| Privacy & Data Protection | 3.0/5.0 [███░░] | 6/9 | Defined (Level 3) |
| Information Security | 2.5/5.0 [███░░] | 4/9 | Defined (Level 3) |
| Vendor & Third-Party Risk | 3.0/5.0 [███░░] | 3/8 | Defined (Level 3) |
| AI Governance & Ethics | 5.0/5.0 [█████] | 3/8 | Optimized (Level 5) |
| Incident Response & Business Continuity | 3.0/5.0 [███░░] | 3/7 | Defined (Level 3) |

**Overall Maturity Score:** 3.1/5.0 — **Defined (Level 3)**
...
| GOV-04 | Is the scope of compliance obligations clearly defined? | [AUTO] 3 | [AUTO] 6 services detected — compliance scope is well-defined |
...
| PRI-04 | Is consent obtained and recorded for all data processing requiring it? | [AUTO] 2 | [AUTO] No analytics/tracking detected — consent management may still be needed |
...
| # | Question | Score (1-5) | Justification |
|---|----------|------------|---------------|
| SEC-01 | Is authentication required for all system access, with MFA for privileged accounts? | [AUTO] 4 | [AUTO] Authentication service detected: django-admin, django-sessions |
| SEC-02 | Is there continuous security monitoring and alerting in place? | [AUTO] 1 | [AUTO] No monitoring service detected |
...
| SEC-06 | Is data encrypted at rest and in transit? | [AUTO] 2 | [AUTO] Database service detected (redis) — encryption at rest needs manual verification |
...
| # | Question | Score (1-5) | Justification |
|---|----------|------------|---------------|
| VEN-01 | Is there a complete inventory of all third-party services and sub-processors? | [AUTO] 3 | [AUTO] 6 third-party services detected and inventoried |
...
| # | Question | Score (1-5) | Justification |
|---|----------|------------|---------------|
| AI-01 | Is there an inventory of all AI/ML systems with risk classifications? | [AUTO] 5 | [AUTO] No AI services detected — N/A |
| AI-02 | Is AI usage disclosed to end users with clear explanations? | [AUTO] 5 | [AUTO] No AI services detected — N/A |
...
| AI-05 | Is there an AI governance framework aligned with regulations (EU AI Act, NIST AI RMF)? | [AUTO] 5 | [AUTO] No AI services detected — N/A |
...
|----------|--------|---------|--------|----------------|-------|----------|
| 1 | Information Security | 2.5 | 3.5 | [DESCRIBE ACTIONS] | [OWNER] | [DATE] |
| 2 | Governance & Leadership | 2.8 | 3.8 | [DESCRIBE ACTIONS] | [OWNER] | [DATE] |
| 3 | Privacy & Data Protection | 3.0 | 4.0 | [DESCRIBE ACTIONS] | [OWNER] | [DATE] |
| 4 | Vendor & Third-Party Risk | 3.0 | 4.0 | [DESCRIBE ACTIONS] | [OWNER] | [DATE] |
...
Recommended next assessment date: **2026-06-14** (quarterly cadence).

---

*This compliance maturity assessment was generated by [Codepliant](https://github.com/joechensmartz/codepliant) based on an automated scan of the **saleor** codebase. Auto-scored questions should be verified by your compliance team. This assessment does not constitute legal advice or formal certification.*
