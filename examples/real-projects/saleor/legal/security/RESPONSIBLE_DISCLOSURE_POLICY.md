...
| Authentication system (django-admin, django-sessions) | Auth Infrastructure | Critical |
| Payment processing (stripe) | Payment Infrastructure | Critical |
| Data storage (boto3, redis) | Data Infrastructure | High |
...
- **Authentication & Authorization** — bypass, privilege escalation, session management flaws (django-admin, django-sessions)
- **Payment Security** — transaction manipulation, price tampering, payment data exposure (stripe)
- **Data Storage** — injection, unauthorized data access, data leakage (boto3, redis)
