...
| **Recipients / Processors** | django-admin, django-sessions |
...
| **Recipients / Processors** | redis (managed/self-hosted) |
...
|----------|-----------|-----------|
| PA-001: User Authentication & Account Management | django-admin, django-sessions | Standard Contractual Clauses (SCCs) |
| PA-002: Payment Processing & Billing | stripe | PCI DSS compliance, Standard Contractual Clauses |
| PA-003: File Storage & Media Management | boto3 | Encryption at rest, Standard Contractual Clauses |
