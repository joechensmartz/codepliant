...
|--------------|---------|---------------|
| boto3 | File storage and media hosting | uploaded files, file metadata |
...
| django-admin | User authentication and identity management | admin panel access, staff user accounts |
| django-sessions | User authentication and identity management | session cookies, CSRF tokens |
