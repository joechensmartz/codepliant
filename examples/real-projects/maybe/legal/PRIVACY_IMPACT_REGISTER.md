...
| **Date Conducted** | 2026-03-16 |
| **Type** | Full DPIA (GDPR Art. 35) |
| **Scope** | Payment services: plaid, stripe |
| **Processing Description** | Collection and processing of payment and financial data |
| **Data Subjects** | Customers, purchasers |
| **Data Categories** | bank account data, transaction history, account balances, financial institution data, payment information, billing address, email |
...
| **Scope** | All 20 detected services and general data processing |
...
| **Data Categories** | Personal Identity Data, Financial Data, AI Interaction Data, Communication Data, Technical & Diagnostic Data, User-Uploaded Content, Stored User Data |
...
| intercom-ruby | other | user profiles, email, name | Review needed | Pending |
...
| plaid | payment | bank account data, transaction history, account balances | Yes | Pending |
