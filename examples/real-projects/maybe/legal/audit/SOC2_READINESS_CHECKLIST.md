...
**Detected services:** 20
**Relevant SOC 2 sections:** Confidentiality (C1), Privacy (P1-P8), Security (CC6), Processing Integrity (PI1), Availability (A1)
...
| intercom-ruby | Other | General |
| nodemailer | Email Service | Confidentiality (C1), Privacy (P1-P8) |
| pg | Database | Confidentiality (C1), Security (CC6) |
| plaid | Payment Processing | Confidentiality (C1), Security (CC6), Processing Integrity (PI1) |
...
- [ ] Review access control configuration for: rails-sessions
...
- [ ] Enable encryption at rest for: ActiveRecord, pg, rails-activerecord, redis
- [ ] Enable encryption at rest for file storage: Active Storage, ActiveStorage, aws-sdk-s3
...
- [ ] Implement idempotency controls for payment transactions via: plaid, stripe
...
- [ ] Enable transparent data encryption (TDE) or equivalent for: ActiveRecord, pg, rails-activerecord, redis
- [ ] Enable server-side encryption for: Active Storage, ActiveStorage, aws-sdk-s3
...
*Payment services detected: plaid, stripe*
...
- [ ] Disclose third-party data sharing for: ruby-openai
