...
| DD-S-008 | **intercom-ruby** | Data fully removed after deletion request | Service-specific API query; expect no user data |
| DD-S-009 | **nodemailer** | Data fully removed after deletion request | Search mailing lists by email; expect not found |
| DD-S-010 | **pg** | Data fully removed after deletion request | Direct DB query by user ID; expect 0 rows |
| DD-S-011 | **plaid** | Data fully removed after deletion request | Query payment records by user ID; expect empty result |
| DD-S-012 | **rack-attack** | Data fully removed after deletion request | Service-specific API query; expect no user data |
| DD-S-013 | **rails-actionmailer** | Data fully removed after deletion request | Search mailing lists by email; expect not found |
| DD-S-014 | **rails-activerecord** | Data fully removed after deletion request | Direct DB query by user ID; expect 0 rows |
| DD-S-015 | **rails-sessions** | Data fully removed after deletion request | Query user profile API; expect 404 |
| DD-S-016 | **redis** | Data fully removed after deletion request | Direct DB query by user ID; expect 0 rows |
| DD-S-017 | **ruby-openai** | Data fully removed after deletion request | Query AI logs by user ID; expect no matching entries |
| DD-S-018 | **sentry-ruby** | Data fully removed after deletion request | Search logs by user ID; expect scrubbed entries |
| DD-S-019 | **sidekiq** | Data fully removed after deletion request | Service-specific API query; expect no user data |
| DD-S-020 | **stripe** | Data fully removed after deletion request | Query payment records by user ID; expect empty result |

### 3.3 Cascade Deletion

| ID | Test Case | Expected Result | Regulation |
| --- | --- | --- | --- |
| DD-C-001 | Delete user account | Data removed from all 20 detected services | GDPR Art. 17 |
...
| **intercom-ruby** | N/A | Required | Required | Recommended |
| **nodemailer** | Required | Required | Required | Recommended |
| **pg** | N/A | Required | Required | Required |
| **plaid** | N/A | Required | Required | Required |
