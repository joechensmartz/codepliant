...
[Your Company Name] operates a technology stack comprising **20 third-party services** across 8 categories. This report provides an overview of our compliance posture, key risks, regulatory developments, and budget status for Q1 2026.
...
| Database | 4 | Medium | Vendor dependency, data processing |
...
3. **Vendor consolidation review** — With 20 third-party services, evaluate opportunities to reduce vendor footprint and associated compliance overhead.
...
| 8 | intercom-ruby | other | Yes | user profiles, email, name +2 more |
| 9 | nodemailer | email | Yes | email addresses, email content |
| 10 | pg | database | Yes | user data as defined in schema |
| 11 | plaid | payment | Yes | bank account data, transaction history, account balances +1 more |
| 12 | rack-attack | other | Yes | IP addresses, request metadata |
| 13 | rails-actionmailer | email | Yes | email addresses, email content |
| 14 | rails-activerecord | database | Yes | user data as defined in schema |
| 15 | rails-sessions | auth | Yes | session cookies, CSRF tokens |
| 16 | redis | database | Yes | cached data, session data |
| 17 | ruby-openai | ai | Yes | user prompts, conversation history, generated content |
| 18 | sentry-ruby | monitoring | Yes | error data, stack traces, user context +1 more |
| 19 | sidekiq | other | Yes | job data, user data processed in background jobs |
| 20 | stripe | payment | Yes | payment information, billing address, email +1 more |

---

*This board report was generated by [Codepliant](https://github.com/joechensmartz/codepliant) based on automated source code analysis of the **maybe** codebase (20 services detected). Sections marked with [brackets] require manual input from the compliance team. This report should be reviewed and supplemented with operational data before board presentation. Generated on 2026-03-16.*
