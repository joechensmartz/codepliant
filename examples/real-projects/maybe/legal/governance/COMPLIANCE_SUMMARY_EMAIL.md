...
[Your Company Name] currently operates **20 third-party service(s)** that process user data. A total of **82 compliance document(s)** have been generated covering all applicable regulatory requirements.
...
|----------|-------|----------|
| Ai | 1 | ruby-openai |
| Auth | 1 | rails-sessions |
| Database | 4 | ActiveRecord, pg, rails-activerecord, redis |
| Email | 3 | ActionMailer, nodemailer, rails-actionmailer |
| Monitoring | 1 | sentry-ruby |
| Other | 5 | ActionCable, ActionController::Cookies, intercom-ruby, rack-attack, sidekiq |
| Payment | 2 | plaid, stripe |
...
2. **Payment Processing** (plaid, stripe): PCI DSS compliance required. Data Processing Agreement must list payment sub-processors.
3. **High Service Count** (20 services): Large attack surface increases data breach risk. Sub-processor management is critical.
4. **Analytics/Monitoring** (sentry-ruby): Cookie consent and tracking disclosure required under GDPR/ePrivacy.
...
*Report generated from analysis of 20 service(s) across 8 categories.*