...
**[Your Company Name]** operates a technology stack with **20 detected service(s)** that fall under **3 regulatory framework(s)**. Non-compliance carries material financial, legal, and reputational risk.
...
Based on the 20 service(s) detected in **maybe**, the following exposure areas have been identified:

### Authentication & User Data (rails-sessions)
...
### Payment Processing (plaid, stripe)
...
### Storage & Database (Active Storage, ActiveRecord, ActiveStorage, aws-sdk-s3, pg, rails-activerecord, redis)
...
Based on **20 detected services** (large complexity):
...
1. **Comprehensive coverage:** Documents cover GDPR, EU AI Act, PCI DSS.
...
*This compliance investment case was generated by [Codepliant](https://github.com/joechensmartz/codepliant) based on automated code analysis of 20 detected service(s). Figures are industry estimates and should be validated with qualified legal and financial counsel.*