...
This document provides a 12-month calendar view of all compliance activities for **maybe**, auto-populated based on 20 detected service(s) and applicable regulations.
...
|-------|--------|--------|--------|
| January | 10 items | 3 items | 2 items |
...
| **Total** | **72 items** | **13 items** | **9 items** |
...
### Authentication Services (rails-sessions)
...
### Storage / Database Services (Active Storage, ActiveRecord, ActiveStorage, aws-sdk-s3, pg, rails-activerecord, redis)
