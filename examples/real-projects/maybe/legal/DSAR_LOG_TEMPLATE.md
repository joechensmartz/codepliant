...
| intercom-ruby | other | user profiles, email, name, conversations, user behavior | Export / Delete / Rectify |
...
| plaid | payment | bank account data, transaction history, account balances, financial institution data | Export / Delete / Rectify |
