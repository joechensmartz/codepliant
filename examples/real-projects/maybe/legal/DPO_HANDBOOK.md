...
- 20 third-party data processors detected (systematic processing at scale)
...
### 5.2 Systems to Query (20 detected)
...
- **plaid** (payment): bank account data, transaction history, account balances
...
*This DPO Handbook was generated by [Codepliant](https://github.com/joechensmartz/codepliant) based on an automated scan of the **maybe** codebase. It should be reviewed and customized by your legal team and appointed DPO before adoption.*
