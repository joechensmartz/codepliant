...
> This guide provides step-by-step procedures for handling Data Subject Access Requests (DSARs) under the General Data Protection Regulation (GDPR) and the California Consumer Privacy Act (CCPA). It is tailored to the **maybe** application based on automated code analysis.
...
The following map was auto-generated from code analysis of **maybe**. It shows where personal data is stored, how to export it, how to delete it, and which third parties must be notified.
...
- **How to export:** Consult the service provider's documentation for data export procedures. Contact their DPO if no self-service export is available.
- **How to delete:** Contact the service provider to request deletion of all personal data. Document the request and any response received.
- **Third-party notification required:** Yes — contact intercom-ruby to forward the DSAR or use their GDPR/privacy API
...
- **Third-party notification required:** Yes — contact Plaid to forward the DSAR or use their GDPR/privacy API
...
| intercom-ruby | Third-Party Service | Forward DSAR; confirm deletion/export |
| pg | Database / Data Store | Forward DSAR; confirm deletion/export |
| Plaid | Payment Processing | Forward DSAR; confirm deletion/export |
...
*This DSAR Handling Guide was generated by [Codepliant](https://github.com/joechensmartz/codepliant) based on automated code analysis of the **maybe** project. The service-specific data location map is derived from detected dependencies and may not capture all data stores. This document is a template and must be reviewed by a legal professional and your Data Protection Officer. It does not constitute legal advice.*