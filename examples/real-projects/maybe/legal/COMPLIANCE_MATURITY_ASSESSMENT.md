...
| GOV-04 | Is the scope of compliance obligations clearly defined? | [AUTO] 3 | [AUTO] 20 services detected — compliance scope is well-defined |
...
| # | Question | Score (1-5) | Justification |
|---|----------|------------|---------------|
| SEC-01 | Is authentication required for all system access, with MFA for privileged accounts? | [AUTO] 4 | [AUTO] Authentication service detected: rails-sessions |
| SEC-02 | Is there continuous security monitoring and alerting in place? | [AUTO] 3 | [AUTO] Monitoring detected: sentry-ruby |
...
| SEC-06 | Is data encrypted at rest and in transit? | [AUTO] 2 | [AUTO] Database service detected (ActiveRecord, pg, rails-activerecord, redis) — encryption at rest needs manual verification |
...
| # | Question | Score (1-5) | Justification |
|---|----------|------------|---------------|
| VEN-01 | Is there a complete inventory of all third-party services and sub-processors? | [AUTO] 3 | [AUTO] 20 third-party services detected and inventoried |
...
| # | Question | Score (1-5) | Justification |
|---|----------|------------|---------------|
| AI-01 | Is there an inventory of all AI/ML systems with risk classifications? | [AUTO] 3 | [AUTO] AI services detected: ruby-openai |
...
| 2 | Privacy & Data Protection | 3.0 | 4.0 | [DESCRIBE ACTIONS] | [OWNER] | [DATE] |
| 3 | Information Security | 3.0 | 4.0 | [DESCRIBE ACTIONS] | [OWNER] | [DATE] |
| 4 | Vendor & Third-Party Risk | 3.0 | 4.0 | [DESCRIBE ACTIONS] | [OWNER] | [DATE] |
| 5 | AI Governance & Ethics | 3.0 | 4.0 | [DESCRIBE ACTIONS] | [OWNER] | [DATE] |
| 6 | Incident Response & Business Continuity | 3.0 | 4.0 | [DESCRIBE ACTIONS] | [OWNER] | [DATE] |
...
*This compliance maturity assessment was generated by [Codepliant](https://github.com/joechensmartz/codepliant) based on an automated scan of the **maybe** codebase. Auto-scored questions should be verified by your compliance team. This assessment does not constitute legal advice or formal certification.*
