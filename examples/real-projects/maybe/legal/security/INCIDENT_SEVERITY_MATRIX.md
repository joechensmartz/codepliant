...
> 20 services | Generated on 2026-03-16
...
| intercom-ruby | other | **P2** | **P3** | user profiles, email, name | Assess per data processed |
...
| plaid | payment | **P0** | **P1** | bank account data, transaction history, account balances | PCI DSS, GDPR Art. 33/34 |
...
*This incident severity matrix was generated by [Codepliant](https://github.com/joechensmartz/codepliant) based on an automated scan of the **maybe** codebase (20 services detected). Customize response times, escalation paths, and roles to match your organization's structure. This document should be reviewed by your security team and legal counsel before adoption.*
