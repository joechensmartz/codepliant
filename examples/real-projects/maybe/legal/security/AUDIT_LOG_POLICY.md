...
This policy defines what events are logged across the **maybe** application, how long logs are retained, and who has access to audit data. It supports compliance with GDPR Article 30 (records of processing activities), SOC 2 Trust Service Criteria (CC7.2 — monitoring), and internal security requirements.
...
|---------|----------|--------------|
| plaid | payment | Application events, user interactions, system metrics |
