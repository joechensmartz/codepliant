...
**Certificate ID:** CODEPLIANT-20260316-MAYBE
...
| 9 | Data Processing Agreement | `DATA_PROCESSING_AGREEMENT.md` |
| 10 | Sub-Processor List | `SUBPROCESSOR_LIST.md` |
| 11 | Data Retention Policy | `DATA_RETENTION_POLICY.md` |
| 12 | DSAR Handling Guide | `DSAR_HANDLING_GUIDE.md` |
| 13 | Vendor Contacts Directory | `VENDOR_CONTACTS.md` |
| 14 | Data Flow Map | `DATA_FLOW_MAP.md` |
| 15 | Compliance Notes | `COMPLIANCE_NOTES.md` |
| 16 | Compliance Timeline | `COMPLIANCE_TIMELINE.md` |
| 17 | SOC 2 Readiness Checklist | `SOC2_READINESS_CHECKLIST.md` |
| 18 | ISO 27001 Compliance Checklist | `ISO_27001_CHECKLIST.md` |
| 19 | Third-Party Risk Assessment | `THIRD_PARTY_RISK_ASSESSMENT.md` |
| 20 | Privacy Impact Assessment | `PRIVACY_IMPACT_ASSESSMENT.md` |
| 21 | Environment Variable Audit | `ENV_AUDIT.md` |
| 22 | Data Classification Report | `DATA_CLASSIFICATION.md` |
| 23 | Dependency Vulnerability Scan | `VULNERABILITY_SCAN.md` |
| 24 | Regulatory Updates | `REGULATORY_UPDATES.md` |
...
| 33 | License Compliance Report | `LICENSE_COMPLIANCE.md` |
...
| 40 | Supplier Code of Conduct | `SUPPLIER_CODE_OF_CONDUCT.md` |
| 41 | Privacy by Design Checklist | `PRIVACY_BY_DESIGN_CHECKLIST.md` |
| 42 | Penetration Test Scope | `PENTEST_SCOPE.md` |
| 43 | Cookie Inventory | `COOKIE_INVENTORY.md` |
| 44 | AI Governance Framework | `AI_GOVERNANCE_FRAMEWORK.md` |
| 45 | Business Continuity Plan | `BUSINESS_CONTINUITY_PLAN.md` |
| 46 | Encryption Policy | `ENCRYPTION_POLICY.md` |
| 47 | Backup Policy | `BACKUP_POLICY.md` |
...
| 55 | Media Consent Form | `MEDIA_CONSENT_FORM.md` |
| 56 | Responsible Disclosure Policy | `RESPONSIBLE_DISCLOSURE_POLICY.md` |
| 57 | Open Source Notice | `OPEN_SOURCE_NOTICE.md` |
...
| 110 | Compliance Onboarding Guide | `COMPLIANCE_ONBOARDING_GUIDE.md` |
| 111 | Data Processing Inventory | `DATA_PROCESSING_INVENTORY.md` |
| 112 | Compliance Policy Index | `COMPLIANCE_POLICY_INDEX.md` |
| 113 | Compliance Digest | `COMPLIANCE_DIGEST.md` |
| 114 | Privacy Notice (App) | `PRIVACY_NOTICE_APP.md` |
| 115 | Compliance Maturity Assessment | `COMPLIANCE_MATURITY_ASSESSMENT.md` |
| 116 | Regulatory Mapping Matrix | `REGULATORY_MAPPING_MATRIX.md` |
| 117 | Compliance Calendar | `COMPLIANCE_CALENDAR.md` |
| 118 | Data Minimization Checklist | `DATA_MINIMIZATION_CHECKLIST.md` |
| 119 | Compliance Board Report | `COMPLIANCE_BOARD_REPORT.md` |
| 120 | Privacy Notice (Deutsch) | `PRIVACY_NOTICE_DE.md` |
| 121 | Privacy Notice (Français) | `PRIVACY_NOTICE_FR.md` |
| 122 | Privacy Notice (Español) | `PRIVACY_NOTICE_ES.md` |
| 123 | Privacy Engineering Guide | `PRIVACY_ENGINEERING_GUIDE.md` |
| 124 | Compliance Testing Plan | `COMPLIANCE_TESTING_PLAN.md` |
| 125 | Compliance Investment Case | `COMPLIANCE_INVESTMENT_CASE.md` |
| 126 | Vendor Compliance Tracker | `VENDOR_COMPLIANCE_TRACKER.md` |
| 127 | Privacy Metrics Dashboard | `PRIVACY_METRICS_DASHBOARD.md` |
| 128 | Compliance Evidence Log | `COMPLIANCE_EVIDENCE_LOG.md` |
| 129 | Privacy Impact Screening | `PRIVACY_IMPACT_SCREENING.md` |
...
|---------|----------|-----------|
| ActionCable | other | Yes |
| ActionController::Cookies | other | Yes |
| ActionMailer | email | Yes |
| Active Storage | storage | Yes |
| ActiveRecord | database | Yes |
| ActiveStorage | storage | Yes |
| aws-sdk-s3 | storage | Yes |
| intercom-ruby | other | Yes |
| nodemailer | email | Yes |
| pg | database | Yes |
| plaid | payment | Yes |
| rack-attack | other | Yes |
| rails-actionmailer | email | Yes |
| rails-activerecord | database | Yes |
| rails-sessions | auth | Yes |
| redis | database | Yes |
| ruby-openai | ai | Yes |
| sentry-ruby | monitoring | Yes |
| sidekiq | other | Yes |
| stripe | payment | Yes |
...
| Category | Sources |
|----------|---------|
| Personal Identity Data | rails-sessions |
| Financial Data | stripe, plaid |
| AI Interaction Data | ruby-openai |
| Communication Data | rails-actionmailer, nodemailer, ActionMailer |
| Technical & Diagnostic Data | sentry-ruby |
| User-Uploaded Content | aws-sdk-s3, ActiveStorage, Active Storage |
| Stored User Data | pg, redis, rails-activerecord, ActiveRecord, Redis (Cache) |
