...
| intercom-ruby | Third-party service integration | user profiles, email, name, conversations, user behavior |
| pg | Data storage and management | user data as defined in schema |
| Plaid | Payment processing and billing | bank account data, transaction history, account balances, financial institution data |
