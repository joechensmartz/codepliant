...
| plaid | Payment Processing | Organizational Controls (A.5), Technological Controls (A.8) |
...
*Data-collecting services detected: ruby-openai*
...
*Authentication services detected: rails-sessions*
...
*Data storage services detected: ActiveRecord, pg, rails-activerecord, redis, Active Storage, ActiveStorage, aws-sdk-s3*
