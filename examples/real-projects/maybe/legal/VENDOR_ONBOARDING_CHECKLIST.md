...
| 8 | intercom-ruby | Other | Low | Internal — classification depends on specific use case |
| 9 | nodemailer | Email Service | Medium | Confidential — processes email addresses, message content |
| 10 | pg | Database | High | Confidential — stores application data, potentially all data categories |
| 11 | plaid | Payment Processing | Critical | Restricted — processes payment card data, financial PII |
| 12 | rack-attack | Other | Low | Internal — classification depends on specific use case |
| 13 | rails-actionmailer | Email Service | Medium | Confidential — processes email addresses, message content |
| 14 | rails-activerecord | Database | High | Confidential — stores application data, potentially all data categories |
| 15 | rails-sessions | Authentication | High | Confidential — processes authentication credentials, identity data |
| 16 | redis | Database | High | Confidential — stores application data, potentially all data categories |
| 17 | ruby-openai | AI Service | Critical | Confidential — may process user content, prompts, PII |
| 18 | sentry-ruby | Error Monitoring | Medium | Internal — collects error logs, stack traces, device metadata |
| 19 | sidekiq | Other | Low | Internal — classification depends on specific use case |
| 20 | stripe | Payment Processing | Critical | Restricted — processes payment card data, financial PII |

> **Total vendors:** 20 | **Critical/High risk:** 11
