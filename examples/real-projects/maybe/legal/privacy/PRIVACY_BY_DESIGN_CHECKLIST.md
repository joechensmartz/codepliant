...
| intercom-ruby | other | user profiles, email, name, conversations, user behavior | Review data processing scope; assess DPA requirements |
...
| plaid | payment | bank account data, transaction history, account balances, financial institution data | PCI DSS compliance; DPA with processor; tokenization review |
