...
*Generated on 2026-03-16 | 20 services detected | 40 data categories*
...
| user profiles, email, name | intercom-ruby | Per retention policy | View, Export, Delete |
...
| bank account data, transaction history, account balances | plaid | Per retention policy | View, Export, Delete |
...
│  └─ Data points: 1,247                                  │
│                                                         │
│  Third-Party Services (20 connected)       │
...
- [ ] Add data aggregation from all 20 connected services
...
*This specification was auto-generated by Codepliant based on 20 detected services in your codebase. Implement this portal to give your users full control over their personal data.*
