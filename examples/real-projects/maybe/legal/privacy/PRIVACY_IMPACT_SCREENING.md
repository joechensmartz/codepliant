...
20 services detected, suggesting potentially large-scale processing.
...
20 services with database storage detected, suggesting data from multiple sources may be combined.
