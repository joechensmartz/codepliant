...
Here is your monthly compliance update for @chatwoot/chatwoot:
...
Codepliant has detected a new third-party service in @chatwoot/chatwoot:
...
This is an update regarding AI services in @chatwoot/chatwoot:
...
Payment processing compliance update for @chatwoot/chatwoot:
...
*This Compliance Communication Plan was generated by [Codepliant](https://github.com/joechensmartz/codepliant) based on automated code analysis of 32 service(s). Adapt the templates and cadences to match your organisation's size, structure, and regulatory environment. Review this plan quarterly.*