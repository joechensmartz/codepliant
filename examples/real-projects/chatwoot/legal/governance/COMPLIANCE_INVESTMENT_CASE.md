...
**[Your Company Name]** operates a technology stack with **32 detected service(s)** that fall under **4 regulatory framework(s)**. Non-compliance carries material financial, legal, and reputational risk.
...
Based on the 32 service(s) detected in **@chatwoot/chatwoot**, the following exposure areas have been identified:

### Analytics & Advertising (@amplitude/analytics-browser, Meta Pixel)
...
### Authentication & User Data (devise, omniauth, pundit, rails-sessions)
...
### Storage & Database (@aws-sdk/client-s3, Active Storage, ActiveRecord, ActiveStorage, aws-sdk-s3, google-cloud-storage, ioredis, pg, PostgreSQL (env), rails-activerecord, redis, Redis, Redis (env))
...
Based on **32 detected services** (large complexity):
...
| **Total estimated investment** | **$100,000 - $500,000** |

### Fine Avoidance Value

| Metric | Value |
|--------|-------|
| Estimated fine exposure without compliance | $5,000,000 - $50,000,000 |
| Estimated fine reduction with compliance program | 80 - 95% |
| Net fine avoidance value | **$5,000,000 - $50,000,000** |
...
Example: ($5,000,000 - $300,000) / $300,000 = 1,567% ROI
```
...
2. **Competitive advantage:** Enterprise customers increasingly require compliance documentation before signing contracts.
...
1. **Automated:** Codepliant generates 80+ compliance documents directly from code analysis — no manual data mapping required.
...
1. **Comprehensive coverage:** Documents cover GDPR, CCPA/CPRA, EU AI Act, PCI DSS.
...
*This compliance investment case was generated by [Codepliant](https://github.com/joechensmartz/codepliant) based on automated code analysis of 32 detected service(s). Figures are industry estimates and should be validated with qualified legal and financial counsel.*