...
graph LR
  ...
  subgraph DT3["AI Interaction Data"]
    DT3C["Collect"] --> DT3P["Process"]
    DT3P --> DT3S["Store"]
    DT3S --> DT3D["Delete\n90 days"]
  end

  subgraph DT4["Communication Data"]
    DT4C["Collect"] --> DT4P["Process"]
    DT4P --> DT4S["Store"]
    DT4S --> DT4D["Delete\n3 years"]
  end

  subgraph DT5["Technical  Error Data"]
    DT5C["Collect"] --> DT5P["Process"]
    DT5P --> DT5S["Store"]
    DT5S --> DT5D["Delete\n90 days"]
  end

  subgraph DT6["UserGenerated Content"]
    DT6C["Collect"] --> DT6P["Process"]
    DT6P --> DT6S["Store"]
    DT6S --> DT6D["Delete\nUntil account deletion"]
  end
  ...
  style DT6 fill:#fff8e1,stroke:#f9a825
```
...
**Sources:** @amplitude/analytics-browser, Meta Pixel
...
**Sources:** ActionMailer, MailHog, nodemailer, rails-actionmailer
...
**Sources:** @aws-sdk/client-s3, Active Storage, ActiveRecord, ActiveStorage, aws-sdk-s3, google-cloud-storage, ioredis, pg, PostgreSQL (env), rails-activerecord, redis, Redis, Redis (env)
