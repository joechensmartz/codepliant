...
|------|------|-----------------|
| Amplitude | Analytics | Product analytics — tracks user behavior, feature adoption, and engagement. |
| sentry-ruby | Error/Performance Monitoring | error data, stack traces, user context, device information |
...
[Your Company Name] uses 32 third-party services that may process employee data in the course of business operations. Employees should:
