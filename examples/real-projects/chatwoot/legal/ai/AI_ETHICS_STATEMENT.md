...
- **ruby-openai** — Processes: user prompts, conversation history, generated content
...
*This AI Ethics Statement was generated by [Codepliant](https://github.com/joechensmartz/codepliant) based on an automated scan of the **@chatwoot/chatwoot** codebase. It should be reviewed and customized by your legal, ethics, and AI governance teams to reflect your organization's specific values and commitments.*