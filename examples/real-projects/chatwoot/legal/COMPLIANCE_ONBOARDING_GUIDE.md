...
| devise | Authentication | email, password hash, session data, authentication tokens |
...
| omniauth | Authentication | email, name, OAuth tokens, profile data |
...
**Total services:** 32. Before integrating a new service, check with the compliance lead to ensure it is added to our sub-processor list and covered by a Data Processing Agreement.
