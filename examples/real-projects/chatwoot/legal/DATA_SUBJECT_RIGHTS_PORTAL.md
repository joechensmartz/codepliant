...
*Generated on 2026-03-16 | 32 services detected | 51 data categories*
...
|---------------|--------|-----------|---------|
| user behavior, device information, session data | @amplitude/analytics-browser | Per retention policy | View, Export, Delete |
| uploaded files, file metadata | @aws-sdk/client-s3 | Per retention policy | View, Export, Delete |
| phone numbers, voice call metadata, call recordings | @twilio/voice-sdk | Per retention policy | View, Export, Delete |
| real-time user data, connection metadata, channel subscriptions | ActionCable | Per retention policy | View, Export, Delete |
| session cookies, session data, CSRF tokens | ActionController::Cookies | Per retention policy | View, Export, Delete |
| email addresses, email content | ActionMailer | Per retention policy | View, Export, Delete |
| uploaded files, file metadata, storage service credentials | Active Storage | Per retention policy | View, Export, Delete |
| user data as defined in schema, timestamps, associations | ActiveRecord | Per retention policy | View, Export, Delete |
| uploaded files, file metadata, storage references | ActiveStorage | Per retention policy | View, Export, Delete |
| uploaded files, file metadata | aws-sdk-s3 | Per retention policy | View, Export, Delete |
| email, password hash, session data | devise | Per retention policy | View, Export, Delete |
| uploaded files, file metadata | google-cloud-storage | Per retention policy | View, Export, Delete |
| cached data, session data | ioredis | Per retention policy | View, Export, Delete |
| email content | MailHog | Per retention policy | View, Export, Delete |
| page views, conversion events, user behavior | Meta Pixel | Per retention policy | View, Export, Delete |
| email addresses, email content | nodemailer | Per retention policy | View, Export, Delete |
| email, name, OAuth tokens | omniauth | Per retention policy | View, Export, Delete |
| user data as defined in schema | pg | Per retention policy | View, Export, Delete |
| application data, user records | PostgreSQL (env) | Per retention policy | View, Export, Delete |
| user roles, authorization policies, access control data | pundit | Per retention policy | View, Export, Delete |
| IP addresses, request metadata | rack-attack | Per retention policy | View, Export, Delete |
| email addresses, email content | rails-actionmailer | Per retention policy | View, Export, Delete |
| user data as defined in schema | rails-activerecord | Per retention policy | View, Export, Delete |
| session cookies, CSRF tokens | rails-sessions | Per retention policy | View, Export, Delete |
| cached data, session data | redis | Per retention policy | View, Export, Delete |
| session data, cache data | Redis | Per retention policy | View, Export, Delete |
| session data, cache data | Redis (env) | Per retention policy | View, Export, Delete |
| user prompts, conversation history, generated content | ruby-openai | Per retention policy | View, Export, Delete |
| error data, stack traces, user context | sentry-ruby | Per retention policy | View, Export, Delete |
| job data, user data processed in background jobs | sidekiq | Per retention policy | View, Export, Delete |
| payment information, billing address, email | stripe | Per retention policy | View, Export, Delete |
| phone numbers, SMS message content, voice call metadata | twilio-ruby | Per retention policy | View, Export, Delete |
...
```json
{
  ...
  "third_party_sharing": [
    { "processor": "@amplitude/analytics-browser", "data_shared": ["user behavior","device information"], "purpose": "service_operation" },
    { "processor": "@aws-sdk/client-s3", "data_shared": ["uploaded files","file metadata"], "purpose": "service_operation" },
    { "processor": "@twilio/voice-sdk", "data_shared": ["phone numbers","voice call metadata"], "purpose": "service_operation" }
  ]
}
```
...
│  └─ Data points: 1,247                                  │
│                                                         │
│  Third-Party Services (32 connected)       │
│  ├─ @amplitude/analytics-browser: user behavior, device information
│  ├─ @aws-sdk/client-s3: uploaded files, file metadata
│  ├─ @twilio/voice-sdk: phone numbers, voice call metadata
│  ├─ ActionCable: real-time user data, connection metadata
│  ├─ ActionController::Cookies: session cookies, session data
│  └─ ... and 27 more
│                                                         │
└─────────────────────────────────────────────────────────┘
```
...
- [ ] Add data aggregation from all 32 connected services
...
*This specification was auto-generated by Codepliant based on 32 detected services in your codebase. Implement this portal to give your users full control over their personal data.*
