...
| Question | Answer |
|----------|--------|
| Do you require authentication for access? | [AUTO] Yes — authentication implemented via devise, omniauth, pundit, rails-sessions |
...
| Where is data stored? | [AUTO] Database services detected: ActiveRecord, ioredis, pg, PostgreSQL (env), rails-activerecord, redis, Redis, Redis (env) — [MANUAL] specify hosting region |
| Do you use cloud storage? | [AUTO] Yes — @aws-sdk/client-s3, Active Storage, ActiveStorage, aws-sdk-s3, google-cloud-storage detected |
...
| Do you use error monitoring / observability? | [AUTO] Yes — sentry-ruby |
...
| Question | Answer |
|----------|--------|
| How many third-party sub-processors do you use? | [AUTO] 32 sub-processor(s) detected |
...
| Question | Answer |
|----------|--------|
| Does the application use AI/ML services? | [AUTO] Yes — ruby-openai |
...
*This vendor security questionnaire was generated by [Codepliant](https://github.com/joechensmartz/codepliant) based on an automated scan of the **@chatwoot/chatwoot** codebase. Answers marked [AUTO] are derived from code analysis and should be verified. Answers marked [MANUAL] require input from your security and compliance teams. This document is not a substitute for a formal security assessment.*
