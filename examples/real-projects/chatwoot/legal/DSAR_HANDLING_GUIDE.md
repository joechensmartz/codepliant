...
> This guide provides step-by-step procedures for handling Data Subject Access Requests (DSARs) under the General Data Protection Regulation (GDPR) and the California Consumer Privacy Act (CCPA). It is tailored to the **@chatwoot/chatwoot** application based on automated code analysis.
...
The following map was auto-generated from code analysis of **@chatwoot/chatwoot**. It shows where personal data is stored, how to export it, how to delete it, and which third parties must be notified.
...
- **Third-party notification required:** Yes — contact Amplitude to forward the DSAR or use their GDPR/privacy API
...
- **Third-party notification required:** Yes — contact Amazon S3 (AWS) to forward the DSAR or use their GDPR/privacy API
...
- **How to export:** List and export all files associated with the user's account. Include file metadata (upload date, size, type).
- **How to delete:** Delete all user-uploaded files and associated metadata. Purge from CDN caches if applicable.
- **Third-party notification required:** Yes — contact google-cloud-storage to forward the DSAR or use their GDPR/privacy API
...
- **How to export:** Export recipient data and email engagement history from the email provider's dashboard or API. Include suppression lists and preferences.
- **How to delete:** Remove the user from all mailing lists, delete their contact record, and add them to the suppression list to prevent future emails.
- **Third-party notification required:** Yes — contact MailHog to forward the DSAR or use their GDPR/privacy API

### Meta Pixel

- **Category:** Advertising
- **Data collected:** page views, conversion events, user behavior, device information
- **Storage location:** Advertising network servers
- **How to export:** Export user ad targeting profiles, conversion data, and audience segment membership from the ad platform.
- **How to delete:** Remove user from ad targeting audiences and delete conversion data. Request removal from any lookalike audiences.
- **Third-party notification required:** Yes — contact Meta Pixel to forward the DSAR or use their GDPR/privacy API
...
- **Third-party notification required:** Yes — contact ruby-openai to forward the DSAR or use their GDPR/privacy API
...
- **Third-party notification required:** Yes — contact sentry-ruby to forward the DSAR or use their GDPR/privacy API
...
- **How to export:** Consult the service provider's documentation for data export procedures. Contact their DPO if no self-service export is available.
- **How to delete:** Contact the service provider to request deletion of all personal data. Document the request and any response received.
- **Third-party notification required:** Yes — contact twilio-ruby to forward the DSAR or use their GDPR/privacy API
...
|--------------|----------|----------------|
| Amplitude | Analytics / Tracking | Forward DSAR; confirm deletion/export |
| Amazon S3 (AWS) | File Storage | Forward DSAR; confirm deletion/export |
...
| google-cloud-storage | File Storage | Forward DSAR; confirm deletion/export |
| MailHog | Email / Communication | Forward DSAR; confirm deletion/export |
| Meta Pixel | Advertising | Forward DSAR; confirm deletion/export |
...
| ruby-openai | AI / Machine Learning | Forward DSAR; confirm deletion/export |
| sentry-ruby | Monitoring / Error Tracking | Forward DSAR; confirm deletion/export |
...
| twilio-ruby | Third-Party Service | Forward DSAR; confirm deletion/export |
...
*This DSAR Handling Guide was generated by [Codepliant](https://github.com/joechensmartz/codepliant) based on automated code analysis of the **@chatwoot/chatwoot** project. The service-specific data location map is derived from detected dependencies and may not capture all data stores. This document is a template and must be reviewed by a legal professional and your Data Protection Officer. It does not constitute legal advice.*