...
**Declared data collection:** user behavior, device information, session data
...
| user behavior | Review needed | Detected via scan | Assess whether this data is necessary for @amplitude/analytics-browser functionality |
| device information | Review needed | Detected via scan | Assess whether this data is necessary for @amplitude/analytics-browser functionality |
| session data | Review needed | Detected via scan | Assess whether this data is necessary for @amplitude/analytics-browser functionality |
...
**Declared data collection:** phone numbers, voice call metadata, call recordings, device information

| Data Field | Likely Needed? | Justification | Recommendation |
|-----------|---------------|---------------|----------------|
| phone numbers | Review needed | Detected via scan | Assess whether this data is necessary for @twilio/voice-sdk functionality |
| voice call metadata | Review needed | Detected via scan | Assess whether this data is necessary for @twilio/voice-sdk functionality |
| call recordings | Review needed | Detected via scan | Assess whether this data is necessary for @twilio/voice-sdk functionality |
| device information | Review needed | Detected via scan | Assess whether this data is necessary for @twilio/voice-sdk functionality |
...
| uploaded_files | Yes | User content storage | Implement file expiration for unused content; enforce size limits |
| file_metadata | Yes | File management | Delete metadata when files are deleted; do not retain orphaned metadata |
| uploaded files | Review needed | Detected via scan | Assess whether this data is necessary for google-cloud-storage functionality |
| file metadata | Review needed | Detected via scan | Assess whether this data is necessary for google-cloud-storage functionality |
...
**Declared data collection:** email content
...
| email_content | **No** | Delivery logs | Do not retain email body after delivery confirmation; delete logs after 90 days |
| open_tracking | **No** | Marketing metrics | Consider removing tracking pixels; they are not essential and raise privacy concerns |
| email content | Review needed | Detected via scan | Assess whether this data is necessary for MailHog functionality |



### Meta Pixel (Advertising)

**Declared data collection:** page views, conversion events, user behavior, device information

| Data Field | Likely Needed? | Justification | Recommendation |
|-----------|---------------|---------------|----------------|
| conversion_events | **No** | Ad campaign measurement — not essential for service delivery | Use aggregate conversion reporting; avoid individual-level tracking |
| device_fingerprint | **No** | Ad targeting | Eliminate device fingerprinting; use contextual advertising instead |
| cross_site_tracking | **No** | Behavioral advertising | Eliminate cross-site tracking; comply with GPC signals |
| page views | Review needed | Detected via scan | Assess whether this data is necessary for Meta Pixel functionality |
| conversion events | Review needed | Detected via scan | Assess whether this data is necessary for Meta Pixel functionality |
| user behavior | Review needed | Detected via scan | Assess whether this data is necessary for Meta Pixel functionality |
| device information | Review needed | Detected via scan | Assess whether this data is necessary for Meta Pixel functionality |
...
**Declared data collection:** phone numbers, SMS message content, voice call metadata

| Data Field | Likely Needed? | Justification | Recommendation |
|-----------|---------------|---------------|----------------|
| phone numbers | Review needed | Detected via scan | Assess whether this data is necessary for twilio-ruby functionality |
| SMS message content | Review needed | Detected via scan | Assess whether this data is necessary for twilio-ruby functionality |
| voice call metadata | Review needed | Detected via scan | Assess whether this data is necessary for twilio-ruby functionality |



## 3. Data Reduction Opportunities

The following 24 data field(s) are collected but **may not be necessary** for core service delivery:

| # | Data Field | Service | Recommendation |
|---|-----------|---------|----------------|
| 1 | page_views | @amplitude/analytics-browser | Use privacy-preserving analytics (e.g., aggregate counts); limit retention to 26 months |
| 2 | user_behavior | @amplitude/analytics-browser | Anonymize user identifiers; consider server-side analytics |
| 3 | device_info | @amplitude/analytics-browser | Collect browser/OS only; do not fingerprint devices |
| 4 | ip_address | @amplitude/analytics-browser | Truncate IP addresses (last octet); delete raw IPs after 90 days |
| 5 | email_content | ActionMailer | Do not retain email body after delivery confirmation; delete logs after 90 days |
| 6 | open_tracking | ActionMailer | Consider removing tracking pixels; they are not essential and raise privacy concerns |
| 7 | login_history | devise | Retain for 90 days max; anonymize after |
| 8 | email_content | MailHog | Do not retain email body after delivery confirmation; delete logs after 90 days |
| 9 | open_tracking | MailHog | Consider removing tracking pixels; they are not essential and raise privacy concerns |
| 10 | conversion_events | Meta Pixel | Use aggregate conversion reporting; avoid individual-level tracking |
| 11 | device_fingerprint | Meta Pixel | Eliminate device fingerprinting; use contextual advertising instead |
| 12 | cross_site_tracking | Meta Pixel | Eliminate cross-site tracking; comply with GPC signals |
| 13 | email_content | nodemailer | Do not retain email body after delivery confirmation; delete logs after 90 days |
| 14 | open_tracking | nodemailer | Consider removing tracking pixels; they are not essential and raise privacy concerns |
| 15 | login_history | omniauth | Retain for 90 days max; anonymize after |
| 16 | login_history | pundit | Retain for 90 days max; anonymize after |
| 17 | email_content | rails-actionmailer | Do not retain email body after delivery confirmation; delete logs after 90 days |
| 18 | open_tracking | rails-actionmailer | Consider removing tracking pixels; they are not essential and raise privacy concerns |
| 19 | login_history | rails-sessions | Retain for 90 days max; anonymize after |
| 20 | conversation_history | ruby-openai | Allow users to opt out; implement automatic expiration (30 days max) |
| 21 | generated_content | ruby-openai | Let users delete on demand; do not use for model training without consent |
| 22 | model_usage_metadata | ruby-openai | Aggregate and anonymize; delete individual records after 90 days |
| 23 | user_context | sentry-ruby | Use anonymized user IDs; do not send full user profiles |
| 24 | ip_address | sentry-ruby | Truncate or hash IP addresses in error reports |
...
| Total data fields assessed | 151 |
| Fields likely needed | 127 |
| Fields potentially unnecessary | 24 |
