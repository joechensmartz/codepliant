...
|---------------------|----------------|-----------|--------------|-----------|------------|
| **5** - Almost Certain | — | — | — | — | — |
| **4** - Likely | — | — | 🟠PR-001 | 🔴PR-004, 🔴PR-008 | — |
| **3** - Possible | — | — | 🟡PR-006, 🟡PR-007 | 🟠PR-005 | 🔴PR-002 |
| **2** - Unlikely | — | — | — | — | 🟠PR-003 |
| **1** - Rare | — | — | — | — | — |
...
|----|---------------------|------------|--------|-------|-------|----------|
| PR-004 | AI/ML data processing and model inference | 4 (Likely) | 4 (Major) | 16 | 🔴 Critical | ruby-openai |
| PR-008 | International data transfers to third-party processors | 4 (Likely) | 4 (Major) | 16 | 🔴 Critical | @amplitude/analytics-browser, @aws-sdk/client-s3, @twilio/voice-sdk, ActionCable, ActionController::Cookies, ActionMailer, Active Storage, ActiveRecord, ActiveStorage, aws-sdk-s3, devise, google-cloud-storage, ioredis, MailHog, Meta Pixel, nodemailer, omniauth, pg, PostgreSQL (env), pundit, rack-attack, rails-actionmailer, rails-activerecord, rails-sessions, redis, Redis, Redis (env), ruby-openai, sentry-ruby, sidekiq, stripe, twilio-ruby |
| PR-002 | User authentication and identity management | 3 (Possible) | 5 (Severe) | 15 | 🔴 Critical | devise, omniauth, pundit, rails-sessions |
| PR-001 | User behavior tracking and analytics | 4 (Likely) | 3 (Moderate) | 12 | 🟠 High | @amplitude/analytics-browser, Meta Pixel |
| PR-005 | Persistent data storage and retrieval | 3 (Possible) | 4 (Major) | 12 | 🟠 High | ActiveRecord, ioredis, pg, PostgreSQL (env), rails-activerecord, redis, Redis, Redis (env) |
| PR-003 | Payment processing and financial data handling | 2 (Unlikely) | 5 (Severe) | 10 | 🟠 High | stripe |
| PR-006 | File and object storage | 3 (Possible) | 3 (Moderate) | 9 | 🟡 Medium | @aws-sdk/client-s3, Active Storage, ActiveStorage, aws-sdk-s3, google-cloud-storage |
| PR-007 | Email communications and marketing | 3 (Possible) | 3 (Moderate) | 9 | 🟡 Medium | ActionMailer, MailHog, nodemailer, rails-actionmailer |
...
### PR-008: International data transfers to third-party processors 🔴

**Risk Level:** Critical (16/25)  
**Likelihood:** 4/5 (Likely)  
**Impact:** 4/5 (Major)  
**Affected Services:** @amplitude/analytics-browser, @aws-sdk/client-s3, @twilio/voice-sdk, ActionCable, ActionController::Cookies, ActionMailer, Active Storage, ActiveRecord, ActiveStorage, aws-sdk-s3, devise, google-cloud-storage, ioredis, MailHog, Meta Pixel, nodemailer, omniauth, pg, PostgreSQL (env), pundit, rack-attack, rails-actionmailer, rails-activerecord, rails-sessions, redis, Redis, Redis (env), ruby-openai, sentry-ruby, sidekiq, stripe, twilio-ruby
...
**Likelihood:** 4/5 (Likely)  
**Impact:** 3/5 (Moderate)  
**Affected Services:** @amplitude/analytics-browser, Meta Pixel
...
**Likelihood:** 3/5 (Possible)  
**Impact:** 4/5 (Major)  
**Affected Services:** ActiveRecord, ioredis, pg, PostgreSQL (env), rails-activerecord, redis, Redis, Redis (env)
...
### PR-006: File and object storage 🟡

**Risk Level:** Medium (9/25)  
**Likelihood:** 3/5 (Possible)  
**Impact:** 3/5 (Moderate)  
**Affected Services:** @aws-sdk/client-s3, Active Storage, ActiveStorage, aws-sdk-s3, google-cloud-storage
...
### PR-007: Email communications and marketing 🟡

**Risk Level:** Medium (9/25)  
**Likelihood:** 3/5 (Possible)  
**Impact:** 3/5 (Moderate)  
**Affected Services:** ActionMailer, MailHog, nodemailer, rails-actionmailer
