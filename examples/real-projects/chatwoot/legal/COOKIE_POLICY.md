...
|---------|---------|---------|----------|
| @amplitude/analytics-browser | amp_* | Product analytics | 10 years |
| Meta Pixel | Various | Service functionality | Varies |
...
- **@amplitude/analytics-browser**: Used for user behavior, device information, session data
- **Meta Pixel**: Used for page views, conversion events, user behavior
- **devise**: Used for email, password hash, session data
- **omniauth**: Used for email, name, OAuth tokens
- **pundit**: Used for user roles, authorization policies, access control data
- **rails-sessions**: Used for session cookies, CSRF tokens
