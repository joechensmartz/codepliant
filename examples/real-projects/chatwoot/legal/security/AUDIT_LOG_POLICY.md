...
This policy defines what events are logged across the **@chatwoot/chatwoot** application, how long logs are retained, and who has access to audit data. It supports compliance with GDPR Article 30 (records of processing activities), SOC 2 Trust Service Criteria (CC7.2 — monitoring), and internal security requirements.
...
|---------|----------|--------------|
| @amplitude/analytics-browser | analytics | User events; User properties; Session data; Revenue events |
| devise | auth | Application events, user interactions, system metrics |
| omniauth | auth | Application events, user interactions, system metrics |
| pundit | auth | Application events, user interactions, system metrics |
| rails-sessions | auth | Application events, user interactions, system metrics |
| sentry-ruby | monitoring | Application events, user interactions, system metrics |
