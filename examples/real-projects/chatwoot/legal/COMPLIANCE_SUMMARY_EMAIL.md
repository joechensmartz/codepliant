...
[Your Company Name] currently operates **32 third-party service(s)** that process user data. A total of **85 compliance document(s)** have been generated covering all applicable regulatory requirements.

| Metric | Value |
|--------|-------|
| Overall Compliance Grade | **A** (Green) |
| Critical Document Coverage | 100% |
| Services Detected | 32 |
| Documents Generated | 85 |
...
|----------|-------|----------|
| Advertising | 1 | Meta Pixel |
| Ai | 1 | ruby-openai |
| Analytics | 1 | @amplitude/analytics-browser |
| Auth | 4 | devise, omniauth, pundit, rails-sessions |
| Database | 8 | ActiveRecord, ioredis, pg, PostgreSQL (env), rails-activerecord, redis, Redis, Redis (env) |
| Email | 4 | ActionMailer, MailHog, nodemailer, rails-actionmailer |
| Monitoring | 1 | sentry-ruby |
| Other | 6 | @twilio/voice-sdk, ActionCable, ActionController::Cookies, rack-attack, sidekiq, twilio-ruby |
| Payment | 1 | stripe |
| Storage | 5 | @aws-sdk/client-s3, Active Storage, ActiveStorage, aws-sdk-s3, google-cloud-storage |

---

## Key Risks

1. **AI/ML Services Detected** (ruby-openai): EU AI Act Art. 50 transparency obligations apply. AI Disclosure document required.
2. **Payment Processing** (stripe): PCI DSS compliance required. Data Processing Agreement must list payment sub-processors.
3. **High Service Count** (32 services): Large attack surface increases data breach risk. Sub-processor management is critical.
4. **Analytics/Monitoring** (@amplitude/analytics-browser, sentry-ruby): Cookie consent and tracking disclosure required under GDPR/ePrivacy.
...
- [ ] Verify PCI DSS compliance and DPA coverage for payment processors
...
| EU AI Act | Covered | AI Disclosure, AI Model Card, AI Governance Framework |
| ePrivacy (Cookies) | Covered | Cookie Policy, Cookie Inventory, Consent Guide |
| PCI DSS | Partial | Security Policy, Encryption Policy, Access Control |
...
*Report generated from analysis of 32 service(s) across 10 categories.*