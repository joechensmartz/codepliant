...
Based on the 32 service(s) detected in **@chatwoot/chatwoot**, the following obligations apply:
...
### Analytics / Advertising Services (@amplitude/analytics-browser, Meta Pixel)
...
### Storage / Database Services (@aws-sdk/client-s3, Active Storage, ActiveRecord, ActiveStorage, aws-sdk-s3, google-cloud-storage, ioredis, pg, PostgreSQL (env), rails-activerecord, redis, Redis, Redis (env))
