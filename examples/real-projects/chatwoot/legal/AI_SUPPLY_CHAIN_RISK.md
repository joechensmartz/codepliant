...
[Your Company Name] currently depends on **1 AI service(s)** from **1 provider(s)** for core product functionality. This creates supply chain dependencies that must be actively managed.
