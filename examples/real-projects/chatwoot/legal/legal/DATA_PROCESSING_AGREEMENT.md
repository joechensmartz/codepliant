...
> This Data Processing Agreement ("DPA") is entered into pursuant to Article 28 of the General Data Protection Regulation (EU) 2016/679 ("GDPR"). It governs the processing of personal data by third-party processors on behalf of the Controller in connection with the **@chatwoot/chatwoot** application.
...
- **Advertising & Conversion Data:** Conversion events, page views, user interactions, and device information collected through advertising pixels and tracking scripts.
...
- **Authentication Data:** passwords detected in OpenAPI/Swagger spec fields: profile.password, user_create_update_payload.password, RequestBody.password (PUT /api/v1/accounts/{account_id}/integrations/hooks/{hook_id}), RequestBody.password (PUT /api/v1/profile).
