...
- **devise** — integrated authentication provider
- **omniauth** — integrated authentication provider
- **pundit** — integrated authentication provider
- **rails-sessions** — integrated authentication provider
...
The API integrates AI services (ruby-openai). Additional restrictions apply:
...
API health and performance are monitored via sentry-ruby. Status updates are provided at our status page during incidents.
