...
**Export Formats:** JSON, CSV, gzip
**Export URL:** https://analytics.amplitude.com/settings > Data Export
**API Endpoint:** `https://amplitude.com/api/2/export`
**Estimated Time:** Export API returns data within 1 hour

**Steps:**

1. Log in to Amplitude and navigate to Settings
2. Go to Organization Settings > Data Export
3. Use the Export API to retrieve raw event data
...
*This data portability guide was generated by [Codepliant](https://github.com/joechensmartz/codepliant) based on an automated scan of the **@chatwoot/chatwoot** codebase. It should be reviewed by your legal and engineering teams to ensure completeness and accuracy. Export instructions may change as third-party services update their APIs and dashboards.*