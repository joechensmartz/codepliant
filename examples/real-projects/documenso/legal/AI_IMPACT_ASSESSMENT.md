...
|---------|---------------|----------------|-----------------|------------|
| @ai-sdk/google-vertex | user prompts, conversation history, generated content | **Limited** | N/A | Semi-annual review |
...
### 3.1 @ai-sdk/google-vertex

| Field | Detail |
|-------|--------|
| **Service** | `@ai-sdk/google-vertex` |
| **Category** | ai |
