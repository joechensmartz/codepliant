...
This Business Continuity Plan (BCP) defines recovery objectives, failover procedures, and communication protocols for **[Your Company Name]**'s **@documenso/root** application. It ensures that critical services can be restored within acceptable timeframes following an outage, disaster, or other disruptive event.
...
|---------|----------|-----|-----|-------------------|
| @simplewebauthn/server | Authentication | 1 hour | 0 minutes | Session cache failover; extend existing tokens |
...
| Service | Category | RTO | RPO | Recovery Strategy |
|---------|----------|-----|-----|-------------------|
| @aws-sdk/client-ses | Email | 4 hours | 1 hour | Queue with retry; alternative SMTP provider |
| nodemailer | Email | 4 hours | 1 hour | Queue with retry; alternative SMTP provider |
| resend | Email | 4 hours | 1 hour | Queue with retry; alternative SMTP provider |
| @ai-sdk/google-vertex | AI Service | 4 hours | 1 hour | Graceful degradation; disable AI features |
...
|----------|--------------------|----------------|
| Railway | Not specified | Railway operates primarily on GCP infrastructure |
...
Detected database service(s): prisma
...
Detected auth service(s): @simplewebauthn/server, next-auth, passport-microsoft
...
Detected AI service(s): @ai-sdk/google-vertex, @vercel/ai
...
|---------|----------|----------------------|--------------------------|
| @ai-sdk/google-vertex | ai | AI-powered features unavailable | Disable AI features; show static content |
| @aws-sdk/client-ses | email | Transactional emails delayed or undelivered | Alternative email provider; manual send |
| @google-cloud/kms | other | Feature degradation | Evaluate per service |
| @simplewebauthn/server | auth | Users cannot sign in or register | Cached sessions; manual verification |
...
| resend | email | Transactional emails delayed or undelivered | Alternative email provider; manual send |
...
*This Business Continuity Plan was generated by [Codepliant](https://github.com/joechensmartz/codepliant) based on an automated scan of the **@documenso/root** codebase. Recovery objectives and procedures should be reviewed and customized by your engineering and operations teams based on actual infrastructure and business requirements.*