# Employee Handbook — Privacy & Monitoring Section
...
> **Internal document.** This section is intended for inclusion in the [Your Company Name] employee handbook. It describes the company's policies on workplace monitoring, device usage, email monitoring, and employee data privacy. All employees and contractors are expected to read and acknowledge this section.

---

## 1. Purpose & Scope

This section of the employee handbook establishes [Your Company Name]'s policies regarding:
...
These policies apply to all employees, contractors, interns, and temporary workers who use [Your Company Name]'s systems, networks, or devices.

## 2. Workplace Monitoring Policy

### 2.1 Monitoring Principles

[Your Company Name] monitors certain workplace systems for the following legitimate purposes:
...
The following monitoring and analytics tools are currently deployed in [Your Company Name]'s systems:

| Tool | Type | What It Collects |
|------|------|-----------------|
| PostHog | Analytics | Product analytics — tracks feature usage, page views, and user interactions. |
...
Company-issued devices (laptops, phones, tablets) are provided for business purposes. [Your Company Name] reserves the right to:
...
If [Your Company Name] permits use of personal devices for work:

- Only approved applications may access company data
- Mobile Device Management (MDM) software may be required
- [Your Company Name] can remotely wipe **company data only** (not personal data) from the device
- Employees must maintain minimum security standards (screen lock, OS updates, encryption)

### 3.3 Software & Cloud Services

[Your Company Name] uses 13 third-party services that may process employee data in the course of business operations. Employees should:
...
- **Company email is not private.** [Your Company Name] may access, monitor, or review company email accounts for legitimate business purposes including security, compliance, legal proceedings, and business continuity.
...
The following email services are currently integrated into [Your Company Name]'s systems:

| Service | Purpose |
|---------|---------|
| @aws-sdk/client-ses (email addresses, email content, uploaded files, file metadata) |
| Nodemailer (email sending — may log outbound email metadata) |
| Resend (email API — logs delivery status and engagement metrics) |


### 4.3 Messaging & Collaboration Tools

[Your Company Name] may monitor usage of company-provided collaboration tools (e.g., Slack, Teams, project management tools) in the same manner as email. Employees should:
...
[Your Company Name] uses the following AI services in its systems:
...
- Follow any additional AI usage guidelines provided by [Your Company Name]

## 6. Employee Data Privacy Rights

### 6.1 What Data We Collect About Employees

In addition to standard HR data (identity, employment, payroll), [Your Company Name] may collect technical data through the monitoring tools described above, including:
...
[Your Company Name] reserves the right to update these policies as monitoring tools, business needs, or legal requirements change. Employees will be notified of material changes before they take effect.

### Employee Acknowledgment

By signing below, I acknowledge that I have read and understood the Privacy & Monitoring section of the [Your Company Name] employee handbook.
...
*This Employee Handbook Privacy Section was auto-generated by [Codepliant](https://github.com/joechensmartz/codepliant) based on a scan of the project's codebase. It should be reviewed by your legal and HR teams before distribution to employees.*