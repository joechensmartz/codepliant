...
[Your Company Name] currently depends on **2 AI service(s)** from **1 provider(s)** for core product functionality. This creates supply chain dependencies that must be actively managed.

| Metric | Value |
|--------|-------|
| AI Services Detected | 2 |
| Unique Providers | 1 |
| Overall Risk Level | **High** |
| Single-Provider Dependency | Yes (CRITICAL) |
| Estimated Monthly AI Spend | $1,000–$10,000 |
| Migration Plans Documented | See Section 4 |

> **WARNING:** All AI functionality depends on a single provider (Google AI). A provider outage, pricing change, or API deprecation would affect 100% of AI features. Diversification is strongly recommended.

## 2. Provider Risk Profiles

### Google AI

**Detected as:** @ai-sdk/google-vertex
...
| Pricing Model | Per-token + Vertex AI platform fees |
| Migration Complexity | High |
| Data Residency | US, EU, Asia-Pacific |
...
| Impact Area | Details |
|-------------|---------|
| Estimated Current Spend | $1,000–$10,000 /month |
...
### Migrating Away from Google AI

**Complexity:** High

**Steps:**

1. **Evaluate alternatives:** OpenAI (GPT), Anthropic (Claude), Mistral AI
...
2. **CRITICAL:** Diversify beyond Google AI — evaluate at least one alternative for each AI capability
