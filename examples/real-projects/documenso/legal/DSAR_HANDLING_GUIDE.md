...
> This guide provides step-by-step procedures for handling Data Subject Access Requests (DSARs) under the General Data Protection Regulation (GDPR) and the California Consumer Privacy Act (CCPA). It is tailored to the **@documenso/root** application based on automated code analysis.
...
The following map was auto-generated from code analysis of **@documenso/root**. It shows where personal data is stored, how to export it, how to delete it, and which third parties must be notified.
...
- **Third-party notification required:** Yes — contact Vercel AI SDK (Google Vertex) to forward the DSAR or use their GDPR/privacy API
...
- **Third-party notification required:** Yes — contact Amazon SES (AWS) to forward the DSAR or use their GDPR/privacy API
...
- **Third-party notification required:** Yes — contact Google Cloud KMS to forward the DSAR or use their GDPR/privacy API
...
|--------------|----------|----------------|
| Vercel AI SDK (Google Vertex) | AI / Machine Learning | Forward DSAR; confirm deletion/export |
| Amazon SES (AWS) | Email / Communication | Forward DSAR; confirm deletion/export |
| Google Cloud KMS | Third-Party Service | Forward DSAR; confirm deletion/export |
...
*This DSAR Handling Guide was generated by [Codepliant](https://github.com/joechensmartz/codepliant) based on automated code analysis of the **@documenso/root** project. The service-specific data location map is derived from detected dependencies and may not capture all data stores. This document is a template and must be reviewed by a legal professional and your Data Protection Officer. It does not constitute legal advice.*