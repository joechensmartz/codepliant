...
- 13 third-party data processors detected (systematic processing at scale)
...
### 5.2 Systems to Query (13 detected)

- **@ai-sdk/google-vertex** (ai): user prompts, conversation history, generated content
- **@aws-sdk/client-ses** (email): email addresses, email content, uploaded files
...
*This DPO Handbook was generated by [Codepliant](https://github.com/joechensmartz/codepliant) based on an automated scan of the **@documenso/root** codebase. It should be reviewed and customized by your legal team and appointed DPO before adoption.*
