...
| Question | Answer |
|----------|--------|
| Do you require authentication for access? | [AUTO] Yes — authentication implemented via @simplewebauthn/server, next-auth, passport-microsoft |
...
| Do you use a key management service? | [AUTO] Yes — KMS service detected |
...
| Question | Answer |
|----------|--------|
| How many third-party sub-processors do you use? | [AUTO] 13 sub-processor(s) detected |
...
| Question | Answer |
|----------|--------|
| Does the application use AI/ML services? | [AUTO] Yes — @ai-sdk/google-vertex, @vercel/ai |
...
*This vendor security questionnaire was generated by [Codepliant](https://github.com/joechensmartz/codepliant) based on an automated scan of the **@documenso/root** codebase. Answers marked [AUTO] are derived from code analysis and should be verified. Answers marked [MANUAL] require input from your security and compliance teams. This document is not a substitute for a formal security assessment.*
