...
|---|--------|----------|-----------|-------------------|
| 1 | @ai-sdk/google-vertex | AI Service | Critical | Confidential — may process user content, prompts, PII |
| 2 | @aws-sdk/client-ses | Email Service | Medium | Confidential — processes email addresses, message content |
| 3 | @google-cloud/kms | Other | Low | Internal — classification depends on specific use case |
| 4 | @simplewebauthn/server | Authentication | High | Confidential — processes authentication credentials, identity data |
| 5 | @vercel/ai | AI Service | Critical | Confidential — may process user content, prompts, PII |
| 6 | googleapis | Other | Low | Internal — classification depends on specific use case |
| 7 | next-auth | Authentication | High | Confidential — processes authentication credentials, identity data |
| 8 | nodemailer | Email Service | Medium | Confidential — processes email addresses, message content |
| 9 | passport-microsoft | Authentication | High | Confidential — processes authentication credentials, identity data |
| 10 | posthog | Analytics | Medium | Internal — collects behavioral data, device info, IP addresses |
| 11 | prisma | Database | High | Confidential — stores application data, potentially all data categories |
| 12 | resend | Email Service | Medium | Confidential — processes email addresses, message content |
| 13 | stripe | Payment Processing | Critical | Restricted — processes payment card data, financial PII |

> **Total vendors:** 13 | **Critical/High risk:** 7
