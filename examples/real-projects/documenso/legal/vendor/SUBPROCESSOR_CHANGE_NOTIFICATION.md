...
|--------------|---------|---------------|
| Vercel AI SDK (Google Vertex) | AI processing and content generation | user prompts, conversation history, generated content |
| Amazon SES (AWS) | Transactional and marketing email delivery | email addresses, email content, uploaded files, file metadata |
| Google Cloud KMS | Third-party service integration | encryption keys, key metadata |
