...
This document provides a risk assessment of all third-party services integrated into the **@documenso/root** application. Each vendor has been evaluated for data sensitivity, geographic risk, compliance certifications, data processing scope, and risk mitigation measures.

Total third-party vendors assessed: **8**
...
|--------|----------|-----------------|----------------|---------------|-------------|
| Vercel AI SDK (Google Vertex) | ai | high | US | SOC 2 Type II, GDPR | Critical |
| Amazon SES (AWS) | email | medium | US | SOC 2 Type II, ISO 27001, GDPR, HIPAA | Medium |
| Google Cloud KMS | other | low | US | SOC 2 Type II, ISO 27001, GDPR, HIPAA | Low |
| Vercel AI SDK | ai | high | US | SOC 2 Type II, GDPR | Critical |
...
|-----------|--------|
| **Category** | email |
| **Data Processed** | email addresses, email content, uploaded files, file metadata |
...
|-----------|--------|
| **Category** | other |
| **Data Processed** | encryption keys, key metadata |
