...
[Your Company Name] operates a technology stack comprising **13 third-party services** across 7 categories. This report provides an overview of our compliance posture, key risks, regulatory developments, and budget status for Q1 2026.
...
|----------|----------|------------|-------------|
| AI / Machine Learning | 2 | High | EU AI Act compliance, bias, hallucination risk |
...
| Email | 3 | Medium | Vendor dependency, data processing |
| Other | 2 | Medium | Vendor dependency, data processing |
...
2. **Prioritize EU AI Act readiness** — With 2 AI service(s) detected, complete risk classification and establish conformity assessment procedures before enforcement deadlines.

3. **Vendor consolidation review** — With 13 third-party services, evaluate opportunities to reduce vendor footprint and associated compliance overhead.
...
|---|---------|----------|----------------|----------------|
| 1 | @ai-sdk/google-vertex | ai | Yes | user prompts, conversation history, generated content |
| 2 | @aws-sdk/client-ses | email | Yes | email addresses, email content, uploaded files +1 more |
| 3 | @google-cloud/kms | other | Yes | encryption keys, key metadata |
| 4 | @simplewebauthn/server | auth | Yes | biometric authentication data, device attestation, credential IDs |
| 5 | @vercel/ai | ai | Yes | user prompts, conversation history, generated content |
| 6 | googleapis | other | Yes | user data via Google APIs, calendar data, email data +1 more |
| 7 | next-auth | auth | Yes | email, name, profile picture +2 more |
| 8 | nodemailer | email | Yes | email addresses, email content |
| 9 | passport-microsoft | auth | Yes | email, name, Microsoft profile data +1 more |
| 10 | posthog | analytics | Yes | user behavior, session recordings, feature flag usage +1 more |
| 11 | prisma | database | Yes | user data as defined in schema |
| 12 | resend | email | Yes | email addresses, email content |
| 13 | stripe | payment | Yes | payment information, billing address, email +1 more |

---

*This board report was generated by [Codepliant](https://github.com/joechensmartz/codepliant) based on automated source code analysis of the **@documenso/root** codebase (13 services detected). Sections marked with [brackets] require manual input from the compliance team. This report should be reviewed and supplemented with operational data before board presentation. Generated on 2026-03-16.*
