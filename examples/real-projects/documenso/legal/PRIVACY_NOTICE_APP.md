...
- Service providers who help us run the app: @ai-sdk/google-vertex, @aws-sdk/client-ses, @google-cloud/kms, @simplewebauthn/server, @vercel/ai, googleapis + 7 more
...
This app uses AI (@ai-sdk/google-vertex, @vercel/ai):
