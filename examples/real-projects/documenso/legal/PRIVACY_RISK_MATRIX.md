...
|----|---------------------|------------|--------|-------|-------|----------|
| PR-004 | AI/ML data processing and model inference | 4 (Likely) | 4 (Major) | 16 | 🔴 Critical | @ai-sdk/google-vertex, @vercel/ai |
| PR-007 | International data transfers to third-party processors | 4 (Likely) | 4 (Major) | 16 | 🔴 Critical | @ai-sdk/google-vertex, @aws-sdk/client-ses, @google-cloud/kms, @simplewebauthn/server, @vercel/ai, googleapis, next-auth, nodemailer, passport-microsoft, posthog, prisma, resend, stripe |
| PR-002 | User authentication and identity management | 3 (Possible) | 5 (Severe) | 15 | 🔴 Critical | @simplewebauthn/server, next-auth, passport-microsoft |
...
| PR-006 | Email communications and marketing | 3 (Possible) | 3 (Moderate) | 9 | 🟡 Medium | @aws-sdk/client-ses, nodemailer, resend |
...
**Impact:** 4/5 (Major)  
**Affected Services:** @ai-sdk/google-vertex, @vercel/ai
...
**Likelihood:** 4/5 (Likely)  
**Impact:** 4/5 (Major)  
**Affected Services:** @ai-sdk/google-vertex, @aws-sdk/client-ses, @google-cloud/kms, @simplewebauthn/server, @vercel/ai, googleapis, next-auth, nodemailer, passport-microsoft, posthog, prisma, resend, stripe
...
**Impact:** 5/5 (Severe)  
**Affected Services:** @simplewebauthn/server, next-auth, passport-microsoft
...
**Likelihood:** 3/5 (Possible)  
**Impact:** 3/5 (Moderate)  
**Affected Services:** @aws-sdk/client-ses, nodemailer, resend
