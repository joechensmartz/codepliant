...
|-----------------|----------|---------------------------|
| @ai-sdk/google-vertex | AI Service | Organizational Controls (A.5), People Controls (A.6), Technological Controls (A.8) |
| @aws-sdk/client-ses | Email Service | Organizational Controls (A.5), Technological Controls (A.8) |
| @google-cloud/kms | Other | General |
| @simplewebauthn/server | Authentication | Organizational Controls (A.5), Technological Controls (A.8) |
...
| resend | Email Service | Organizational Controls (A.5), Technological Controls (A.8) |
...
*Data-collecting services detected: posthog, @ai-sdk/google-vertex, @vercel/ai*
...
*Authentication services detected: @simplewebauthn/server, next-auth, passport-microsoft*
...
*Data storage services detected: prisma*
...
*AI services detected: @ai-sdk/google-vertex, @vercel/ai*
