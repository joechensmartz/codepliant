...
|-----------------|----------|----------------------|
| @ai-sdk/google-vertex | AI Service | Processing Integrity (PI1), Confidentiality (C1), Privacy (P1-P8) |
| @aws-sdk/client-ses | Email Service | Confidentiality (C1), Privacy (P1-P8) |
| @google-cloud/kms | Other | General |
| @simplewebauthn/server | Authentication | Security (CC6) |
...
- [ ] Review access control configuration for: @simplewebauthn/server, next-auth, passport-microsoft
...
- [ ] Enable encryption at rest for: prisma
...
- [ ] Validate AI model inputs and outputs for: @ai-sdk/google-vertex, @vercel/ai
...
- [ ] Enable transparent data encryption (TDE) or equivalent for: prisma
...
- [ ] Disclose third-party data sharing for: posthog, @ai-sdk/google-vertex, @vercel/ai
