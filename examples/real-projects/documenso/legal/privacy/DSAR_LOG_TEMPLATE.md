...
|---------|----------|----------------|-----------------|
| @ai-sdk/google-vertex | ai | user prompts, conversation history, generated content | Export / Delete / Rectify |
| @aws-sdk/client-ses | email | email addresses, email content, uploaded files, file metadata | Export / Delete / Rectify |
| @google-cloud/kms | other | encryption keys, key metadata | Export / Delete / Rectify |
| @simplewebauthn/server | auth | biometric authentication data, device attestation, credential IDs | Export / Delete / Rectify |
