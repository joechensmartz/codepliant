...
| **Scope** | AI/ML services: @ai-sdk/google-vertex, @vercel/ai |
...
| **Scope** | All 13 detected services and general data processing |
...
| **Data Categories** | Personal Identity Data, Financial Data, Usage & Behavioral Data, AI Interaction Data, Communication Data, Stored User Data |
...
|---------|----------|---------------|---------------|-------------------|
| @ai-sdk/google-vertex | ai | user prompts, conversation history, generated content | Yes | Pending |
| @aws-sdk/client-ses | email | email addresses, email content, uploaded files | Review needed | Pending |
| @google-cloud/kms | other | encryption keys, key metadata | Review needed | Pending |
| @simplewebauthn/server | auth | biometric authentication data, device attestation, credential IDs | Review needed | Pending |
