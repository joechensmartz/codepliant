...
| **Recipients / Processors** | @simplewebauthn/server, next-auth, passport-microsoft |
...
| **Recipients / Processors** | @aws-sdk/client-ses, nodemailer, resend |
...
| **Recipients / Processors** | @ai-sdk/google-vertex, @vercel/ai |
...
|----------|-----------|-----------|
| PA-001: User Authentication & Account Management | @simplewebauthn/server, next-auth, passport-microsoft | Standard Contractual Clauses (SCCs) |
...
| PA-004: Email Communications | @aws-sdk/client-ses, nodemailer, resend | Standard Contractual Clauses (SCCs) |
| PA-005: AI-Powered Features & Processing | @ai-sdk/google-vertex, @vercel/ai | Standard Contractual Clauses, Data Processing Addendum with AI provider |
