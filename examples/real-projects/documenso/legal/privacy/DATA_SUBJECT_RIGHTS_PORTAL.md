...
*Generated on 2026-03-16 | 13 services detected | 30 data categories*
...
|---------------|--------|-----------|---------|
| user prompts, conversation history, generated content | @ai-sdk/google-vertex | Per retention policy | View, Export, Delete |
| email addresses, email content, uploaded files | @aws-sdk/client-ses | Per retention policy | View, Export, Delete |
| encryption keys, key metadata | @google-cloud/kms | Per retention policy | View, Export, Delete |
| biometric authentication data, device attestation, credential IDs | @simplewebauthn/server | Per retention policy | View, Export, Delete |
...
| email addresses, email content | resend | Per retention policy | View, Export, Delete |
...
```json
{
  ...
  "third_party_sharing": [
    { "processor": "@ai-sdk/google-vertex", "data_shared": ["user prompts","conversation history"], "purpose": "service_operation" },
    { "processor": "@aws-sdk/client-ses", "data_shared": ["email addresses","email content"], "purpose": "service_operation" },
    { "processor": "@google-cloud/kms", "data_shared": ["encryption keys","key metadata"], "purpose": "service_operation" }
  ]
}
```
...
│  └─ Data points: 1,247                                  │
│                                                         │
│  Third-Party Services (13 connected)       │
│  ├─ @ai-sdk/google-vertex: user prompts, conversation history
│  ├─ @aws-sdk/client-ses: email addresses, email content
│  ├─ @google-cloud/kms: encryption keys, key metadata
│  ├─ @simplewebauthn/server: biometric authentication data, device attestation
│  ├─ @vercel/ai: user prompts, conversation history
│  └─ ... and 8 more
│                                                         │
└─────────────────────────────────────────────────────────┘
```
...
- [ ] Add data aggregation from all 13 connected services
...
*This specification was auto-generated by Codepliant based on 13 detected services in your codebase. Implement this portal to give your users full control over their personal data.*
