...
**Services:** @ai-sdk/google-vertex, @vercel/ai
...
**Services:** @aws-sdk/client-ses, nodemailer, resend
...
**Services:** @google-cloud/kms, googleapis

**Data processed:** encryption keys, key metadata, user data via Google APIs, calendar data, email data, profile information
...
**Services:** @simplewebauthn/server, next-auth, passport-microsoft

**Data processed:** biometric authentication data, device attestation, credential IDs, email, name, profile picture, OAuth tokens, session data, Microsoft profile data
