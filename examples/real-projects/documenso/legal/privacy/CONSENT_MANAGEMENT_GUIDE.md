...
|---------|----------|----------------|-----------------|
| @ai-sdk/google-vertex | ai | user prompts, conversation history, generated content | Must not load until user consents |
| @vercel/ai | ai | user prompts, conversation history, generated content | Must not load until user consents |
...
|---------|----------|----------------|-------|
| @aws-sdk/client-ses | email | email addresses, email content, uploaded files | Document in LIA; provide opt-out |
| nodemailer | email | email addresses, email content | Document in LIA; provide opt-out |
| resend | email | email addresses, email content | Document in LIA; provide opt-out |
...
| Service | Category | Data Collected | Notes |
|---------|----------|----------------|-------|
| @simplewebauthn/server | auth | biometric authentication data, device attestation, credential IDs | Essential for service delivery |
| next-auth | auth | email, name, profile picture | Essential for service delivery |
| passport-microsoft | auth | email, name, Microsoft profile data | Essential for service delivery |
...
|----------|----------|---------------|
| Strictly Necessary | @simplewebauthn/server, next-auth, passport-microsoft, prisma, stripe | Always active (no toggle) |
| Analytics | posthog | Off until consented |
| AI Services | @ai-sdk/google-vertex, @vercel/ai | Off until consented |
...
#### @aws-sdk/client-ses (email) — Legitimate Interest
...
#### resend (email) — Legitimate Interest
- [ ] Legitimate Interest Assessment (LIA) documented
- [ ] User objection mechanism provided
- [ ] Data minimization applied
- [ ] Processing documented in privacy policy
...
*This guide was auto-generated by Codepliant based on code analysis of @documenso/root. It provides implementation guidance only and does not constitute legal advice. Consult with a qualified privacy professional for your specific compliance requirements.*