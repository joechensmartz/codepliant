...
| next-auth | Authentication | email, name, profile picture, OAuth tokens, session data |
...
**Total services:** 13. Before integrating a new service, check with the compliance lead to ensure it is added to our sub-processor list and covered by a Data Processing Agreement.
