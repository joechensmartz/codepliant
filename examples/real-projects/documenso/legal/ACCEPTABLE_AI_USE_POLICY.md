...
|---------|----------|---------------|
| @ai-sdk/google-vertex | Vercel AI SDK (Google Vertex) | user prompts, conversation history, generated content |
