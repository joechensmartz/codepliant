...
- **@simplewebauthn/server**: Used for biometric authentication data, device attestation, credential IDs
- **next-auth**: Used for email, name, profile picture
- **passport-microsoft**: Used for email, name, Microsoft profile data
