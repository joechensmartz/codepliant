...
| Authentication system (@simplewebauthn/server, next-auth, passport-microsoft) | Auth Infrastructure | Critical |
...
- **Authentication & Authorization** — bypass, privilege escalation, session management flaws (@simplewebauthn/server, next-auth, passport-microsoft)
