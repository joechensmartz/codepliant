...
**Overall Maturity Score:** 2.9/5.0 — **Defined (Level 3)**
...
| GOV-04 | Is the scope of compliance obligations clearly defined? | [AUTO] 3 | [AUTO] 13 services detected — compliance scope is well-defined |
...
| # | Question | Score (1-5) | Justification |
|---|----------|------------|---------------|
| SEC-01 | Is authentication required for all system access, with MFA for privileged accounts? | [AUTO] 4 | [AUTO] Authentication service detected: @simplewebauthn/server, next-auth, passport-microsoft |
...
| # | Question | Score (1-5) | Justification |
|---|----------|------------|---------------|
| VEN-01 | Is there a complete inventory of all third-party services and sub-processors? | [AUTO] 3 | [AUTO] 13 third-party services detected and inventoried |
...
| # | Question | Score (1-5) | Justification |
|---|----------|------------|---------------|
| AI-01 | Is there an inventory of all AI/ML systems with risk classifications? | [AUTO] 3 | [AUTO] AI services detected: @ai-sdk/google-vertex, @vercel/ai |
...
*This compliance maturity assessment was generated by [Codepliant](https://github.com/joechensmartz/codepliant) based on an automated scan of the **@documenso/root** codebase. Auto-scored questions should be verified by your compliance team. This assessment does not constitute legal advice or formal certification.*
