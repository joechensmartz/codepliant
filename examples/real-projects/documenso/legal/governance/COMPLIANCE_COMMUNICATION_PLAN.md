...
Here is your monthly compliance update for @documenso/root:
...
Codepliant has detected a new third-party service in @documenso/root:
...
This is an update regarding AI services in @documenso/root:
...
Payment processing compliance update for @documenso/root:
...
*This Compliance Communication Plan was generated by [Codepliant](https://github.com/joechensmartz/codepliant) based on automated code analysis of 13 service(s). Adapt the templates and cadences to match your organisation's size, structure, and regulatory environment. Review this plan quarterly.*