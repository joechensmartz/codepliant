...
| PostgreSQL | Data storage and management | application data, user records |
...
| ws (WebSocket) | Third-party service integration | real-time user data, connection metadata, IP address, WebSocket messages |
