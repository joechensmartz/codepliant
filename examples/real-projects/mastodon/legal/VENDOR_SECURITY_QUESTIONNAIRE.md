...
| PCI DSS compliant? | [AUTO] No payment processing detected — N/A |
...
| Where is data stored? | [AUTO] Database services detected: ActiveRecord, ioredis, pg, PostgreSQL, PostgreSQL (env), rails-activerecord, redis, Redis — [MANUAL] specify hosting region |
| Do you use cloud storage? | [AUTO] Yes — Active Storage, ActiveStorage, aws-sdk-s3 detected |
...
| Question | Answer |
|----------|--------|
| How many third-party sub-processors do you use? | [AUTO] 22 sub-processor(s) detected |
...
## 10. Privacy & Data Subject Rights
...
*This vendor security questionnaire was generated by [Codepliant](https://github.com/joechensmartz/codepliant) based on an automated scan of the **@mastodon/mastodon** codebase. Answers marked [AUTO] are derived from code analysis and should be verified. Answers marked [MANUAL] require input from your security and compliance teams. This document is not a substitute for a formal security assessment.*
