...
|---|--------|----------|-----------|-------------------|
| 1 | ActionCable | Other | Low | Internal — classification depends on specific use case |
| 2 | ActionController::Cookies | Other | Low | Internal — classification depends on specific use case |
| 3 | ActionMailer | Email Service | Medium | Confidential — processes email addresses, message content |
| 4 | Active Storage | File Storage | High | Confidential — stores files that may contain any data category |
| 5 | ActiveRecord | Database | High | Confidential — stores application data, potentially all data categories |
| 6 | ActiveStorage | File Storage | High | Confidential — stores files that may contain any data category |
| 7 | aws-sdk-s3 | File Storage | High | Confidential — stores files that may contain any data category |
| 8 | devise | Authentication | High | Confidential — processes authentication credentials, identity data |
| 9 | ioredis | Database | High | Confidential — stores application data, potentially all data categories |
| 10 | omniauth | Authentication | High | Confidential — processes authentication credentials, identity data |
| 11 | pg | Database | High | Confidential — stores application data, potentially all data categories |
| 12 | PostgreSQL | Database | High | Confidential — stores application data, potentially all data categories |
| 13 | PostgreSQL (env) | Database | High | Confidential — stores application data, potentially all data categories |
| 14 | pundit | Authentication | High | Confidential — processes authentication credentials, identity data |
| 15 | rack-attack | Other | Low | Internal — classification depends on specific use case |
| 16 | rails-actionmailer | Email Service | Medium | Confidential — processes email addresses, message content |
| 17 | rails-activerecord | Database | High | Confidential — stores application data, potentially all data categories |
| 18 | rails-sessions | Authentication | High | Confidential — processes authentication credentials, identity data |
| 19 | redis | Database | High | Confidential — stores application data, potentially all data categories |
| 20 | Redis | Database | High | Confidential — stores application data, potentially all data categories |
| 21 | sidekiq | Other | Low | Internal — classification depends on specific use case |
| 22 | ws (WebSocket) | Other | Low | Internal — classification depends on specific use case |

> **Total vendors:** 22 | **Critical/High risk:** 15
