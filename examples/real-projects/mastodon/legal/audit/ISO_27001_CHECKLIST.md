...
*Data storage services detected: ActiveRecord, ioredis, pg, PostgreSQL, PostgreSQL (env), rails-activerecord, redis, Redis, Active Storage, ActiveStorage, aws-sdk-s3*
...
- [ ] Enable encryption at rest for: ActiveRecord, ioredis, pg, PostgreSQL, PostgreSQL (env), rails-activerecord, redis, Redis
