...
| --- | --- | --- | --- |
| DD-S-001 | **ActionCable** | Data fully removed after deletion request | Service-specific API query; expect no user data |
| DD-S-002 | **ActionController::Cookies** | Data fully removed after deletion request | Service-specific API query; expect no user data |
| DD-S-003 | **ActionMailer** | Data fully removed after deletion request | Search mailing lists by email; expect not found |
| DD-S-004 | **Active Storage** | Data fully removed after deletion request | List objects by user prefix; expect empty |
| DD-S-005 | **ActiveRecord** | Data fully removed after deletion request | Direct DB query by user ID; expect 0 rows |
| DD-S-006 | **ActiveStorage** | Data fully removed after deletion request | List objects by user prefix; expect empty |
| DD-S-007 | **aws-sdk-s3** | Data fully removed after deletion request | List objects by user prefix; expect empty |
| DD-S-008 | **devise** | Data fully removed after deletion request | Query user profile API; expect 404 |
| DD-S-009 | **ioredis** | Data fully removed after deletion request | Direct DB query by user ID; expect 0 rows |
| DD-S-010 | **omniauth** | Data fully removed after deletion request | Query user profile API; expect 404 |
| DD-S-011 | **pg** | Data fully removed after deletion request | Direct DB query by user ID; expect 0 rows |
| DD-S-012 | **PostgreSQL** | Data fully removed after deletion request | Direct DB query by user ID; expect 0 rows |
| DD-S-013 | **PostgreSQL (env)** | Data fully removed after deletion request | Direct DB query by user ID; expect 0 rows |
| DD-S-014 | **pundit** | Data fully removed after deletion request | Query user profile API; expect 404 |
| DD-S-015 | **rack-attack** | Data fully removed after deletion request | Service-specific API query; expect no user data |
| DD-S-016 | **rails-actionmailer** | Data fully removed after deletion request | Search mailing lists by email; expect not found |
| DD-S-017 | **rails-activerecord** | Data fully removed after deletion request | Direct DB query by user ID; expect 0 rows |
| DD-S-018 | **rails-sessions** | Data fully removed after deletion request | Query user profile API; expect 404 |
| DD-S-019 | **redis** | Data fully removed after deletion request | Direct DB query by user ID; expect 0 rows |
| DD-S-020 | **Redis** | Data fully removed after deletion request | Direct DB query by user ID; expect 0 rows |
| DD-S-021 | **sidekiq** | Data fully removed after deletion request | Service-specific API query; expect no user data |
| DD-S-022 | **ws (WebSocket)** | Data fully removed after deletion request | Service-specific API query; expect no user data |

### 3.3 Cascade Deletion

| ID | Test Case | Expected Result | Regulation |
| --- | --- | --- | --- |
| DD-C-001 | Delete user account | Data removed from all 22 detected services | GDPR Art. 17 |
...
| **ws (WebSocket)** | N/A | Required | Required | Recommended |
