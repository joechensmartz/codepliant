...
*Generated on 2026-03-16 | 22 services detected | 35 data categories*
...
| real-time user data, connection metadata, IP address | ws (WebSocket) | Per retention policy | View, Export, Delete |
...
```json
{
  ...
  "third_party_sharing": [
    ...
    { "processor": "ActionController::Cookies", "data_shared": ["session cookies","session data"], "purpose": "service_operation" },
    { "processor": "ActionMailer", "data_shared": ["email addresses","email content"], "purpose": "service_operation" }
  ]
}
```
...
│  └─ Data points: 1,247                                  │
│                                                         │
│  Third-Party Services (22 connected)       │
...
│  ├─ ActiveRecord: user data as defined in schema, timestamps
│  └─ ... and 17 more
│                                                         │
└─────────────────────────────────────────────────────────┘
```
...
- [ ] Add data aggregation from all 22 connected services
...
*This specification was auto-generated by Codepliant based on 22 detected services in your codebase. Implement this portal to give your users full control over their personal data.*
