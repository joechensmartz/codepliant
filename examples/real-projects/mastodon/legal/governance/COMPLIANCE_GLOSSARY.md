...
> This glossary defines compliance and data protection terms used throughout the compliance documentation generated for **@mastodon/mastodon**. Terms are sourced from GDPR, CCPA/CPRA, EU AI Act, SOC 2, ISO 27001, PCI DSS, HIPAA, and general data protection standards.

*48 terms defined based on 22 detected services.*
...
The following regulatory frameworks may apply to **@mastodon/mastodon** based on the detected services and data processing activities:
