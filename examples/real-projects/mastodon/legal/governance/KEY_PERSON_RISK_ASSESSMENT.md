...
| Metric | Value |
|--------|-------|
| Key Compliance Roles | **5** |
| Critical Roles | **3** |
| Unassigned / Needs Assignment | **4** |
| Single Points of Failure | **4** |

> **Action Required:** 4 role(s) need immediate assignment to avoid compliance gaps.
...
**Description:** Manages relationships with 22 detected third-party services. Owns DPA negotiations, vendor risk assessments, and sub-processor monitoring.
