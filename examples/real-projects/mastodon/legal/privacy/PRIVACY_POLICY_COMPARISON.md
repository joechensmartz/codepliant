...
**14 / 23 items covered (61%)**

############________ 61%

Moderate coverage. Several important sections are missing or incomplete.
...
| 9 | International Data Transfers | **No** | GDPR Art. 13(1)(f) | Stripe, Vercel, Linear |
| 10 | Cookie Policy / Tracking Technologies | **No** | ePrivacy Directive Art. 5(3) | Stripe, Vercel, Linear |
| 11 | AI / Automated Decision-Making Disclosure | **No** | GDPR Art. 22, EU AI Act | Notion, Linear, Vercel |
...
| 19 | Do Not Sell My Personal Information | **No** | CCPA Sec. 1798.120 | Stripe, Notion, GitHub |
...
- **Industry examples:** Stripe, Vercel, Linear
- **Recommendation:** Add this section to your privacy policy. This section is auto-generated when AI, analytics, or payment services are detected.
...
- **Recommendation:** Add this section to your privacy policy. This section is auto-generated when analytics or advertising services are detected.
...
- **Industry examples:** Notion, Linear, Vercel
- **Recommendation:** Add this section to your privacy policy. This section is auto-generated when AI services are detected.
...
- **Industry examples:** Stripe, Notion, GitHub
- **Recommendation:** Add this section to your privacy policy. Review industry examples above for guidance on implementing this section.
...
- [ ] Add **International Data Transfers** (GDPR Art. 13(1)(f))
- [ ] Add **Contact Information for Privacy Inquiries** (GDPR Art. 13(1)(a))
- [ ] Add **Do Not Sell My Personal Information** (CCPA Sec. 1798.120)

**Medium Priority (recommended):**

- [ ] Add **Cookie Policy / Tracking Technologies** (ePrivacy Directive Art. 5(3))
- [ ] Add **AI / Automated Decision-Making Disclosure** (GDPR Art. 22, EU AI Act)
...
*This privacy policy comparison was generated by [Codepliant](https://github.com/joechensmartz/codepliant) based on automated code analysis. This is an internal assessment tool and does not constitute legal advice. Consult with a qualified privacy attorney for compliance guidance.*