...
## Your scan detected 22 service(s)

**Services found:** ActionCable, ActionController::Cookies, ActionMailer, Active Storage, ActiveRecord, ActiveStorage, aws-sdk-s3, devise, ioredis, omniauth, pg, PostgreSQL, PostgreSQL (env), pundit, rack-attack, rails-actionmailer, rails-activerecord, rails-sessions, redis, Redis, sidekiq, ws (WebSocket)
...
No analytics or advertising cookies were detected in your project. If you add any in the future, re-run `npx codepliant go` and this section will update with specific instructions.
