...
### 2.5 Application Infrastructure
...
We are currently experiencing a significant service disruption affecting @mastodon/mastodon.
...
*This Disaster Recovery Plan was generated by [Codepliant](https://github.com/joechensmartz/codepliant) based on an automated scan of the **@mastodon/mastodon** codebase. Recovery procedures should be reviewed and customized by your engineering and operations teams based on actual infrastructure, RPO/RTO requirements, and business priorities.*