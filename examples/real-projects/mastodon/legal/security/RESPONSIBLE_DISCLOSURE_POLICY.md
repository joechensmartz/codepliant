...
| Data storage (Active Storage, ActiveRecord, ActiveStorage, aws-sdk-s3, ioredis, pg, PostgreSQL, PostgreSQL (env), rails-activerecord, redis, Redis) | Data Infrastructure | High |
...
- **Data Storage** — injection, unauthorized data access, data leakage (Active Storage, ActiveRecord, ActiveStorage, aws-sdk-s3, ioredis, pg, PostgreSQL, PostgreSQL (env), rails-activerecord, redis, Redis)
