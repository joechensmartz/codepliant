...
|-----------------|----------|---------------------------|
| @hubspot/api-client | Other | General |
| @sendgrid/mail | Email Service | Organizational Controls (A.5), Technological Controls (A.8) |
| @sentry/nextjs | Error Monitoring | Technological Controls (A.8), Organizational Controls (A.5) |
| @upstash/redis | Database | Technological Controls (A.8), Organizational Controls (A.5) |
| Google Analytics | Analytics | Organizational Controls (A.5), Technological Controls (A.8) |
| Google Tag Manager | Analytics | Organizational Controls (A.5), Technological Controls (A.8) |
| google-auth-library | Authentication | Organizational Controls (A.5), Technological Controls (A.8) |
| googleapis | Other | General |
| intercom | Other | General |
| ioredis | Database | Technological Controls (A.8), Organizational Controls (A.5) |
| next-auth | Authentication | Organizational Controls (A.5), Technological Controls (A.8) |
| nodemailer | Email Service | Organizational Controls (A.5), Technological Controls (A.8) |
| passport | Authentication | Organizational Controls (A.5), Technological Controls (A.8) |
| Plausible Analytics | Analytics | Organizational Controls (A.5), Technological Controls (A.8) |
| PostgreSQL | Database | Technological Controls (A.8), Organizational Controls (A.5) |
...
| prisma | Database | Technological Controls (A.8), Organizational Controls (A.5) |
...
| twilio | Other | General |
| web-push | Other | General |
...
*Data-collecting services detected: Google Analytics, Google Tag Manager, Plausible Analytics, posthog*
...
*Authentication services detected: google-auth-library, next-auth, passport*
...
*Data storage services detected: @upstash/redis, ioredis, PostgreSQL, PostgreSQL (env), prisma, Redis, Redis (env)*
...
- [ ] Configure alerting in: @sentry/nextjs
...
- [ ] Enable encryption at rest for: @upstash/redis, ioredis, PostgreSQL, PostgreSQL (env), prisma, Redis, Redis (env)
