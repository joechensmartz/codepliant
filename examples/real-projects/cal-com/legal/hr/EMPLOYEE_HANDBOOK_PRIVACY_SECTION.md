...
|------|------|-----------------|
| Sentry | Error/Performance Monitoring | Application error tracking — captures stack traces, request metadata, and device information when errors occur. |
...
[Your Company Name] uses 23 third-party services that may process employee data in the course of business operations. Employees should:
...
| Service | Purpose |
|---------|---------|
| SendGrid (transactional email — may log email metadata and delivery status) |
...
## 5. Employee Data Privacy Rights

### 5.1 What Data We Collect About Employees
