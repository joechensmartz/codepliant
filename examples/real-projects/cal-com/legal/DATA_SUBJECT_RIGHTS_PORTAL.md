...
*Generated on 2026-03-16 | 23 services detected | 48 data categories*
...
|---------------|--------|-----------|---------|
| contact information, email addresses, names | @hubspot/api-client | Per retention policy | View, Export, Delete |
| email addresses, email content | @sendgrid/mail | Per retention policy | View, Export, Delete |
| error data, stack traces, user context | @sentry/nextjs | Per retention policy | View, Export, Delete |
| cached data, session data | @upstash/redis | Per retention policy | View, Export, Delete |
| page views, user behavior, device information | Google Analytics | Per retention policy | View, Export, Delete |
| page views, user behavior, custom events | Google Tag Manager | Per retention policy | View, Export, Delete |
| OAuth tokens, Google profile data, email | google-auth-library | Per retention policy | View, Export, Delete |
| user data via Google APIs, calendar data, email data | googleapis | Per retention policy | View, Export, Delete |
| user profiles, email, name | intercom | Per retention policy | View, Export, Delete |
| cached data, session data | ioredis | Per retention policy | View, Export, Delete |
| email, name, profile picture | next-auth | Per retention policy | View, Export, Delete |
| email addresses, email content | nodemailer | Per retention policy | View, Export, Delete |
| email, name, OAuth tokens | passport | Per retention policy | View, Export, Delete |
| page views, referrer data, device information | Plausible Analytics | Per retention policy | View, Export, Delete |
| application data, user records | PostgreSQL | Per retention policy | View, Export, Delete |
...
| user data as defined in schema | prisma | Per retention policy | View, Export, Delete |
...
| phone numbers, SMS message content, voice call metadata | twilio | Per retention policy | View, Export, Delete |
| push subscription endpoints, device tokens, notification content | web-push | Per retention policy | View, Export, Delete |
...
```json
{
  ...
  "third_party_sharing": [
    { "processor": "@hubspot/api-client", "data_shared": ["contact information","email addresses"], "purpose": "service_operation" },
    { "processor": "@sendgrid/mail", "data_shared": ["email addresses","email content"], "purpose": "service_operation" },
    { "processor": "@sentry/nextjs", "data_shared": ["error data","stack traces"], "purpose": "service_operation" }
  ]
}
```
...
│  └─ Data points: 1,247                                  │
│                                                         │
│  Third-Party Services (23 connected)       │
│  ├─ @hubspot/api-client: contact information, email addresses
│  ├─ @sendgrid/mail: email addresses, email content
│  ├─ @sentry/nextjs: error data, stack traces
│  ├─ @upstash/redis: cached data, session data
...
- [ ] Add data aggregation from all 23 connected services
...
*This specification was auto-generated by Codepliant based on 23 detected services in your codebase. Implement this portal to give your users full control over their personal data.*
