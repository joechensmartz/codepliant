...
| 7 | Cookie Policy | `COOKIE_POLICY.md` | Annual + on analytics changes | - [ ] Reviewed |
...
|---------|----------|-------------|---------------|---------------|
| @hubspot/api-client | other | - [ ] Yes | [Date] | [None / Update DPA / Replace / Remove] |
| @sendgrid/mail | email | - [ ] Yes | [Date] | [None / Update DPA / Replace / Remove] |
| @sentry/nextjs | monitoring | - [ ] Yes | [Date] | [None / Update DPA / Replace / Remove] |
| @upstash/redis | database | - [ ] Yes | [Date] | [None / Update DPA / Replace / Remove] |
| Google Analytics | analytics | - [ ] Yes | [Date] | [None / Update DPA / Replace / Remove] |
| Google Tag Manager | analytics | - [ ] Yes | [Date] | [None / Update DPA / Replace / Remove] |
| google-auth-library | auth | - [ ] Yes | [Date] | [None / Update DPA / Replace / Remove] |
| googleapis | other | - [ ] Yes | [Date] | [None / Update DPA / Replace / Remove] |
| intercom | other | - [ ] Yes | [Date] | [None / Update DPA / Replace / Remove] |
| ioredis | database | - [ ] Yes | [Date] | [None / Update DPA / Replace / Remove] |
| next-auth | auth | - [ ] Yes | [Date] | [None / Update DPA / Replace / Remove] |
| nodemailer | email | - [ ] Yes | [Date] | [None / Update DPA / Replace / Remove] |
| passport | auth | - [ ] Yes | [Date] | [None / Update DPA / Replace / Remove] |
| Plausible Analytics | analytics | - [ ] Yes | [Date] | [None / Update DPA / Replace / Remove] |
| PostgreSQL | database | - [ ] Yes | [Date] | [None / Update DPA / Replace / Remove] |
| PostgreSQL (env) | database | - [ ] Yes | [Date] | [None / Update DPA / Replace / Remove] |
| posthog | analytics | - [ ] Yes | [Date] | [None / Update DPA / Replace / Remove] |
| prisma | database | - [ ] Yes | [Date] | [None / Update DPA / Replace / Remove] |
...
| twilio | other | - [ ] Yes | [Date] | [None / Update DPA / Replace / Remove] |
| web-push | other | - [ ] Yes | [Date] | [None / Update DPA / Replace / Remove] |
