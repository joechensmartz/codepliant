...
|---|---------------------|---------|-----------------------------|-----------------------------|------------|-------------|-----------------|
| 1 | User Authentication | Account creation, login, and session management | Registered Users | Email, name, profile data, session tokens, OAuth tokens | google-auth-library, next-auth, passport | Contract performance (Art. 6(1)(b)) | [Define retention period] |
| 2 | Usage Analytics | Product improvement, user behavior analysis, performance monitoring | Website Visitors, Registered Users | Page views, click events, device info, IP address, session data | Google Analytics, Google Tag Manager, Plausible Analytics, posthog | Legitimate interest (Art. 6(1)(f)) or Consent (Art. 6(1)(a)) | [Define retention period] |
...
| 4 | Email Communications | Transactional emails, notifications, and marketing communications | Registered Users, Customers | Email addresses, email content, delivery status | @sendgrid/mail, nodemailer | Contract performance (Art. 6(1)(b)) / Consent for marketing (Art. 6(1)(a)) | [Define retention period] |
| 5 | Error Monitoring | Application error tracking, performance monitoring, debugging | Registered Users, Website Visitors | Error data, stack traces, user context, device information, IP address | @sentry/nextjs | Legitimate interest (Art. 6(1)(f)) | [Define retention period] |
| 6 | Data Storage | Persistent storage of user data as defined by application schema | Registered Users, Customers | User data as defined in database schema | @upstash/redis, ioredis, PostgreSQL, PostgreSQL (env), prisma, Redis, Redis (env) (self-hosted or managed) | Contract performance (Art. 6(1)(b)) | [Define retention period] |
...
|---------|----------|-------------------|------------|
| @hubspot/api-client | other | Standard Contractual Clauses (SCCs) | [Verify with provider] |
| @sendgrid/mail | email | Standard Contractual Clauses (SCCs) | [Verify with provider] |
| @sentry/nextjs | monitoring | Standard Contractual Clauses (SCCs) | [Verify with provider] |
| @upstash/redis | database | Standard Contractual Clauses (SCCs) | [Verify with provider] |
| Google Analytics | analytics | Standard Contractual Clauses (SCCs) | [Verify with provider] |
| Google Tag Manager | analytics | Standard Contractual Clauses (SCCs) | [Verify with provider] |
| google-auth-library | auth | Standard Contractual Clauses (SCCs) | [Verify with provider] |
| googleapis | other | Standard Contractual Clauses (SCCs) | [Verify with provider] |
| intercom | other | Standard Contractual Clauses (SCCs) | [Verify with provider] |
| ioredis | database | Standard Contractual Clauses (SCCs) | [Verify with provider] |
| next-auth | auth | Standard Contractual Clauses (SCCs) | [Verify with provider] |
| nodemailer | email | Standard Contractual Clauses (SCCs) | [Verify with provider] |
| passport | auth | Standard Contractual Clauses (SCCs) | [Verify with provider] |
| Plausible Analytics | analytics | Standard Contractual Clauses (SCCs) | [Verify with provider] |
...
| twilio | other | Standard Contractual Clauses (SCCs) | [Verify with provider] |
| web-push | other | Standard Contractual Clauses (SCCs) | [Verify with provider] |
