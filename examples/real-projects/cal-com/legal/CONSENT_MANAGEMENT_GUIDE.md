...
|---------|----------|----------------|-----------------|
| Google Analytics | analytics | page views, user behavior, device information | Must not load until user consents |
| Google Tag Manager | analytics | page views, user behavior, custom events | Must not load until user consents |
| Plausible Analytics | analytics | page views, referrer data, device information | Must not load until user consents |
...
|---------|----------|----------------|-------|
| @sendgrid/mail | email | email addresses, email content | Document in LIA; provide opt-out |
| @sentry/nextjs | monitoring | error data, stack traces, user context | Document in LIA; provide opt-out |
...
| Service | Category | Data Collected | Notes |
|---------|----------|----------------|-------|
| @upstash/redis | database | cached data, session data | Essential for service delivery |
| google-auth-library | auth | OAuth tokens, Google profile data, email | Essential for service delivery |
| ioredis | database | cached data, session data | Essential for service delivery |
| next-auth | auth | email, name, profile picture | Essential for service delivery |
| passport | auth | email, name, OAuth tokens | Essential for service delivery |
| PostgreSQL | database | application data, user records | Essential for service delivery |
| PostgreSQL (env) | database | application data, user records | Essential for service delivery |
| prisma | database | user data as defined in schema | Essential for service delivery |
...
|----------|----------|---------------|
| Strictly Necessary | @upstash/redis, google-auth-library, ioredis, next-auth, passport, PostgreSQL, PostgreSQL (env), prisma, Redis, Redis (env), stripe | Always active (no toggle) |
| Analytics | Google Analytics, Google Tag Manager, Plausible Analytics, posthog | Off until consented |
...
### Other Analytics Services (Google Analytics, Google Tag Manager, Plausible Analytics)
...
#### @sendgrid/mail (email) — Legitimate Interest
...
#### @sentry/nextjs (monitoring) — Legitimate Interest
- [ ] Legitimate Interest Assessment (LIA) documented
- [ ] User objection mechanism provided
- [ ] Data minimization applied
- [ ] Processing documented in privacy policy
...
*This guide was auto-generated by Codepliant based on code analysis of calcom-monorepo. It provides implementation guidance only and does not constitute legal advice. Consult with a qualified privacy professional for your specific compliance requirements.*