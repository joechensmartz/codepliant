...
| Question | Answer |
|----------|--------|
| Do you require authentication for access? | [AUTO] Yes — authentication implemented via google-auth-library, next-auth, passport |
...
| Where is data stored? | [AUTO] Database services detected: @upstash/redis, ioredis, PostgreSQL, PostgreSQL (env), prisma, Redis, Redis (env) — [MANUAL] specify hosting region |
...
| Do you use error monitoring / observability? | [AUTO] Yes — @sentry/nextjs |
...
| Question | Answer |
|----------|--------|
| How many third-party sub-processors do you use? | [AUTO] 23 sub-processor(s) detected |
...
*This vendor security questionnaire was generated by [Codepliant](https://github.com/joechensmartz/codepliant) based on an automated scan of the **calcom-monorepo** codebase. Answers marked [AUTO] are derived from code analysis and should be verified. Answers marked [MANUAL] require input from your security and compliance teams. This document is not a substitute for a formal security assessment.*
