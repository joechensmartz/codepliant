...
|--------------|---------|---------------|
| HubSpot | Third-party service integration | contact information, email addresses, names, phone numbers, company data, deal information, engagement history |
| SendGrid (Twilio) | Transactional and marketing email delivery | email addresses, email content |
| Sentry | Error tracking and performance monitoring | error data, stack traces, user context, device information, IP address, performance profiles |
| Upstash Redis | Data storage and management | cached data, session data |
| Google Analytics | Product analytics and usage tracking | page views, user behavior, device information, IP address, location data |
| Google Tag Manager | Product analytics and usage tracking | page views, user behavior, custom events, device information, third-party tag data |
| Google Auth | User authentication and identity management | OAuth tokens, Google profile data, email |
| Google APIs | Third-party service integration | user data via Google APIs, calendar data, email data, profile information |
| Intercom | Third-party service integration | user profiles, email, name, conversations, user behavior, company data |
| Plausible Analytics | Product analytics and usage tracking | page views, referrer data, device information |
...
| Twilio | Third-party service integration | phone numbers, SMS message content, voice call metadata, call recordings |
