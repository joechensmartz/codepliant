...
## Your scan detected 23 service(s)

**Services found:** @hubspot/api-client, @sendgrid/mail, @sentry/nextjs, @upstash/redis, Google Analytics, Google Tag Manager, google-auth-library, googleapis, intercom, ioredis, next-auth, nodemailer, passport, Plausible Analytics, PostgreSQL, PostgreSQL (env), posthog, prisma, Redis, Redis (env), stripe, twilio, web-push
