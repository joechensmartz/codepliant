...
[Your Company Name] currently operates **23 third-party service(s)** that process user data. A total of **76 compliance document(s)** have been generated covering all applicable regulatory requirements.
...
|----------|-------|----------|
| Analytics | 4 | Google Analytics, Google Tag Manager, Plausible Analytics, posthog |
| Auth | 3 | google-auth-library, next-auth, passport |
| Database | 7 | @upstash/redis, ioredis, PostgreSQL, PostgreSQL (env), prisma, Redis, Redis (env) |
| Email | 2 | @sendgrid/mail, nodemailer |
| Monitoring | 1 | @sentry/nextjs |
| Other | 5 | @hubspot/api-client, googleapis, intercom, twilio, web-push |
| Payment | 1 | stripe |
...
1. **Payment Processing** (stripe): PCI DSS compliance required. Data Processing Agreement must list payment sub-processors.
2. **High Service Count** (23 services): Large attack surface increases data breach risk. Sub-processor management is critical.
3. **Analytics/Monitoring** (@sentry/nextjs, Google Analytics, Google Tag Manager, Plausible Analytics, posthog): Cookie consent and tracking disclosure required under GDPR/ePrivacy.
...
*Report generated from analysis of 23 service(s) across 7 categories.*