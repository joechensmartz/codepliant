...
- **google-auth-library** — integrated authentication provider
- **next-auth** — integrated authentication provider
...
API health and performance are monitored via @sentry/nextjs. Status updates are provided at our status page during incidents.
