...
| Activities with international transfers | 5 |
| Activities with automated decision-making | 0 |

> **DPIA Required:** 1 high-risk processing activity has been identified. Under GDPR Article 35, a Data Protection Impact Assessment is likely required for these activities.
...
| **Recipients / Processors** | google-auth-library, next-auth, passport |
...
| **Recipients / Processors** | Google Analytics, Google Tag Manager, Plausible Analytics, posthog |
...
| **Recipients / Processors** | @sendgrid/mail, nodemailer |
...
| **Recipients / Processors** | @sentry/nextjs |
...
| **Recipients / Processors** | @upstash/redis (managed/self-hosted), ioredis (managed/self-hosted), PostgreSQL (managed/self-hosted), PostgreSQL (env) (managed/self-hosted), prisma (managed/self-hosted), Redis (managed/self-hosted), Redis (env) (managed/self-hosted) |
...
| PA-006 | Primary Data Storage | Contract performance | All user-submitted data as defined by database schema, Timestamps, Relational references | Medium |

## 5. Legal Basis Summary

| Legal Basis | Activities Using It |
|-------------|-------------------|
| Contract performance (Art. 6(1)(b)) | PA-001, PA-003, PA-004, PA-006 |
...
|----------|-----------|-----------|
| PA-001: User Authentication & Account Management | google-auth-library, next-auth, passport | Standard Contractual Clauses (SCCs) |
| PA-002: Website & Product Analytics | Google Analytics, Google Tag Manager, Plausible Analytics, posthog | Standard Contractual Clauses (SCCs) |
| PA-003: Payment Processing & Billing | stripe | PCI DSS compliance, Standard Contractual Clauses |
| PA-004: Email Communications | @sendgrid/mail, nodemailer | Standard Contractual Clauses (SCCs) |
| PA-005: Error Monitoring & Application Performance | @sentry/nextjs | Standard Contractual Clauses (SCCs) |
