...
|---------|----------|----------------|-----------------|
| @hubspot/api-client | other | contact information, email addresses, names, phone numbers, company data, deal information, engagement history | Export / Delete / Rectify |
| @sendgrid/mail | email | email addresses, email content | Export / Delete / Rectify |
| @sentry/nextjs | monitoring | error data, stack traces, user context, device information, IP address, performance profiles | Export / Delete / Rectify |
| @upstash/redis | database | cached data, session data | Export / Delete / Rectify |
| Google Analytics | analytics | page views, user behavior, device information, IP address, location data | Export / Delete / Rectify |
| Google Tag Manager | analytics | page views, user behavior, custom events, device information, third-party tag data | Export / Delete / Rectify |
| google-auth-library | auth | OAuth tokens, Google profile data, email | Export / Delete / Rectify |
| googleapis | other | user data via Google APIs, calendar data, email data, profile information | Export / Delete / Rectify |
| intercom | other | user profiles, email, name, conversations, user behavior, company data | Export / Delete / Rectify |
| ioredis | database | cached data, session data | Export / Delete / Rectify |
| next-auth | auth | email, name, profile picture, OAuth tokens, session data | Export / Delete / Rectify |
| nodemailer | email | email addresses, email content | Export / Delete / Rectify |
| passport | auth | email, name, OAuth tokens, session data | Export / Delete / Rectify |
| Plausible Analytics | analytics | page views, referrer data, device information | Export / Delete / Rectify |
| PostgreSQL | database | application data, user records | Export / Delete / Rectify |
...
| twilio | other | phone numbers, SMS message content, voice call metadata, call recordings | Export / Delete / Rectify |
| web-push | other | push subscription endpoints, device tokens, notification content | Export / Delete / Rectify |
