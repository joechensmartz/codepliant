...
|---|-----------------|------|----------------|--------|------------|----------|-------------|
| 1 | Payment Data Processing Assessment | DPIA | 2026-03-16 | Pending Review | High | [Data Protection Officer Name] | 2027-03-16 |
| 2 | Analytics & Tracking Assessment | DPIA | 2026-03-16 | Pending Review | Medium | [Data Protection Officer Name] | 2027-03-16 |
| 3 | User Authentication & Identity Assessment | PIA | 2026-03-16 | Pending Review | Medium | [Data Protection Officer Name] | 2027-03-16 |
| 4 | Application Monitoring Assessment | PIA | 2026-03-16 | Pending Review | Low | [Data Protection Officer Name] | 2027-03-16 |
| 5 | General Personal Data Processing Assessment | PIA | 2026-03-16 | Pending Review | Medium | [Data Protection Officer Name] | 2027-03-16 |
| 6 | Cross-Border Data Transfer Assessment | DPIA | 2026-03-16 | Pending Review | High | [Data Protection Officer Name] | 2027-03-16 |

### 3.2 Detailed Assessment Records

#### Assessment 1: Payment Data Processing
...
#### Assessment 2: Analytics & Tracking
...
| **Scope** | Analytics services: Google Analytics, Google Tag Manager, Plausible Analytics, posthog |
...
| **Data Categories** | page views, user behavior, device information, IP address, location data, custom events, third-party tag data, referrer data, session recordings, feature flag usage |
...
#### Assessment 3: General Personal Data Processing
...
| **Scope** | All 23 detected services and general data processing |
...
| **Data Categories** | Personal Identity Data, Financial Data, Usage & Behavioral Data, Communication Data, Technical & Diagnostic Data, Stored User Data, API Data Collection |
...
|---------|----------|---------------|---------------|-------------------|
| @hubspot/api-client | other | contact information, email addresses, names | Review needed | Pending |
| @sendgrid/mail | email | email addresses, email content | Review needed | Pending |
| @sentry/nextjs | monitoring | error data, stack traces, user context | Review needed | Pending |
| @upstash/redis | database | cached data, session data | Review needed | Pending |
| Google Analytics | analytics | page views, user behavior, device information | Review needed | Pending |
| Google Tag Manager | analytics | page views, user behavior, custom events | Review needed | Pending |
| google-auth-library | auth | OAuth tokens, Google profile data, email | Review needed | Pending |
| googleapis | other | user data via Google APIs, calendar data, email data | Review needed | Pending |
| intercom | other | user profiles, email, name | Review needed | Pending |
| ioredis | database | cached data, session data | Review needed | Pending |
| next-auth | auth | email, name, profile picture | Review needed | Pending |
| nodemailer | email | email addresses, email content | Review needed | Pending |
| passport | auth | email, name, OAuth tokens | Review needed | Pending |
| Plausible Analytics | analytics | page views, referrer data, device information | Review needed | Pending |
...
| twilio | other | phone numbers, SMS message content, voice call metadata | Review needed | Pending |
| web-push | other | push subscription endpoints, device tokens, notification content | Review needed | Pending |
