...
**Services:** @hubspot/api-client, googleapis, intercom, twilio, web-push

**Data processed:** contact information, email addresses, names, phone numbers, company data, deal information, engagement history, user data via Google APIs, calendar data, email data, profile information, user profiles, email, name, conversations, user behavior, SMS message content, voice call metadata, call recordings, push subscription endpoints, device tokens, notification content
...
**Services:** @sendgrid/mail, nodemailer
...
**Services:** @upstash/redis, ioredis, PostgreSQL, PostgreSQL (env), prisma, Redis, Redis (env)

**Data processed:** cached data, session data, application data, user records, user data as defined in schema, cache data
...
**Services:** Google Analytics, Google Tag Manager, Plausible Analytics, posthog

**Data processed:** page views, user behavior, device information, IP address, location data, custom events, third-party tag data, referrer data, session recordings, feature flag usage
...
**Services:** google-auth-library, next-auth, passport

**Data processed:** OAuth tokens, Google profile data, email, name, profile picture, session data
