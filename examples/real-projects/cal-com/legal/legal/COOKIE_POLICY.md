...
|---------|---------|---------|----------|
| Google Analytics | Various | Service functionality | Varies |
| Google Tag Manager | Various | Service functionality | Varies |
| Plausible Analytics | Various | Service functionality | Varies |
...
- **Google Analytics**: Used for page views, user behavior, device information
- **Google Tag Manager**: Used for page views, user behavior, custom events
- **Plausible Analytics**: Used for page views, referrer data, device information
- **posthog**: Used for user behavior, session recordings, feature flag usage
- **google-auth-library**: Used for OAuth tokens, Google profile data, email
- **next-auth**: Used for email, name, profile picture
- **passport**: Used for email, name, OAuth tokens
