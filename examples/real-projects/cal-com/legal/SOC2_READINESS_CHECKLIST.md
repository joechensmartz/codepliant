...
**Relevant SOC 2 sections:** Confidentiality (C1), Privacy (P1-P8), Availability (A1), Security (CC6), Processing Integrity (PI1)
...
| @sendgrid/mail | Email Service | Confidentiality (C1), Privacy (P1-P8) |
| @sentry/nextjs | Error Monitoring | Availability (A1), Security (CC6) |
| @upstash/redis | Database | Confidentiality (C1), Security (CC6) |
| Google Analytics | Analytics | Processing Integrity (PI1), Privacy (P1-P8) |
| Google Tag Manager | Analytics | Processing Integrity (PI1), Privacy (P1-P8) |
| google-auth-library | Authentication | Security (CC6) |
| googleapis | Other | General |
| intercom | Other | General |
| ioredis | Database | Confidentiality (C1), Security (CC6) |
| next-auth | Authentication | Security (CC6) |
| nodemailer | Email Service | Confidentiality (C1), Privacy (P1-P8) |
| passport | Authentication | Security (CC6) |
| Plausible Analytics | Analytics | Processing Integrity (PI1), Privacy (P1-P8) |
| PostgreSQL | Database | Confidentiality (C1), Security (CC6) |
| PostgreSQL (env) | Database | Confidentiality (C1), Security (CC6) |
| posthog | Analytics | Processing Integrity (PI1), Privacy (P1-P8) |
| prisma | Database | Confidentiality (C1), Security (CC6) |
...
- [ ] Review access control configuration for: google-auth-library, next-auth, passport
...
- [ ] Enable transparent data encryption (TDE) or equivalent for: @upstash/redis, ioredis, PostgreSQL, PostgreSQL (env), prisma, Redis, Redis (env)
...
- [ ] Disclose third-party data sharing for: Google Analytics, Google Tag Manager, Plausible Analytics, posthog
