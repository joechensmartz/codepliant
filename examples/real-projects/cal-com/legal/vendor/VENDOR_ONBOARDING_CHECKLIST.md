...
|---|--------|----------|-----------|-------------------|
| 1 | @hubspot/api-client | Other | Low | Internal — classification depends on specific use case |
| 2 | @sendgrid/mail | Email Service | Medium | Confidential — processes email addresses, message content |
| 3 | @sentry/nextjs | Error Monitoring | Medium | Internal — collects error logs, stack traces, device metadata |
| 4 | @upstash/redis | Database | High | Confidential — stores application data, potentially all data categories |
| 5 | Google Analytics | Analytics | Medium | Internal — collects behavioral data, device info, IP addresses |
| 6 | Google Tag Manager | Analytics | Medium | Internal — collects behavioral data, device info, IP addresses |
| 7 | google-auth-library | Authentication | High | Confidential — processes authentication credentials, identity data |
| 8 | googleapis | Other | Low | Internal — classification depends on specific use case |
| 9 | intercom | Other | Low | Internal — classification depends on specific use case |
| 10 | ioredis | Database | High | Confidential — stores application data, potentially all data categories |
| 11 | next-auth | Authentication | High | Confidential — processes authentication credentials, identity data |
| 12 | nodemailer | Email Service | Medium | Confidential — processes email addresses, message content |
| 13 | passport | Authentication | High | Confidential — processes authentication credentials, identity data |
| 14 | Plausible Analytics | Analytics | Medium | Internal — collects behavioral data, device info, IP addresses |
| 15 | PostgreSQL | Database | High | Confidential — stores application data, potentially all data categories |
| 16 | PostgreSQL (env) | Database | High | Confidential — stores application data, potentially all data categories |
| 17 | posthog | Analytics | Medium | Internal — collects behavioral data, device info, IP addresses |
| 18 | prisma | Database | High | Confidential — stores application data, potentially all data categories |
| 19 | Redis | Database | High | Confidential — stores application data, potentially all data categories |
| 20 | Redis (env) | Database | High | Confidential — stores application data, potentially all data categories |
| 21 | stripe | Payment Processing | Critical | Restricted — processes payment card data, financial PII |
| 22 | twilio | Other | Low | Internal — classification depends on specific use case |
| 23 | web-push | Other | Low | Internal — classification depends on specific use case |

> **Total vendors:** 23 | **Critical/High risk:** 11
