...
This assessment classifies **17 third-party vendors** detected in the **calcom-monorepo** codebase into risk tiers based on three factors:
...
| **Google Auth** | auth | Medium ! | 4/5 | Medium | Moderate | Annually (every 12 months) |
| **PostHog** | analytics | Medium ! | 2/5 | High | Easy | Annually (every 12 months) |
| **HubSpot** | other | Low - | 1/5 | Low | Easy | Biannually (every 24 months) |
...
| **Upstash Redis** | database | Low - | 3/5 | Medium | Easy | Biannually (every 24 months) |
| **Google Analytics** | analytics | Low - | 2/5 | Low | Easy | Biannually (every 24 months) |
| **Google Tag Manager** | analytics | Low - | 2/5 | Low | Easy | Biannually (every 24 months) |
| **Google APIs** | other | Low - | 1/5 | Low | Easy | Biannually (every 24 months) |
| **Intercom** | other | Low - | 1/5 | Low | Easy | Biannually (every 24 months) |
| **Plausible Analytics** | analytics | Low - | 2/5 | Low | Easy | Biannually (every 24 months) |
...
| Annual Review | 2027-03-16 | Google Auth, PostHog |
| Biannual Review | 2028-03-15 | HubSpot, SendGrid, Sentry, Upstash Redis, Google Analytics, Google Tag Manager, Google APIs, Intercom, Plausible Analytics, PostgreSQL, PostgreSQL (env), Redis, Redis (env), Twilio |
