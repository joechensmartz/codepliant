...
| **Scope** | AI/ML services: @ai-sdk/anthropic, @ai-sdk/google, @ai-sdk/openai, @vercel/ai, openai |
...
| **Scope** | All 16 detected services and general data processing |
...
| **Data Categories** | Personal Identity Data, Financial Data, AI Interaction Data, Communication Data, Technical & Diagnostic Data, User-Uploaded Content, Stored User Data, Contact Information, Authentication Data, Location Data |
...
|---------|----------|---------------|---------------|-------------------|
| @ai-sdk/anthropic | ai | user prompts, conversation history, generated content | Yes | Pending |
| @ai-sdk/google | ai | user prompts, conversation history, generated content | Yes | Pending |
| @ai-sdk/openai | ai | user prompts, conversation history, generated content | Yes | Pending |
...
| @vercel/ai | ai | user prompts, conversation history, generated content | Yes | Pending |
| drizzle | database | user data as defined in schema | Review needed | Pending |
...
| passport-google-oauth20 | auth | email, name, Google profile data | Review needed | Pending |
| passport-microsoft | auth | email, name, Microsoft profile data | Review needed | Pending |
