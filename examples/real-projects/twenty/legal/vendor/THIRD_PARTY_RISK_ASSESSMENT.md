...
This document provides a risk assessment of all third-party services integrated into the **twenty** application. Each vendor has been evaluated for data sensitivity, geographic risk, compliance certifications, data processing scope, and risk mitigation measures.

Total third-party vendors assessed: **9**
...
|--------|----------|-----------------|----------------|---------------|-------------|
| Vercel AI SDK (Anthropic) | ai | high | US | SOC 2 Type II, GDPR | Critical |
| Vercel AI SDK (Google) | ai | high | US | SOC 2 Type II, GDPR | Critical |
| Vercel AI SDK (OpenAI) | ai | high | US | SOC 2 Type II, GDPR | Critical |
