...
This assessment classifies **9 third-party vendors** detected in the **twenty** codebase into risk tiers based on three factors:
...
| Medium | 5 | Annually (every 12 months) |
...
| **Vercel AI SDK (Anthropic)** | ai | Medium ! | 4/5 | Medium | Moderate | Annually (every 12 months) |
| **Vercel AI SDK (Google)** | ai | Medium ! | 4/5 | Medium | Moderate | Annually (every 12 months) |
| **Vercel AI SDK (OpenAI)** | ai | Medium ! | 4/5 | Medium | Moderate | Annually (every 12 months) |
...
| Annual Review | 2027-03-16 | Vercel AI SDK (Anthropic), Vercel AI SDK (Google), Vercel AI SDK (OpenAI), Vercel AI SDK, OpenAI |
