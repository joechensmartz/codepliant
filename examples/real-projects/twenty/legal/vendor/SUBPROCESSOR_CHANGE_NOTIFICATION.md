...
|--------------|---------|---------------|
| Vercel AI SDK (Anthropic) | AI processing and content generation | user prompts, conversation history, generated content |
| Vercel AI SDK (Google) | AI processing and content generation | user prompts, conversation history, generated content |
| Vercel AI SDK (OpenAI) | AI processing and content generation | user prompts, conversation history, generated content |
...
| Vercel AI SDK | AI processing and content generation | user prompts, conversation history, generated content |
