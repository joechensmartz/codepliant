...
|---|--------|----------|-----------|-------------------|
| 1 | @ai-sdk/anthropic | AI Service | Critical | Confidential — may process user content, prompts, PII |
| 2 | @ai-sdk/google | AI Service | Critical | Confidential — may process user content, prompts, PII |
| 3 | @ai-sdk/openai | AI Service | Critical | Confidential — may process user content, prompts, PII |
| 4 | @aws-sdk/client-s3 | File Storage | High | Confidential — stores files that may contain any data category |
| 5 | @sentry/node | Error Monitoring | Medium | Internal — collects error logs, stack traces, device metadata |
| 6 | @vercel/ai | AI Service | Critical | Confidential — may process user content, prompts, PII |
| 7 | drizzle | Database | High | Confidential — stores application data, potentially all data categories |
...
| 10 | nodemailer | Email Service | Medium | Confidential — processes email addresses, message content |
| 11 | openai | AI Service | Critical | Confidential — may process user content, prompts, PII |
| 12 | passport | Authentication | High | Confidential — processes authentication credentials, identity data |
| 13 | passport-google-oauth20 | Authentication | High | Confidential — processes authentication credentials, identity data |
| 14 | passport-microsoft | Authentication | High | Confidential — processes authentication credentials, identity data |
| 15 | redis | Database | High | Confidential — stores application data, potentially all data categories |
| 16 | stripe | Payment Processing | Critical | Restricted — processes payment card data, financial PII |

> **Total vendors:** 16 | **Critical/High risk:** 13
