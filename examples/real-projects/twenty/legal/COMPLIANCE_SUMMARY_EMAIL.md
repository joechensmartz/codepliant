...
[Your Company Name] currently operates **16 third-party service(s)** that process user data. A total of **84 compliance document(s)** have been generated covering all applicable regulatory requirements.
...
|----------|-------|----------|
| Ai | 5 | @ai-sdk/anthropic, @ai-sdk/google, @ai-sdk/openai, @vercel/ai, openai |
| Auth | 3 | passport, passport-google-oauth20, passport-microsoft |
| Database | 3 | drizzle, ioredis, redis |
| Email | 1 | nodemailer |
| Monitoring | 1 | @sentry/node |
| Other | 1 | googleapis |
| Payment | 1 | stripe |
| Storage | 1 | @aws-sdk/client-s3 |

---

## Key Risks

1. **AI/ML Services Detected** (@ai-sdk/anthropic, @ai-sdk/google, @ai-sdk/openai, @vercel/ai, openai): EU AI Act Art. 50 transparency obligations apply. AI Disclosure document required.
2. **Payment Processing** (stripe): PCI DSS compliance required. Data Processing Agreement must list payment sub-processors.
3. **High Service Count** (16 services): Large attack surface increases data breach risk. Sub-processor management is critical.
4. **Analytics/Monitoring** (@sentry/node): Cookie consent and tracking disclosure required under GDPR/ePrivacy.
...
*Report generated from analysis of 16 service(s) across 8 categories.*