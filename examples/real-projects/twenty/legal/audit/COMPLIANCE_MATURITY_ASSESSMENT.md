...
| GOV-04 | Is the scope of compliance obligations clearly defined? | [AUTO] 3 | [AUTO] 16 services detected — compliance scope is well-defined |
...
| # | Question | Score (1-5) | Justification |
|---|----------|------------|---------------|
| SEC-01 | Is authentication required for all system access, with MFA for privileged accounts? | [AUTO] 4 | [AUTO] Authentication service detected: passport, passport-google-oauth20, passport-microsoft |
...
| SEC-06 | Is data encrypted at rest and in transit? | [AUTO] 2 | [AUTO] Database service detected (drizzle, ioredis, redis) — encryption at rest needs manual verification |
...
| # | Question | Score (1-5) | Justification |
|---|----------|------------|---------------|
| VEN-01 | Is there a complete inventory of all third-party services and sub-processors? | [AUTO] 3 | [AUTO] 16 third-party services detected and inventoried |
...
| # | Question | Score (1-5) | Justification |
|---|----------|------------|---------------|
| AI-01 | Is there an inventory of all AI/ML systems with risk classifications? | [AUTO] 3 | [AUTO] AI services detected: @ai-sdk/anthropic, @ai-sdk/google, @ai-sdk/openai, @vercel/ai, openai |
...
*This compliance maturity assessment was generated by [Codepliant](https://github.com/joechensmartz/codepliant) based on an automated scan of the **twenty** codebase. Auto-scored questions should be verified by your compliance team. This assessment does not constitute legal advice or formal certification.*
