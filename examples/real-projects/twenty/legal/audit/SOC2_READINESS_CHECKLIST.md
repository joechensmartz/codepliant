...
**Detected services:** 16
**Relevant SOC 2 sections:** Processing Integrity (PI1), Confidentiality (C1), Privacy (P1-P8), Security (CC6), Availability (A1)
...
|-----------------|----------|----------------------|
| @ai-sdk/anthropic | AI Service | Processing Integrity (PI1), Confidentiality (C1), Privacy (P1-P8) |
| @ai-sdk/google | AI Service | Processing Integrity (PI1), Confidentiality (C1), Privacy (P1-P8) |
| @ai-sdk/openai | AI Service | Processing Integrity (PI1), Confidentiality (C1), Privacy (P1-P8) |
| @aws-sdk/client-s3 | File Storage | Confidentiality (C1), Security (CC6) |
| @sentry/node | Error Monitoring | Availability (A1), Security (CC6) |
| @vercel/ai | AI Service | Processing Integrity (PI1), Confidentiality (C1), Privacy (P1-P8) |
| drizzle | Database | Confidentiality (C1), Security (CC6) |
...
| passport-google-oauth20 | Authentication | Security (CC6) |
| passport-microsoft | Authentication | Security (CC6) |
...
- [ ] Review access control configuration for: passport, passport-google-oauth20, passport-microsoft
...
- [ ] Enable encryption at rest for: drizzle, ioredis, redis
- [ ] Enable encryption at rest for file storage: @aws-sdk/client-s3
...
- [ ] Validate AI model inputs and outputs for: @ai-sdk/anthropic, @ai-sdk/google, @ai-sdk/openai, @vercel/ai, openai
...
- [ ] Enable transparent data encryption (TDE) or equivalent for: drizzle, ioredis, redis
- [ ] Enable server-side encryption for: @aws-sdk/client-s3
...
- [ ] Disclose third-party data sharing for: @ai-sdk/anthropic, @ai-sdk/google, @ai-sdk/openai, @vercel/ai, openai
