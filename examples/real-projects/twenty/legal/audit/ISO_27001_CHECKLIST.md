...
|-----------------|----------|---------------------------|
| @ai-sdk/anthropic | AI Service | Organizational Controls (A.5), People Controls (A.6), Technological Controls (A.8) |
| @ai-sdk/google | AI Service | Organizational Controls (A.5), People Controls (A.6), Technological Controls (A.8) |
| @ai-sdk/openai | AI Service | Organizational Controls (A.5), People Controls (A.6), Technological Controls (A.8) |
| @aws-sdk/client-s3 | File Storage | Technological Controls (A.8), Organizational Controls (A.5) |
| @sentry/node | Error Monitoring | Technological Controls (A.8), Organizational Controls (A.5) |
| @vercel/ai | AI Service | Organizational Controls (A.5), People Controls (A.6), Technological Controls (A.8) |
| drizzle | Database | Technological Controls (A.8), Organizational Controls (A.5) |
...
| passport-google-oauth20 | Authentication | Organizational Controls (A.5), Technological Controls (A.8) |
| passport-microsoft | Authentication | Organizational Controls (A.5), Technological Controls (A.8) |
...
*Data-collecting services detected: @ai-sdk/anthropic, @ai-sdk/google, @ai-sdk/openai, @vercel/ai, openai*
...
*Authentication services detected: passport, passport-google-oauth20, passport-microsoft*
...
*Data storage services detected: drizzle, ioredis, redis, @aws-sdk/client-s3*
...
*AI services detected: @ai-sdk/anthropic, @ai-sdk/google, @ai-sdk/openai, @vercel/ai, openai*
