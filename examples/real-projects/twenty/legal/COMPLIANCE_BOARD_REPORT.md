...
[Your Company Name] operates a technology stack comprising **16 third-party services** across 8 categories. This report provides an overview of our compliance posture, key risks, regulatory developments, and budget status for Q1 2026.
...
| **Data Processing Categories** | 8 |
| **Data Categories Detected** | 10 |
...
Likelihood
  ↓
  High     │            │ Auth breach │ AI misuse   │ Payment fraud │
...
|----------|----------|------------|-------------|
| AI / Machine Learning | 5 | High | EU AI Act compliance, bias, hallucination risk |
...
| Storage | 1 | Medium | Vendor dependency, data processing |
| Database | 3 | Medium | Vendor dependency, data processing |
| Other | 1 | Medium | Vendor dependency, data processing |
...
2. **Prioritize EU AI Act readiness** — With 5 AI service(s) detected, complete risk classification and establish conformity assessment procedures before enforcement deadlines.

3. **Vendor consolidation review** — With 16 third-party services, evaluate opportunities to reduce vendor footprint and associated compliance overhead.
...
|---|---------|----------|----------------|----------------|
| 1 | @ai-sdk/anthropic | ai | Yes | user prompts, conversation history, generated content |
| 2 | @ai-sdk/google | ai | Yes | user prompts, conversation history, generated content |
| 3 | @ai-sdk/openai | ai | Yes | user prompts, conversation history, generated content |
| 4 | @aws-sdk/client-s3 | storage | Yes | uploaded files, file metadata |
| 5 | @sentry/node | monitoring | Yes | error data, stack traces, user context +3 more |
| 6 | @vercel/ai | ai | Yes | user prompts, conversation history, generated content |
| 7 | drizzle | database | Yes | user data as defined in schema |
...
| 10 | nodemailer | email | Yes | email addresses, email content |
| 11 | openai | ai | Yes | user prompts, conversation history, generated content |
| 12 | passport | auth | Yes | email, name, OAuth tokens +1 more |
| 13 | passport-google-oauth20 | auth | Yes | email, name, Google profile data +1 more |
| 14 | passport-microsoft | auth | Yes | email, name, Microsoft profile data +1 more |
| 15 | redis | database | Yes | cached data, session data |
| 16 | stripe | payment | Yes | payment information, billing address, email +1 more |

---

*This board report was generated by [Codepliant](https://github.com/joechensmartz/codepliant) based on automated source code analysis of the **twenty** codebase (16 services detected). Sections marked with [brackets] require manual input from the compliance team. This report should be reviewed and supplemented with operational data before board presentation. Generated on 2026-03-16.*
