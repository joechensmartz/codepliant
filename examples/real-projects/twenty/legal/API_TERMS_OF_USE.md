...
- **passport** — integrated authentication provider
- **passport-google-oauth20** — integrated authentication provider
- **passport-microsoft** — integrated authentication provider
...
The API integrates AI services (@ai-sdk/anthropic, @ai-sdk/google, @ai-sdk/openai, @vercel/ai, openai). Additional restrictions apply:
