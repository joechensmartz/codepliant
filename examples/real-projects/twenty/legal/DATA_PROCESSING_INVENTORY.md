...
| **Recipients / Processors** | passport, passport-google-oauth20, passport-microsoft |
...
| **Recipients / Processors** | nodemailer |
...
| **Recipients / Processors** | @ai-sdk/anthropic, @ai-sdk/google, @ai-sdk/openai, @vercel/ai, openai |
...
| **Recipients / Processors** | @aws-sdk/client-s3 |
...
| **Recipients / Processors** | drizzle (managed/self-hosted), ioredis (managed/self-hosted), redis (managed/self-hosted) |
...
|----------|-----------|-----------|
| PA-001: User Authentication & Account Management | passport, passport-google-oauth20, passport-microsoft | Standard Contractual Clauses (SCCs) |
| PA-002: Payment Processing & Billing | stripe | PCI DSS compliance, Standard Contractual Clauses |
| PA-003: Email Communications | nodemailer | Standard Contractual Clauses (SCCs) |
| PA-004: AI-Powered Features & Processing | @ai-sdk/anthropic, @ai-sdk/google, @ai-sdk/openai, @vercel/ai, openai | Standard Contractual Clauses, Data Processing Addendum with AI provider |
| PA-005: Error Monitoring & Application Performance | @sentry/node | Standard Contractual Clauses (SCCs) |
| PA-006: File Storage & Media Management | @aws-sdk/client-s3 | Encryption at rest, Standard Contractual Clauses |
