...
| passport-google-oauth20 | email, name, Google profile data, OAuth tokens |
| passport-microsoft | email, name, Microsoft profile data, OAuth tokens |
...
Consider integrating TOTP-based MFA (e.g., via passport) as a first step.
