...
> 16 services | Generated on 2026-03-16
...
|---------|----------|---------------|-----------|-------------|-------------------|
| @ai-sdk/anthropic | ai | **P0** | **P2** | user prompts, conversation history, generated content | EU AI Act, GDPR Art. 22 (automated decisions) |
| @ai-sdk/google | ai | **P0** | **P2** | user prompts, conversation history, generated content | EU AI Act, GDPR Art. 22 (automated decisions) |
| @ai-sdk/openai | ai | **P0** | **P2** | user prompts, conversation history, generated content | EU AI Act, GDPR Art. 22 (automated decisions) |
| @aws-sdk/client-s3 | storage | **P1** | **P2** | uploaded files, file metadata | GDPR Art. 33/34 if PII stored |
| @sentry/node | monitoring | **P2** | **P2** | error data, stack traces, user context | Minimal direct regulatory impact |
| @vercel/ai | ai | **P0** | **P2** | user prompts, conversation history, generated content | EU AI Act, GDPR Art. 22 (automated decisions) |
| drizzle | database | **P0** | **P1** | user data as defined in schema | GDPR Art. 33/34, data breach notification |
...
| passport-google-oauth20 | auth | **P0** | **P1** | email, name, Google profile data | GDPR Art. 33/34, credential breach notification |
| passport-microsoft | auth | **P0** | **P1** | email, name, Microsoft profile data | GDPR Art. 33/34, credential breach notification |
...
*This incident severity matrix was generated by [Codepliant](https://github.com/joechensmartz/codepliant) based on an automated scan of the **twenty** codebase (16 services detected). Customize response times, escalation paths, and roles to match your organization's structure. This document should be reviewed by your security team and legal counsel before adoption.*
