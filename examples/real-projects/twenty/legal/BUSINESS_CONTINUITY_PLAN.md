...
This Business Continuity Plan (BCP) defines recovery objectives, failover procedures, and communication protocols for **[Your Company Name]**'s **twenty** application. It ensures that critical services can be restored within acceptable timeframes following an outage, disaster, or other disruptive event.
...
| passport-google-oauth20 | Authentication | 1 hour | 0 minutes | Session cache failover; extend existing tokens |
| passport-microsoft | Authentication | 1 hour | 0 minutes | Session cache failover; extend existing tokens |
| stripe | Payment Processing | 1 hour | 0 minutes | Transaction queue with retry; idempotency keys |
| drizzle | Database | 1 hour | 5 minutes | Automated replica promotion; point-in-time recovery |
...
| @ai-sdk/anthropic | AI Service | 4 hours | 1 hour | Graceful degradation; disable AI features |
| @ai-sdk/google | AI Service | 4 hours | 1 hour | Graceful degradation; disable AI features |
| @ai-sdk/openai | AI Service | 4 hours | 1 hour | Graceful degradation; disable AI features |
| @vercel/ai | AI Service | 4 hours | 1 hour | Graceful degradation; disable AI features |
...
| Service | Category | RTO | RPO | Recovery Strategy |
|---------|----------|-----|-----|-------------------|
| @sentry/node | Monitoring | 24 hours | 24 hours | Secondary monitoring; manual checks |
...
Detected database service(s): drizzle, ioredis, redis
...
Detected auth service(s): passport, passport-google-oauth20, passport-microsoft
...
Detected AI service(s): @ai-sdk/anthropic, @ai-sdk/google, @ai-sdk/openai, @vercel/ai, openai
...
|---------|----------|----------------------|--------------------------|
| @ai-sdk/anthropic | ai | AI-powered features unavailable | Disable AI features; show static content |
| @ai-sdk/google | ai | AI-powered features unavailable | Disable AI features; show static content |
| @ai-sdk/openai | ai | AI-powered features unavailable | Disable AI features; show static content |
| @aws-sdk/client-s3 | storage | File uploads/downloads unavailable | CDN cache; deferred uploads |
| @sentry/node | monitoring | Blind to errors and performance issues | Manual log review; secondary tools |
| @vercel/ai | ai | AI-powered features unavailable | Disable AI features; show static content |
| drizzle | database | Data reads/writes unavailable | Read replica; cached responses |
...
| passport-google-oauth20 | auth | Users cannot sign in or register | Cached sessions; manual verification |
| passport-microsoft | auth | Users cannot sign in or register | Cached sessions; manual verification |
...
*This Business Continuity Plan was generated by [Codepliant](https://github.com/joechensmartz/codepliant) based on an automated scan of the **twenty** codebase. Recovery objectives and procedures should be reviewed and customized by your engineering and operations teams based on actual infrastructure and business requirements.*