...
| Question | Answer |
|----------|--------|
| Do you require authentication for access? | [AUTO] Yes — authentication implemented via passport, passport-google-oauth20, passport-microsoft |
...
| Where is data stored? | [AUTO] Database services detected: drizzle, ioredis, redis — [MANUAL] specify hosting region |
| Do you use cloud storage? | [AUTO] Yes — @aws-sdk/client-s3 detected |
...
| Do you use error monitoring / observability? | [AUTO] Yes — @sentry/node |
...
| Question | Answer |
|----------|--------|
| How many third-party sub-processors do you use? | [AUTO] 16 sub-processor(s) detected |
...
| Question | Answer |
|----------|--------|
| Does the application use AI/ML services? | [AUTO] Yes — @ai-sdk/anthropic, @ai-sdk/google, @ai-sdk/openai, @vercel/ai, openai |
...
*This vendor security questionnaire was generated by [Codepliant](https://github.com/joechensmartz/codepliant) based on an automated scan of the **twenty** codebase. Answers marked [AUTO] are derived from code analysis and should be verified. Answers marked [MANUAL] require input from your security and compliance teams. This document is not a substitute for a formal security assessment.*
