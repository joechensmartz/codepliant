...
This policy defines what events are logged across the **twenty** application, how long logs are retained, and who has access to audit data. It supports compliance with GDPR Article 30 (records of processing activities), SOC 2 Trust Service Criteria (CC7.2 — monitoring), and internal security requirements.
...
|---------|----------|--------------|
| @sentry/node | monitoring | Application errors; Unhandled exceptions; Performance transactions; User context (IP, browser) |
| passport | auth | Application events, user interactions, system metrics |
| passport-google-oauth20 | auth | Application events, user interactions, system metrics |
| passport-microsoft | auth | Application events, user interactions, system metrics |
