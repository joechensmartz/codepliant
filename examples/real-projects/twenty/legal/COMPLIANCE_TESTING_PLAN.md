...
| --- | --- | --- | --- |
| DD-S-001 | **@ai-sdk/anthropic** | Data fully removed after deletion request | Query AI logs by user ID; expect no matching entries |
| DD-S-002 | **@ai-sdk/google** | Data fully removed after deletion request | Query AI logs by user ID; expect no matching entries |
| DD-S-003 | **@ai-sdk/openai** | Data fully removed after deletion request | Query AI logs by user ID; expect no matching entries |
| DD-S-004 | **@aws-sdk/client-s3** | Data fully removed after deletion request | List objects by user prefix; expect empty |
| DD-S-005 | **@sentry/node** | Data fully removed after deletion request | Search logs by user ID; expect scrubbed entries |
| DD-S-006 | **@vercel/ai** | Data fully removed after deletion request | Query AI logs by user ID; expect no matching entries |
| DD-S-007 | **drizzle** | Data fully removed after deletion request | Direct DB query by user ID; expect 0 rows |
...
| DD-S-010 | **nodemailer** | Data fully removed after deletion request | Search mailing lists by email; expect not found |
| DD-S-011 | **openai** | Data fully removed after deletion request | Query AI logs by user ID; expect no matching entries |
| DD-S-012 | **passport** | Data fully removed after deletion request | Query user profile API; expect 404 |
| DD-S-013 | **passport-google-oauth20** | Data fully removed after deletion request | Query user profile API; expect 404 |
| DD-S-014 | **passport-microsoft** | Data fully removed after deletion request | Query user profile API; expect 404 |
| DD-S-015 | **redis** | Data fully removed after deletion request | Direct DB query by user ID; expect 0 rows |
| DD-S-016 | **stripe** | Data fully removed after deletion request | Query payment records by user ID; expect empty result |

### 3.3 Cascade Deletion

| ID | Test Case | Expected Result | Regulation |
| --- | --- | --- | --- |
| DD-C-001 | Delete user account | Data removed from all 16 detected services | GDPR Art. 17 |
...
- **passport-google-oauth20**: Verify MFA enforcement for admin accounts
- **passport-google-oauth20**: Verify OAuth scope restrictions match configured minimums
- **passport-google-oauth20**: Verify session token rotation on privilege escalation
- **passport-microsoft**: Verify MFA enforcement for admin accounts
- **passport-microsoft**: Verify OAuth scope restrictions match configured minimums
- **passport-microsoft**: Verify session token rotation on privilege escalation
...
- **@sentry/node**: Verify breach alert rules are configured and active
- **@sentry/node**: Verify alert reaches on-call within 15 minutes of trigger
...
| --- | --- | --- | --- | --- |
| **@ai-sdk/anthropic** | Required | Required | Required | Recommended |
| **@ai-sdk/google** | Required | Required | Required | Recommended |
| **@ai-sdk/openai** | Required | Required | Required | Recommended |
| **@aws-sdk/client-s3** | N/A | Required | Required | Required |
| **@sentry/node** | N/A | Required | Required | Recommended |
| **@vercel/ai** | Required | Required | Required | Recommended |
| **drizzle** | N/A | Required | Required | Required |
...
| **openai** | Required | Required | Required | Recommended |
| **passport** | N/A | Required | Required | Required |
| **passport-google-oauth20** | N/A | Required | Required | Required |
| **passport-microsoft** | N/A | Required | Required | Required |
