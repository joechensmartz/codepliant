...
|---------|----------|---------------|
| @ai-sdk/anthropic | Vercel AI SDK (Anthropic) | user prompts, conversation history, generated content |
| @ai-sdk/google | Vercel AI SDK (Google) | user prompts, conversation history, generated content |
| @ai-sdk/openai | Vercel AI SDK (OpenAI) | user prompts, conversation history, generated content |
| @vercel/ai | Vercel AI SDK | user prompts, conversation history, generated content |
| openai | OpenAI (GPT) | user prompts, conversation history, generated content |
...
**Current review level:** limited risk

AI-generated content should be reviewed before external distribution; internal use may proceed with spot-checks.
...
[Your Company Name] is committed to the responsible and fair use of AI. We acknowledge that AI systems can perpetuate or amplify biases present in training data.
...
*This Acceptable AI Use Policy was generated by [Codepliant](https://github.com/joechensmartz/codepliant) based on automated code analysis. Review and verify all entries for accuracy. This document does not constitute legal advice.*