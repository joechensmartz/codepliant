...
This AI Disclosure Statement is provided by [Your Company Name] in compliance with the European Union Artificial Intelligence Act (Regulation (EU) 2024/1689), which establishes harmonised rules on artificial intelligence. Full transparency obligations under the EU AI Act take effect on **2 August 2026**.
...
|-----------|----------|---------------|---------|
| @ai-sdk/anthropic | @ai-sdk/anthropic | user prompts, conversation history, generated content | AI processing |
| @ai-sdk/google | @ai-sdk/google | user prompts, conversation history, generated content | AI processing |
| @ai-sdk/openai | @ai-sdk/openai | user prompts, conversation history, generated content | AI processing |
| @vercel/ai | @vercel/ai | user prompts, conversation history, generated content | AI processing |
...
|-----------|-----------------------------|
| user prompts | @ai-sdk/anthropic, @ai-sdk/google, @ai-sdk/openai, @vercel/ai, OpenAI |
| conversation history | @ai-sdk/anthropic, @ai-sdk/google, @ai-sdk/openai, @vercel/ai, OpenAI |
| generated content | @ai-sdk/anthropic, @ai-sdk/google, @ai-sdk/openai, @vercel/ai, OpenAI |
...
|----------|---------------|
| @ai-sdk/anthropic | [Privacy & Data Policy](#) |
| @ai-sdk/google | [Privacy & Data Policy](#) |
| @ai-sdk/openai | [Privacy & Data Policy](#) |
| @vercel/ai | [Privacy & Data Policy](#) |
