...
> This guide provides step-by-step procedures for handling Data Subject Access Requests (DSARs) under the General Data Protection Regulation (GDPR) and the California Consumer Privacy Act (CCPA). It is tailored to the **twenty** application based on automated code analysis.
...
The following map was auto-generated from code analysis of **twenty**. It shows where personal data is stored, how to export it, how to delete it, and which third parties must be notified.
...
- **Third-party notification required:** Yes — contact Vercel AI SDK (Anthropic) to forward the DSAR or use their GDPR/privacy API
...
- **How to export:** Query the AI provider's API or admin dashboard for stored conversation logs and user data. Check if the provider offers a data export endpoint.
- **How to delete:** Delete stored conversations and user data via the AI provider's API or dashboard. Confirm deletion of any fine-tuning data that included user content.
- **Third-party notification required:** Yes — contact Vercel AI SDK (Google) to forward the DSAR or use their GDPR/privacy API
...
- **How to export:** Query the AI provider's API or admin dashboard for stored conversation logs and user data. Check if the provider offers a data export endpoint.
- **How to delete:** Delete stored conversations and user data via the AI provider's API or dashboard. Confirm deletion of any fine-tuning data that included user content.
- **Third-party notification required:** Yes — contact Vercel AI SDK (OpenAI) to forward the DSAR or use their GDPR/privacy API
...
- **How to export:** Query the AI provider's API or admin dashboard for stored conversation logs and user data. Check if the provider offers a data export endpoint.
- **How to delete:** Delete stored conversations and user data via the AI provider's API or dashboard. Confirm deletion of any fine-tuning data that included user content.
- **Third-party notification required:** Yes — contact Vercel AI SDK to forward the DSAR or use their GDPR/privacy API
...
|--------------|----------|----------------|
| Vercel AI SDK (Anthropic) | AI / Machine Learning | Forward DSAR; confirm deletion/export |
| Vercel AI SDK (Google) | AI / Machine Learning | Forward DSAR; confirm deletion/export |
| Vercel AI SDK (OpenAI) | AI / Machine Learning | Forward DSAR; confirm deletion/export |
...
| Vercel AI SDK | AI / Machine Learning | Forward DSAR; confirm deletion/export |
...
*This DSAR Handling Guide was generated by [Codepliant](https://github.com/joechensmartz/codepliant) based on automated code analysis of the **twenty** project. The service-specific data location map is derived from detected dependencies and may not capture all data stores. This document is a template and must be reviewed by a legal professional and your Data Protection Officer. It does not constitute legal advice.*