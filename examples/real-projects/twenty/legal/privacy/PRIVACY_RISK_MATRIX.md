...
|----|---------------------|------------|--------|-------|-------|----------|
| PR-003 | AI/ML data processing and model inference | 4 (Likely) | 4 (Major) | 16 | 🔴 Critical | @ai-sdk/anthropic, @ai-sdk/google, @ai-sdk/openai, @vercel/ai, openai |
| PR-007 | International data transfers to third-party processors | 4 (Likely) | 4 (Major) | 16 | 🔴 Critical | @ai-sdk/anthropic, @ai-sdk/google, @ai-sdk/openai, @aws-sdk/client-s3, @sentry/node, @vercel/ai, drizzle, googleapis, ioredis, nodemailer, openai, passport, passport-google-oauth20, passport-microsoft, redis, stripe |
| PR-001 | User authentication and identity management | 3 (Possible) | 5 (Severe) | 15 | 🔴 Critical | passport, passport-google-oauth20, passport-microsoft |
| PR-004 | Persistent data storage and retrieval | 3 (Possible) | 4 (Major) | 12 | 🟠 High | drizzle, ioredis, redis |
| PR-002 | Payment processing and financial data handling | 2 (Unlikely) | 5 (Severe) | 10 | 🟠 High | stripe |
| PR-005 | File and object storage | 3 (Possible) | 3 (Moderate) | 9 | 🟡 Medium | @aws-sdk/client-s3 |
| PR-006 | Email communications and marketing | 3 (Possible) | 3 (Moderate) | 9 | 🟡 Medium | nodemailer |
...
**Impact:** 4/5 (Major)  
**Affected Services:** @ai-sdk/anthropic, @ai-sdk/google, @ai-sdk/openai, @vercel/ai, openai
...
**Likelihood:** 4/5 (Likely)  
**Impact:** 4/5 (Major)  
**Affected Services:** @ai-sdk/anthropic, @ai-sdk/google, @ai-sdk/openai, @aws-sdk/client-s3, @sentry/node, @vercel/ai, drizzle, googleapis, ioredis, nodemailer, openai, passport, passport-google-oauth20, passport-microsoft, redis, stripe
...
**Impact:** 5/5 (Severe)  
**Affected Services:** passport, passport-google-oauth20, passport-microsoft
...
**Likelihood:** 3/5 (Possible)  
**Impact:** 4/5 (Major)  
**Affected Services:** drizzle, ioredis, redis
...
**Likelihood:** 3/5 (Possible)  
**Impact:** 3/5 (Moderate)  
**Affected Services:** @aws-sdk/client-s3
