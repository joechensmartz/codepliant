...
*Generated on 2026-03-16 | 16 services detected | 28 data categories*
...
|---------------|--------|-----------|---------|
| user prompts, conversation history, generated content | @ai-sdk/anthropic | Per retention policy | View, Export, Delete |
| user prompts, conversation history, generated content | @ai-sdk/google | Per retention policy | View, Export, Delete |
| user prompts, conversation history, generated content | @ai-sdk/openai | Per retention policy | View, Export, Delete |
| uploaded files, file metadata | @aws-sdk/client-s3 | Per retention policy | View, Export, Delete |
| error data, stack traces, user context | @sentry/node | Per retention policy | View, Export, Delete |
| user prompts, conversation history, generated content | @vercel/ai | Per retention policy | View, Export, Delete |
| user data as defined in schema | drizzle | Per retention policy | View, Export, Delete |
...
| email, name, Google profile data | passport-google-oauth20 | Per retention policy | View, Export, Delete |
| email, name, Microsoft profile data | passport-microsoft | Per retention policy | View, Export, Delete |
...
```json
{
  ...
  "third_party_sharing": [
    { "processor": "@ai-sdk/anthropic", "data_shared": ["user prompts","conversation history"], "purpose": "service_operation" },
    { "processor": "@ai-sdk/google", "data_shared": ["user prompts","conversation history"], "purpose": "service_operation" },
    { "processor": "@ai-sdk/openai", "data_shared": ["user prompts","conversation history"], "purpose": "service_operation" }
  ]
}
```
...
│  └─ Data points: 1,247                                  │
│                                                         │
│  Third-Party Services (16 connected)       │
│  ├─ @ai-sdk/anthropic: user prompts, conversation history
│  ├─ @ai-sdk/google: user prompts, conversation history
│  ├─ @ai-sdk/openai: user prompts, conversation history
│  ├─ @aws-sdk/client-s3: uploaded files, file metadata
│  ├─ @sentry/node: error data, stack traces
│  └─ ... and 11 more
│                                                         │
└─────────────────────────────────────────────────────────┘
```
...
- [ ] Add data aggregation from all 16 connected services
...
*This specification was auto-generated by Codepliant based on 16 detected services in your codebase. Implement this portal to give your users full control over their personal data.*
