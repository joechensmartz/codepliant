...
- 16 third-party data processors detected (systematic processing at scale)
...
### 5.2 Systems to Query (16 detected)
...
- **passport-google-oauth20** (auth): email, name, Google profile data
- **passport-microsoft** (auth): email, name, Microsoft profile data
...
*This DPO Handbook was generated by [Codepliant](https://github.com/joechensmartz/codepliant) based on an automated scan of the **twenty** codebase. It should be reviewed and customized by your legal team and appointed DPO before adoption.*
