...
**Services:** @ai-sdk/anthropic, @ai-sdk/google, @ai-sdk/openai, @vercel/ai, openai
...
**Services:** drizzle, ioredis, redis

**Data processed:** user data as defined in schema, cached data, session data
...
**Services:** passport, passport-google-oauth20, passport-microsoft

**Data processed:** email, name, OAuth tokens, session data, Google profile data, Microsoft profile data
