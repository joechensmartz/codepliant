...
|---------|---------------|----------------|-----------------|------------|
| @ai-sdk/anthropic | user prompts, conversation history, generated content | **Limited** | N/A | Semi-annual review |
| @ai-sdk/google | user prompts, conversation history, generated content | **Limited** | N/A | Semi-annual review |
| @ai-sdk/openai | user prompts, conversation history, generated content | **Limited** | N/A | Semi-annual review |
| @vercel/ai | user prompts, conversation history, generated content | **Limited** | N/A | Semi-annual review |
| openai | user prompts, conversation history, generated content | **Limited** | N/A | Semi-annual review |

## 3. Per-Service Risk Evaluation

### 3.1 @ai-sdk/anthropic

| Field | Detail |
|-------|--------|
| **Service** | `@ai-sdk/anthropic` |
| **Category** | ai |
