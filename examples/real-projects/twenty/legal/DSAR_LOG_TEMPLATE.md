...
|---------|----------|----------------|-----------------|
| @ai-sdk/anthropic | ai | user prompts, conversation history, generated content | Export / Delete / Rectify |
| @ai-sdk/google | ai | user prompts, conversation history, generated content | Export / Delete / Rectify |
| @ai-sdk/openai | ai | user prompts, conversation history, generated content | Export / Delete / Rectify |
| @aws-sdk/client-s3 | storage | uploaded files, file metadata | Export / Delete / Rectify |
| @sentry/node | monitoring | error data, stack traces, user context, device information, IP address, performance profiles | Export / Delete / Rectify |
| @vercel/ai | ai | user prompts, conversation history, generated content | Export / Delete / Rectify |
| drizzle | database | user data as defined in schema | Export / Delete / Rectify |
...
| passport-google-oauth20 | auth | email, name, Google profile data, OAuth tokens | Export / Delete / Rectify |
| passport-microsoft | auth | email, name, Microsoft profile data, OAuth tokens | Export / Delete / Rectify |
