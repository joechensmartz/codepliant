...
| passport | Authentication | email, name, OAuth tokens, session data |
| passport-google-oauth20 | Authentication | email, name, Google profile data, OAuth tokens |
| passport-microsoft | Authentication | email, name, Microsoft profile data, OAuth tokens |
...
**Total services:** 16. Before integrating a new service, check with the compliance lead to ensure it is added to our sub-processor list and covered by a Data Processing Agreement.
