...
*Data-collecting services detected: posthog*
...
*Authentication services detected: next-auth*
...
*Data storage services detected: ioredis, prisma, redis, @aws-sdk/client-s3*
