...
**Overall Maturity Score:** 3.3/5.0 — **Defined (Level 3)**
...
| GOV-04 | Is the scope of compliance obligations clearly defined? | [AUTO] 3 | [AUTO] 10 services detected — compliance scope is well-defined |
...
| # | Question | Score (1-5) | Justification |
|---|----------|------------|---------------|
| SEC-01 | Is authentication required for all system access, with MFA for privileged accounts? | [AUTO] 4 | [AUTO] Authentication service detected: next-auth |
| SEC-02 | Is there continuous security monitoring and alerting in place? | [AUTO] 3 | [AUTO] Monitoring detected: @sentry/nextjs |
...
| SEC-06 | Is data encrypted at rest and in transit? | [AUTO] 2 | [AUTO] Database service detected (ioredis, prisma, redis) — encryption at rest needs manual verification |
...
| # | Question | Score (1-5) | Justification |
|---|----------|------------|---------------|
| VEN-01 | Is there a complete inventory of all third-party services and sub-processors? | [AUTO] 3 | [AUTO] 10 third-party services detected and inventoried |
...
| 4 | Incident Response & Business Continuity | 3.0 | 4.0 | [DESCRIBE ACTIONS] | [OWNER] | [DATE] |
| 5 | Privacy & Data Protection | 3.2 | 4.2 | [DESCRIBE ACTIONS] | [OWNER] | [DATE] |
...
*This compliance maturity assessment was generated by [Codepliant](https://github.com/joechensmartz/codepliant) based on an automated scan of the **formbricks** codebase. Auto-scored questions should be verified by your compliance team. This assessment does not constitute legal advice or formal certification.*
