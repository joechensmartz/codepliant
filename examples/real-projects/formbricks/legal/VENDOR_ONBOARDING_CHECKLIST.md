...
| 2 | @sentry/nextjs | Error Monitoring | Medium | Internal — collects error logs, stack traces, device metadata |
| 3 | googleapis | Other | Low | Internal — classification depends on specific use case |
| 4 | ioredis | Database | High | Confidential — stores application data, potentially all data categories |
| 5 | next-auth | Authentication | High | Confidential — processes authentication credentials, identity data |
| 6 | nodemailer | Email Service | Medium | Confidential — processes email addresses, message content |
| 7 | posthog | Analytics | Medium | Internal — collects behavioral data, device info, IP addresses |
| 8 | prisma | Database | High | Confidential — stores application data, potentially all data categories |
| 9 | redis | Database | High | Confidential — stores application data, potentially all data categories |
| 10 | stripe | Payment Processing | Critical | Restricted — processes payment card data, financial PII |
