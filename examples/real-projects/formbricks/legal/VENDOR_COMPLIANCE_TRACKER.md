...
This document tracks the compliance status of all **5 third-party vendors** detected in the **formbricks** codebase. It provides a centralized view of DPA status, review schedules, risk tiers, and vendor contacts for ongoing vendor compliance management.
...
|-------|----------------------|
| 2026-06 | Stripe |
| 2027-03 | Amazon S3 (AWS) |
| 2028-03 | Sentry, Google APIs, PostHog |
