...
Here is your monthly compliance update for formbricks:
...
Codepliant has detected a new third-party service in formbricks:
...
Payment processing compliance update for formbricks:
...
*This Compliance Communication Plan was generated by [Codepliant](https://github.com/joechensmartz/codepliant) based on automated code analysis of 10 service(s). Adapt the templates and cadences to match your organisation's size, structure, and regulatory environment. Review this plan quarterly.*