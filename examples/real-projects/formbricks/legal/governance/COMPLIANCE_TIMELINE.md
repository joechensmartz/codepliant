...
Based on the 10 service(s) detected in **formbricks**, the following obligations apply:
...
### Authentication Services (next-auth)
...
### Storage / Database Services (@aws-sdk/client-s3, ioredis, prisma, redis)
