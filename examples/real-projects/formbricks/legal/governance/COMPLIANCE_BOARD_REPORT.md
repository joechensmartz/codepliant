...
[Your Company Name] operates a technology stack comprising **10 third-party services** across 8 categories. This report provides an overview of our compliance posture, key risks, regulatory developments, and budget status for Q1 2026.
...
> **Tier:** Growth | **Total Annual Budget:** $145,000

| Category | Annual Budget | YTD Actual | YTD Budget | Variance |
|----------|-------------|-----------|-----------|----------|
| Legal & Advisory | $40,000 | [Actual] | $10,000 | [Variance] |
| Tools & Software | $25,000 | [Actual] | $6,250 | [Variance] |
| Training & Awareness | $15,000 | [Actual] | $3,750 | [Variance] |
| Audit & Certification | $50,000 | [Actual] | $12,500 | [Variance] |
| Insurance | $15,000 | [Actual] | $3,750 | [Variance] |
| **Total** | **$145,000** | **[Actual]** | **$36,250** | **[Variance]** |
...
2. **Vendor consolidation review** — With 10 third-party services, evaluate opportunities to reduce vendor footprint and associated compliance overhead.
...
| 2 | @sentry/nextjs | monitoring | Yes | error data, stack traces, user context +2 more |
| 3 | googleapis | other | Yes | user data via Google APIs, calendar data, email data +1 more |
| 4 | ioredis | database | Yes | cached data, session data |
| 5 | next-auth | auth | Yes | email, name, profile picture +2 more |
| 6 | nodemailer | email | Yes | email addresses, email content |
| 7 | posthog | analytics | Yes | user behavior, session recordings, feature flag usage +1 more |
| 8 | prisma | database | Yes | user data as defined in schema |
| 9 | redis | database | Yes | cached data, session data |
| 10 | stripe | payment | Yes | payment information, billing address, email +1 more |

---

*This board report was generated by [Codepliant](https://github.com/joechensmartz/codepliant) based on automated source code analysis of the **formbricks** codebase (10 services detected). Sections marked with [brackets] require manual input from the compliance team. This report should be reviewed and supplemented with operational data before board presentation. Generated on 2026-03-16.*
