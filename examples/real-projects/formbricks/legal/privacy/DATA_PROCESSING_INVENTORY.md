...
| **Recipients / Processors** | next-auth |
...
| **Recipients / Processors** | ioredis (managed/self-hosted), prisma (managed/self-hosted), redis (managed/self-hosted) |
...
|-------------|-------------------|
| Contract performance (Art. 6(1)(b)) | PA-001, PA-003, PA-004, PA-006, PA-007 |
...
|----------|-----------|-----------|
| PA-001: User Authentication & Account Management | next-auth | Standard Contractual Clauses (SCCs) |
...
| PA-004: Email Communications | nodemailer | Standard Contractual Clauses (SCCs) |
