...
**Services:** ioredis, prisma, redis

**Data processed:** cached data, session data, user data as defined in schema
...
**Data processed:** email, name, profile picture, OAuth tokens, session data
