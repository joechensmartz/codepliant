...
*Generated on 2026-03-16 | 10 services detected | 26 data categories*
...
```json
{
  ...
  "third_party_sharing": [
    ...
    { "processor": "googleapis", "data_shared": ["user data via Google APIs","calendar data"], "purpose": "service_operation" }
  ]
}
```
...
│  ├─ googleapis: user data via Google APIs, calendar data
│  ├─ ioredis: cached data, session data
│  ├─ next-auth: email, name
│  └─ ... and 5 more
│                                                         │
└─────────────────────────────────────────────────────────┘
```
