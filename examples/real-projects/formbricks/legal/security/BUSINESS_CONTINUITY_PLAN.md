...
This Business Continuity Plan (BCP) defines recovery objectives, failover procedures, and communication protocols for **[Your Company Name]**'s **formbricks** application. It ensures that critical services can be restored within acceptable timeframes following an outage, disaster, or other disruptive event.
...
|----------|--------------------|----------------|
| Microsoft Azure | Not specified | Azure offers data residency controls via Azure Regions |
| Vercel | Not specified | Vercel deploys to edge locations globally using AWS infrastructure |
...
Detected database service(s): ioredis, prisma, redis
...
Detected auth service(s): next-auth
