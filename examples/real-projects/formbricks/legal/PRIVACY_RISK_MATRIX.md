...
|---------------------|----------------|-----------|--------------|-----------|------------|
| **5** - Almost Certain | — | — | — | — | — |
| **4** - Likely | — | — | 🟠PR-001 | 🔴PR-007 | — |
| **3** - Possible | — | — | 🟡PR-005, 🟡PR-006 | 🟠PR-004 | 🔴PR-002 |
| **2** - Unlikely | — | — | — | — | 🟠PR-003 |
| **1** - Rare | — | — | — | — | — |
...
|----|---------------------|------------|--------|-------|-------|----------|
| PR-007 | International data transfers to third-party processors | 4 (Likely) | 4 (Major) | 16 | 🔴 Critical | @aws-sdk/client-s3, @sentry/nextjs, googleapis, ioredis, next-auth, nodemailer, posthog, prisma, redis, stripe |
| PR-002 | User authentication and identity management | 3 (Possible) | 5 (Severe) | 15 | 🔴 Critical | next-auth |
| PR-001 | User behavior tracking and analytics | 4 (Likely) | 3 (Moderate) | 12 | 🟠 High | posthog |
| PR-004 | Persistent data storage and retrieval | 3 (Possible) | 4 (Major) | 12 | 🟠 High | ioredis, prisma, redis |
...
**Impact:** 4/5 (Major)  
**Affected Services:** @aws-sdk/client-s3, @sentry/nextjs, googleapis, ioredis, next-auth, nodemailer, posthog, prisma, redis, stripe
...
**Likelihood:** 3/5 (Possible)  
**Impact:** 4/5 (Major)  
**Affected Services:** ioredis, prisma, redis
