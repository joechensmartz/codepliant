...
[Your Company Name] currently operates **10 third-party service(s)** that process user data. A total of **77 compliance document(s)** have been generated covering all applicable regulatory requirements.
...
| Analytics | 1 | posthog |
| Auth | 1 | next-auth |
| Database | 3 | ioredis, prisma, redis |
| Email | 1 | nodemailer |
...
2. **Analytics/Monitoring** (@sentry/nextjs, posthog): Cookie consent and tracking disclosure required under GDPR/ePrivacy.
...
*Report generated from analysis of 10 service(s) across 8 categories.*