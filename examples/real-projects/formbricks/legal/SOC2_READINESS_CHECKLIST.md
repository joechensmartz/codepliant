...
**Relevant SOC 2 sections:** Confidentiality (C1), Security (CC6), Availability (A1), Privacy (P1-P8), Processing Integrity (PI1)
...
- [ ] Review access control configuration for: next-auth
...
- [ ] Enable encryption at rest for: ioredis, prisma, redis
...
- [ ] Enable transparent data encryption (TDE) or equivalent for: ioredis, prisma, redis
...
- [ ] Disclose third-party data sharing for: posthog
